...
replace (
	github.com/beltran/gohive => github.com/bytebase/gohive v0.0.0-20240419051906-3758d5fe4cf3
	github.com/beltran/gosasl => github.com/bytebase/gosasl v0.0.0-20240419050012-d3a70f525b3f
)
