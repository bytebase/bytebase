...
configurationRegistry.registerConfiguration({
    ...
    properties: {
        ...
        [treeStickyScroll]: {
            ...
            description: localizeWithPath('vs/platform/list/browser/listService', 'sticky scroll', "Controls whether sticky scrolling is enabled in trees."),
        },
        [treeStickyScrollMaxElements]: {
            type: 'number',
            minimum: 1,
            default: 7,
            markdownDescription: localizeWithPath('vs/platform/list/browser/listService', 'sticky scroll maximum items', "Controls the number of sticky elements displayed in the tree when `#workbench.tree.enableStickyScroll#` is enabled."),
        },
