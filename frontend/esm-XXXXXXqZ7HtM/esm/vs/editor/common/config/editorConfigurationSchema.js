...
const editorConfiguration = {
    ...
    properties: {
        ...
        'editor.wordBasedSuggestions': {
            ...
            enumDescriptions: [
                nls.localizeWithPath('vs/editor/common/config/editorConfigurationSchema', 'wordBasedSuggestions.off', 'Turn off Word Based Suggestions.'),
                nls.localizeWithPath('vs/editor/common/config/editorConfigurationSchema', 'wordBasedSuggestions.currentDocument', 'Only suggest words from the active document.'),
                nls.localizeWithPath('vs/editor/common/config/editorConfigurationSchema', 'wordBasedSuggestions.matchingDocuments', 'Suggest words from all open documents of the same language.'),
                nls.localizeWithPath('vs/editor/common/config/editorConfigurationSchema', 'wordBasedSuggestions.allDocuments', 'Suggest words from all open documents.')
            ],
            description: nls.localizeWithPath('vs/editor/common/config/editorConfigurationSchema', 'wordBasedSuggestions', "Controls whether completions should be computed based on words in the document and from which documents they are computed.")
        },
