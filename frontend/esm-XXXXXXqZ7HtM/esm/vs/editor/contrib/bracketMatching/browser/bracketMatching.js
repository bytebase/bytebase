...
class SelectToBracketAction extends EditorAction {
    constructor() {
        super({
            ...
            precondition: undefined,
            metadata: {
                description: nls.localize2WithPath('vs/editor/contrib/bracketMatching/browser/bracketMatching', 'smartSelect.selectToBracketDescription', "Select the text inside and including the brackets or curly braces"),
                args: [{
                        name: 'args',
                        schema: {
                            type: 'object',
