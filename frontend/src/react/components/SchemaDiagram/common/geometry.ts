// Deep import: `@/utils` (the barrel) transitively pulls in Monaco, which
// can't be resolved in the vitest environment. `minmax` itself is a pure
// math helper; importing it directly keeps the geometry helpers test-safe.
