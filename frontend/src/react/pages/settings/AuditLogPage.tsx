...
// dayjs UTC plugin is needed by buildFilterString for create_time filters.
dayjs.extend(utc);
...
// ============================================================
// TimeRangePicker — shows full datetime, updates the "created" scope
// ============================================================
...
// ============================================================
// ExportDropdown — filled accent button like the old design
// ============================================================
...
// ============================================================
// useColumnWidths — manages resizable column widths
// ============================================================
...
export function AuditLogPage() {
  ...
  // The "created" scope is readonly so it's hidden from the search bar.
  // The TimeRangePicker manages it separately.
  ...
  const parent = `${projectNamePrefix}-`;
  ...
  // Scope options: method, level, and actor (free-text input)
