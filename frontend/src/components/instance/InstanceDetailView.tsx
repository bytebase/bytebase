...
export function InstanceDetailView({
  ...
  useProductIntro({
    ...
    disabled: isProjectOwned || !shouldShowTransferIntro,
  });
  const syncingInstanceName = syncingInstanceId ? instanceName : undefined;
        ...
        <TabsPanel value="databases" keepMounted={false}>
          <div className="flex flex-col gap-y-2">
            ...
            <DatabaseBatchOperationsBar
              ...
              onTransferProject={
                isProjectOwned ? undefined : () => setShowTransferDrawer(true)
              }
              allSelected={
                visibleDatabases.length > 0 &&
