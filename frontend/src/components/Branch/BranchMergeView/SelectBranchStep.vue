    ...
    <NTabs v-model:value="tab">
      <template v-if="headBranch" #prefix>
        <div class="text-control-placeholder">
          {{
            $t("branch.merge.changes-of-branch", {
