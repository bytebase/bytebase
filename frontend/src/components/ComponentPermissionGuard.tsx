...
import { REQUEST_ROLE_REQUIRED_PERMISSIONS } from "@/modules/access-control/requestRoleButton";
...
const RequestRoleSheet = lazy(async () => {
  const module = await import("@/modules/access-control/RequestRoleSheet");
