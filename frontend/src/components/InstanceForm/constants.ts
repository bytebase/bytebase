...
export const EngineIconPath: Record<string, string> = {
  ...
  [Engine.POSTGRES]: new URL("@/assets/db/postgres.png", import.meta.url)
    .href,
  ...
  [Engine.REDSHIFT]: new URL("@/assets/db/redshift.svg", import.meta.url)
    .href,
  ...
  [Engine.BIGQUERY]: new URL("@/assets/db/bigquery.svg", import.meta.url)
    .href,
  [Engine.DYNAMODB]: new URL("@/assets/db/dynamodb.svg", import.meta.url)
    .href,
  [Engine.DATABRICKS]: new URL("@/assets/db/databricks.svg", import.meta.url)
    .href,
  [Engine.COCKROACHDB]: new URL(
    "@/assets/db/cockroachdb.png",
    import.meta.url
  ).href,
  [Engine.COSMOSDB]: new URL("@/assets/db/cosmosdb.svg", import.meta.url)
    .href,
