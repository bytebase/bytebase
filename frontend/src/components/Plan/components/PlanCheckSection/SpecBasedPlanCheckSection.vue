<template>
  <div v-if="show" class="px-4 py-3 flex flex-col gap-y-1 overflow-hidden">
    <div class="flex items-center justify-between gap-2">
      <div class="flex items-center gap-1">
        <h3 class="text-base font-medium">Checks</h3>
        <span class="text-control-light">({{ totalCheckRuns }})</span>
      </div>
      ...
      <div class="flex items-center gap-2">
        ...
        <div class="flex items-center gap-2 text-sm">
          ...
          >
            ...
            <span class="text-success font-medium">{{ summary.success }}</span>
          </button>
        </div>
    ...
    <div class="flex-1 overflow-y-auto">
      ...
      <!-- Check Results -->
      <div v-else-if="checkRunsForSpec.length > 0" class="flex flex-wrap gap-2">
        <!-- Group by Check Type -->
        <div
