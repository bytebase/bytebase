  ...
  <div class="space-y-4">
    ...
    <div>
      <div class="textlabel">
        ...
        <a
          href="https://bytebase.com/docs/features/vcs-integration/name-and-organize-schema-files#file-path-template?source=console"
          target="__blank"
    ...
    <div>
      <div class="textlabel">
        ...
        <a
          href="https://www.bytebase.com/docs/features/vcs-integration/name-and-organize-schema-files#schema-path-template?source=console"
          target="__blank"
          class="font-normal normal-link"
        >
          {{ $t("common.config-guide") }}</a
