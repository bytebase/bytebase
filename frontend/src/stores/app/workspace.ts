...
import { resolvePath } from "@/app/router/navigation";
import { settingNamePrefix, workspaceNamePrefix } from "@/lib/resourceName";
import { getEnvironmentId } from "@/stores/modules/v1/common";
import {
