 ...
 * reads, named as `QueryOption.ExplainFormat` and `QueryResult.QueryPlan.Format`
 * name it. The SQL editor offers Visualize for exactly these engines and hands
 * over the plan in this format; the visualizer keys its parsers on the same
