...
export interface ListProjectInstancesRequest {
  ...
  pageSize: number;
  /**
   * A page token, received from a previous `ListProjectInstances` call.
   * Provide this to retrieve the subsequent page.
   *
   * When paginating, all other parameters provided to `ListProjectInstances` must match
  ...
  /**
   * Filter the project.
   * Same as the filter in ListInstancesRequest.
   */
  filter: string;
}
...
function createBaseListProjectInstancesRequest(): ListProjectInstancesRequest {
  return { project: "", pageSize: 0, pageToken: "", showDeleted: false, filter: "" };
}

export const ListProjectInstancesRequest: MessageFns<ListProjectInstancesRequest> = {
  encode(message: ListProjectInstancesRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.project !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ListProjectInstancesRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseListProjectInstancesRequest();
  ...
  fromJSON(object: any): ListProjectInstancesRequest {
    return {
  ...
  toJSON(message: ListProjectInstancesRequest): unknown {
    const obj: any = {};
    if (message.project !== "") {
  ...
  create(base?: DeepPartial<ListProjectInstancesRequest>): ListProjectInstancesRequest {
    return ListProjectInstancesRequest.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<ListProjectInstancesRequest>): ListProjectInstancesRequest {
    const message = createBaseListProjectInstancesRequest();
...
function createBaseListProjectInstancesResponse(): ListProjectInstancesResponse {
  return { instances: [], nextPageToken: "" };
}

export const ListProjectInstancesResponse: MessageFns<ListProjectInstancesResponse> = {
  encode(message: ListProjectInstancesResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ListProjectInstancesResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseListProjectInstancesResponse();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): ListProjectInstancesResponse {
    return {
  ...
  toJSON(message: ListProjectInstancesResponse): unknown {
    const obj: any = {};
  ...
  create(base?: DeepPartial<ListProjectInstancesResponse>): ListProjectInstancesResponse {
    return ListProjectInstancesResponse.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<ListProjectInstancesResponse>): ListProjectInstancesResponse {
    const message = createBaseListProjectInstancesResponse();
...
export const ProjectServiceDefinition = {
  ...
  methods: {
    ...
    listProjectInstances: {
      name: "ListProjectInstances",
      requestType: ListProjectInstancesRequest,
      requestStream: false,
      responseType: ListProjectInstancesResponse,
      responseStream: false,
      options: {
        _unknownFields: {
