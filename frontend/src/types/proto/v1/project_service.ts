...
export interface Project {
  ...
  priorBackupPolicy: Project_PriorBackupPolicy;
}

export enum Project_PriorBackupPolicy {
  PRIOR_BACKUP_POLICY_UNSPECIFIED = "PRIOR_BACKUP_POLICY_UNSPECIFIED",
  PRIOR_BACKUP_POLICY_NO_BACKUP = "PRIOR_BACKUP_POLICY_NO_BACKUP",
  PRIOR_BACKUP_POLICY_BACKUP_ON_ERROR_STOP = "PRIOR_BACKUP_POLICY_BACKUP_ON_ERROR_STOP",
  PRIOR_BACKUP_POLICY_BACKUP_ON_ERROR_SKIP = "PRIOR_BACKUP_POLICY_BACKUP_ON_ERROR_SKIP",
  UNRECOGNIZED = "UNRECOGNIZED",
}

export function project_PriorBackupPolicyFromJSON(object: any): Project_PriorBackupPolicy {
  switch (object) {
    case 0:
    case "PRIOR_BACKUP_POLICY_UNSPECIFIED":
      return Project_PriorBackupPolicy.PRIOR_BACKUP_POLICY_UNSPECIFIED;
    case 1:
    case "PRIOR_BACKUP_POLICY_NO_BACKUP":
      return Project_PriorBackupPolicy.PRIOR_BACKUP_POLICY_NO_BACKUP;
    case 2:
    case "PRIOR_BACKUP_POLICY_BACKUP_ON_ERROR_STOP":
      return Project_PriorBackupPolicy.PRIOR_BACKUP_POLICY_BACKUP_ON_ERROR_STOP;
    case 3:
    case "PRIOR_BACKUP_POLICY_BACKUP_ON_ERROR_SKIP":
      return Project_PriorBackupPolicy.PRIOR_BACKUP_POLICY_BACKUP_ON_ERROR_SKIP;
    case -1:
    case "UNRECOGNIZED":
    default:
      return Project_PriorBackupPolicy.UNRECOGNIZED;
  }
}

export function project_PriorBackupPolicyToJSON(object: Project_PriorBackupPolicy): string {
  switch (object) {
    case Project_PriorBackupPolicy.PRIOR_BACKUP_POLICY_UNSPECIFIED:
      return "PRIOR_BACKUP_POLICY_UNSPECIFIED";
    case Project_PriorBackupPolicy.PRIOR_BACKUP_POLICY_NO_BACKUP:
      return "PRIOR_BACKUP_POLICY_NO_BACKUP";
    case Project_PriorBackupPolicy.PRIOR_BACKUP_POLICY_BACKUP_ON_ERROR_STOP:
      return "PRIOR_BACKUP_POLICY_BACKUP_ON_ERROR_STOP";
    case Project_PriorBackupPolicy.PRIOR_BACKUP_POLICY_BACKUP_ON_ERROR_SKIP:
      return "PRIOR_BACKUP_POLICY_BACKUP_ON_ERROR_SKIP";
    case Project_PriorBackupPolicy.UNRECOGNIZED:
    default:
      return "UNRECOGNIZED";
  }
}

export function project_PriorBackupPolicyToNumber(object: Project_PriorBackupPolicy): number {
  switch (object) {
    case Project_PriorBackupPolicy.PRIOR_BACKUP_POLICY_UNSPECIFIED:
      return 0;
    case Project_PriorBackupPolicy.PRIOR_BACKUP_POLICY_NO_BACKUP:
...
function createBaseProject(): Project {
  return {
    ...
    priorBackupPolicy: Project_PriorBackupPolicy.PRIOR_BACKUP_POLICY_UNSPECIFIED,
  };
}
...
export const Project = {
  encode(message: Project, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.priorBackupPolicy !== Project_PriorBackupPolicy.PRIOR_BACKUP_POLICY_UNSPECIFIED) {
      writer.uint32(144).int32(project_PriorBackupPolicyToNumber(message.priorBackupPolicy));
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 18:
          ...
          message.priorBackupPolicy = project_PriorBackupPolicyFromJSON(reader.int32());
          continue;
      }
      if ((tag & 7) === 4 || tag === 0) {
        break;
  ...
  fromJSON(object: any): Project {
    return {
      ...
      priorBackupPolicy: isSet(object.priorBackupPolicy)
        ? project_PriorBackupPolicyFromJSON(object.priorBackupPolicy)
        : Project_PriorBackupPolicy.PRIOR_BACKUP_POLICY_UNSPECIFIED,
    };
  },
  ...
  toJSON(message: Project): unknown {
    ...
    if (message.priorBackupPolicy !== Project_PriorBackupPolicy.PRIOR_BACKUP_POLICY_UNSPECIFIED) {
      obj.priorBackupPolicy = project_PriorBackupPolicyToJSON(message.priorBackupPolicy);
    }
    return obj;
  },
  ...
  fromPartial(object: DeepPartial<Project>): Project {
    ...
    message.priorBackupPolicy = object.priorBackupPolicy ?? Project_PriorBackupPolicy.PRIOR_BACKUP_POLICY_UNSPECIFIED;
    return message;
  },
};
