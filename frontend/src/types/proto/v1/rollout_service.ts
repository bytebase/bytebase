...
export const TaskRunLogEntry = {
  encode(message: TaskRunLogEntry, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.instanceUuid !== "") {
      writer.uint32(98).string(message.instanceUuid);
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 12:
          ...
          message.instanceUuid = reader.string();
          continue;
        case 2:
          if (tag !== 18) {
            break;
  ...
  fromJSON(object: any): TaskRunLogEntry {
    return {
      ...
      instanceUuid: isSet(object.instanceUuid) ? globalThis.String(object.instanceUuid) : "",
  ...
  toJSON(message: TaskRunLogEntry): unknown {
    ...
    if (message.instanceUuid !== "") {
      obj.instanceUuid = message.instanceUuid;
    }
    if (message.schemaDump !== undefined) {
  ...
  fromPartial(object: DeepPartial<TaskRunLogEntry>): TaskRunLogEntry {
    ...
    message.instanceUuid = object.instanceUuid ?? "";
