...
export const ListInboxResponse = {
  ...
  fromJSON(object: any): ListInboxResponse {
    return {
      inboxMessages: globalThis.Array.isArray(object?.inboxMessages)
...
export const InboxMessage = {
  ...
  fromJSON(object: any): InboxMessage {
    return {
      ...
      activityUid: isSet(object.activityUid) ? globalThis.String(object.activityUid) : "",
...
export const InboxSummary = {
  ...
  fromJSON(object: any): InboxSummary {
    return {
      ...
      unreadError: isSet(object.unreadError) ? globalThis.Number(object.unreadError) : 0,
    };
  },
