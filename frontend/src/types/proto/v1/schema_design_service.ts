...
export interface DeparseSchemaMetadataRequest {
  /** The metadata of the schema to deparse. */
  schemaMetadata?:
    | DatabaseMetadata
    | undefined;
  /** The database engine of the schema string. */
...
export interface DeparseSchemaMetadataResponse {
  /** The schema string. */
  schemaString: string;
}
...
function createBaseDeparseSchemaMetadataRequest(): DeparseSchemaMetadataRequest {
  return { schemaMetadata: undefined, engine: 0 };
}

export const DeparseSchemaMetadataRequest = {
  encode(message: DeparseSchemaMetadataRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.schemaMetadata !== undefined) {
      DatabaseMetadata.encode(message.schemaMetadata, writer.uint32(10).fork()).ldelim();
    }
    if (message.engine !== 0) {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): DeparseSchemaMetadataRequest {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseDeparseSchemaMetadataRequest();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): DeparseSchemaMetadataRequest {
    return {
      schemaMetadata: isSet(object.schemaMetadata) ? DatabaseMetadata.fromJSON(object.schemaMetadata) : undefined,
      engine: isSet(object.engine) ? engineFromJSON(object.engine) : 0,
    };
  ...
  toJSON(message: DeparseSchemaMetadataRequest): unknown {
    const obj: any = {};
    message.schemaMetadata !== undefined &&
      (obj.schemaMetadata = message.schemaMetadata ? DatabaseMetadata.toJSON(message.schemaMetadata) : undefined);
    message.engine !== undefined && (obj.engine = engineToJSON(message.engine));
  ...
  create(base?: DeepPartial<DeparseSchemaMetadataRequest>): DeparseSchemaMetadataRequest {
    return DeparseSchemaMetadataRequest.fromPartial(base ?? {});
  },

  fromPartial(object: DeepPartial<DeparseSchemaMetadataRequest>): DeparseSchemaMetadataRequest {
    const message = createBaseDeparseSchemaMetadataRequest();
    message.schemaMetadata = (object.schemaMetadata !== undefined && object.schemaMetadata !== null)
      ? DatabaseMetadata.fromPartial(object.schemaMetadata)
      : undefined;
...
function createBaseDeparseSchemaMetadataResponse(): DeparseSchemaMetadataResponse {
  return { schemaString: "" };
}

export const DeparseSchemaMetadataResponse = {
  encode(message: DeparseSchemaMetadataResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.schemaString !== "") {
      writer.uint32(10).string(message.schemaString);
    }
    return writer;
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): DeparseSchemaMetadataResponse {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseDeparseSchemaMetadataResponse();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): DeparseSchemaMetadataResponse {
    return { schemaString: isSet(object.schemaString) ? String(object.schemaString) : "" };
  },

  toJSON(message: DeparseSchemaMetadataResponse): unknown {
    const obj: any = {};
    message.schemaString !== undefined && (obj.schemaString = message.schemaString);
    return obj;
  },

  create(base?: DeepPartial<DeparseSchemaMetadataResponse>): DeparseSchemaMetadataResponse {
    return DeparseSchemaMetadataResponse.fromPartial(base ?? {});
  },

  fromPartial(object: DeepPartial<DeparseSchemaMetadataResponse>): DeparseSchemaMetadataResponse {
    const message = createBaseDeparseSchemaMetadataResponse();
    message.schemaString = object.schemaString ?? "";
    return message;
  },
...
export const SchemaDesignServiceDefinition = {
  ...
  methods: {
    ...
    deparseSchemaMetadata: {
      name: "DeparseSchemaMetadata",
      requestType: DeparseSchemaMetadataRequest,
      requestStream: false,
      responseType: DeparseSchemaMetadataResponse,
      responseStream: false,
      options: {
        _unknownFields: {
          578365826: [
