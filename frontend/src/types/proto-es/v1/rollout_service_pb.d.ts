...
export declare type TaskRunLogEntry = Message<"bytebase.v1.TaskRunLogEntry"> & {
   ...
   */
  computeDiff?: TaskRunLogEntry_ComputeDiff | undefined;
   ...
   */
  releaseFileExecute?: TaskRunLogEntry_ReleaseFileExecute | undefined;
   ...
   */
  ghostMigration?: TaskRunLogEntry_GhostMigration | undefined;
};
...
export declare type TaskRunLogEntry_PriorBackup = Message<"bytebase.v1.TaskRunLogEntry.PriorBackup"> & {
   ...
   */
  priorBackupDetail?: TaskRunLogEntry_PriorBackup_PriorBackupDetail | undefined;
...
export declare type TaskRunLogEntry_PriorBackup_PriorBackupDetail_Item = Message<"bytebase.v1.TaskRunLogEntry.PriorBackup.PriorBackupDetail.Item"> & {
   ...
   */
  sourceTable?: TaskRunLogEntry_PriorBackup_PriorBackupDetail_Item_Table | undefined;
   ...
   */
  targetTable?: TaskRunLogEntry_PriorBackup_PriorBackupDetail_Item_Table | undefined;
...
export declare type TaskRunSession_Postgres = Message<"bytebase.v1.TaskRunSession.Postgres"> & {
   ...
   */
  session?: TaskRunSession_Postgres_Session | undefined;
