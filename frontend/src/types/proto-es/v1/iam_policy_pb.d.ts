...
export declare type Binding = Message<"bytebase.v1.Binding"> & {
   ...
   *     - Modeled non-table object DDL (gated at the DATABASE level by the object's own explicit database/schema qualifier; an unqualified name keeps the request-database check): CREATE/ALTER/DROP of view, procedure/function/routine, trigger, sequence, synonym, type, and (Oracle) package, cluster, materialized view.
