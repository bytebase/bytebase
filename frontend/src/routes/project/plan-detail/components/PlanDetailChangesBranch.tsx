...
import { GhostFlagsButton } from "@/components/ghost/GhostFlagsButton";
...
import { getProjectNameAndDatabaseGroupName, pushNotification } from "@/stores";
...
export function DatabaseGroupTarget({
  ...
  const cachedGroup = useAppStore((s) =>
    s.dbGroupViewByName[target] === DatabaseGroupView.FULL
      ? s.dbGroupsByName[target]
      : undefined
  );
