...
import {
  ...
  type ThemeAnchors,
  themeToAnchors,
} from "@/modules/sql-editor/components/theme/derive";
import {
  DEFAULT_THEME_ID,
  PRESET_BY_ID,
  PRESETS,
} from "@/modules/sql-editor/components/theme/presets";
import type {
  SQLEditorTheme,
  SQLEditorThemeToken,
} from "@/modules/sql-editor/components/theme/types";
import { resolveWorkspaceTheme } from "@/modules/sql-editor/components/theme/useWorkspaceSQLEditorTheme";
import { DEFAULT_MAX_RESULT_SIZE_IN_MB } from "@/stores";
