...
INSERT INTO public.issue (id, creator_id, created_at, updated_at, project, plan_id, pipeline_id, name, status, type, description, payload, ts_vector) VALUES (101, 101, '2025-05-26 08:26:15.26631+00', '2025-05-26 08:26:16.121796+00', 'hr', 101, 101, '', 'OPEN', 'DATABASE_CHANGE', '', '{"labels": ["3.6.2", "feature"], "approval": {"riskLevel": "HIGH", "approvalTemplate": {"id": "bb.project-owner-workspace-dba", "flow": {"roles": ["roles/projectOwner", "roles/workspaceDBA"]}, "title": "Project Owner -> Workspace DBA", "description": "The system defines the approval process, first the project Owner approves, then the DBA approves."}, "approvalFindingDone": true}}', '''add'':3 ''column'':5 ''email'':4 ''employee'':7 ''here'':2 ''start'':1 ''table'':8 ''to'':6') ON CONFLICT DO NOTHING;
...
SELECT pg_catalog.setval('public.instance_change_history_id_seq', 167, true);
...
SELECT pg_catalog.setval('public.setting_id_seq', 144, true);
