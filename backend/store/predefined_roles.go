...
var PredefinedRoles = []*RoleMessage{
	{
		...
		Permissions: permissionSet(
			...
			permission.DatabasesDiffMetadata,
			...
			permission.SavedQueriesCreate,
			permission.SavedQueriesSearch,
			permission.SavedQueriesGet,
			permission.SavedQueriesGetIamPolicy,
			permission.SavedQueriesList,
			permission.SavedQueriesUpdate,
			permission.SavedQueriesDelete,
			...
			permission.ServiceAccountsGet,
			permission.ServiceAccountsList,
			permission.ServiceAccountsUndelete,
			permission.ServiceAccountsUpdate,
			permission.WorkloadIdentitiesCreate,
			permission.WorkloadIdentitiesDelete,
			permission.WorkloadIdentitiesGet,
			permission.WorkloadIdentitiesList,
			permission.WorkloadIdentitiesUndelete,
			permission.WorkloadIdentitiesUpdate,
		),
	},
	{
