...
const (
	...
	// AdvisoryLockKeyProjectLifecycle is the namespace for project lifecycle gates.
	AdvisoryLockKeyProjectLifecycle AdvisoryLockKey = 1006
	// AdvisoryLockKeyInstanceLifecycle is the namespace for instance lifecycle gates.
	AdvisoryLockKeyInstanceLifecycle AdvisoryLockKey = 1007
