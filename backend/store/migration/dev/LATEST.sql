...
CREATE TABLE vcs (
    ...
    updated_ts BIGINT NOT NULL DEFAULT extract(epoch from now()),
    name TEXT NOT NULL,
    type TEXT NOT NULL CHECK (type IN ('GITLAB_SELF_HOST', 'GITHUB_COM', 'GITLAB_COM')),
...
CREATE TABLE sheet (
    ...
    source TEXT NOT NULL CHECK (source IN ('BYTEBASE', 'GITLAB_SELF_HOST', 'GITHUB_COM', 'GITLAB_COM')) DEFAULT 'BYTEBASE',
