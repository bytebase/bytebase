...
func init() {
	advisor.Register(db.Postgres, advisor.PostgreSQLDisallowAddNotNull, &StatementDisallowAddNotNullAdvisor{})
}
...
func (*StatementDisallowAddNotNullAdvisor) Check(ctx advisor.Context, statement string) ([]advisor.Advice, error) {
