			...
			want: resData{
				res: []base.Statement{
					...
					},
					{
						...
						Start:    &storepb.Position{Line: 3, Column: 4},
						End:      &storepb.Position{Line: 3, Column: 20},
					},
				},
			},
		},
				...
				res: []base.Statement{
					{
						...
						Start: &storepb.Position{Line: 1, Column: 1},
						End:   &storepb.Position{Line: 1, Column: int32(len(bigSQL) + 1)},
					},
				},
			},
		},
				...
				res: []base.Statement{
					{
						...
						Start: &storepb.Position{Line: 1, Column: 1},
						End:   &storepb.Position{Line: 1, Column: 53},
					},
					{
						Text:  "\n\t\t\t\t\t\tINSERT INTO \"tech_Book\" VALUES (0, 'abce_ksdf'), (1, 'lks''kjsafajdfl;\"ka');",
						Range: &storepb.Range{Start: 52, End: 135},
						Start: &storepb.Position{Line: 2, Column: 7},
						End:   &storepb.Position{Line: 2, Column: 83},
					},
				},
			},
		},
				...
				res: []base.Statement{
					{
						...
						End:   &storepb.Position{Line: 3, Column: 79},
					},
					{
						Text:     "\n\t\t\t\t\t\t-- this is the comment.\n\t\t\t\t\t\tINSERT INTO \"tech_Book\" VALUES (0, 'abce_ksdf'), (1, 'lks''kjsafajdfl;\"ka');",
						BaseLine: 2,
						...
						End:      &storepb.Position{Line: 5, Column: 83},
					},
				},
			},
		},
				...
				res: []base.Statement{
					{
						...
						Start: &storepb.Position{Line: 1, Column: 1},
						End:   &storepb.Position{Line: 8, Column: 10},
					},
					{
						Text:     "\n\t\t\t\t\t\tCREATE TABLE t(a int);",
						BaseLine: 7,
						...
						End:      &storepb.Position{Line: 9, Column: 29},
					},
				},
			},
		},
				...
				res: []base.Statement{
					{
						...
						Start: &storepb.Position{Line: 1, Column: 1},
						End:   &storepb.Position{Line: 8, Column: 18},
					},
					{
						Text:     "\n\t\t\t\t\t\tCREATE TABLE t(a int);",
						BaseLine: 7,
				...
				res: []base.Statement{
					{
						...
						Start: &storepb.Position{Line: 1, Column: 1},
						End:   &storepb.Position{Line: 5, Column: 93},
					},
				},
			},
		},
				...
				res: []base.Statement{
					{
						...
						Start: &storepb.Position{Line: 1, Column: 1},
						End:   &storepb.Position{Line: 1, Column: 32},
						Empty: false,
					},
				},
			},
				...
				res: []base.Statement{
					{
						...
						Start:    &storepb.Position{Line: 1, Column: 1},
						End:      &storepb.Position{Line: 1, Column: 35},
						Empty:    false,
					},
				},
			},
