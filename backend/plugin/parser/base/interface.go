...
type TransformDMLToSelectFunc func(statement string, sourceDatabase string, targetDatabase string, tableSuffix string) ([]string, error)
...
func TransformDMLToSelect(engine storepb.Engine, statement string, sourceDatabase string, targetDatabase string, tableSuffix string) ([]string, error) {
