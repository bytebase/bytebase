	...
	tests := []splitTestData{
		{
			...
			END;`,
						...
						End:      &storepb.Position{Line: 10, Column: 9},
					...
					},
					{
						...
						End:      &storepb.Position{Line: 12, Column: 24},
			...
			SELECT x;`,
						...
						End:      &storepb.Position{Line: 13, Column: 13},
					...
					},
					{
						...
						End:   &storepb.Position{Line: 14, Column: 4},
						Empty: true,
		...
		},
		{
			...
			FROM t;`,
						...
						End:   &storepb.Position{Line: 103, Column: 11},
					...
					},
					{
						...
						End:      &storepb.Position{Line: 103, Column: 28},
			...
			want: resData{
				res: []base.Statement{
					...
					},
					{
						...
						End:   &storepb.Position{Line: 1, Column: 40},
...
`,
				...
				res: []base.Statement{
					{
						...
						End:   &storepb.Position{Line: 2, Column: 24},
						Empty: true,
		...
		END ;`,
						Start: &storepb.Position{Line: 1, Column: 1},
						End:   &storepb.Position{Line: 14, Column: 8},
			...
			want: resData{
				res: []base.Statement{
					...
					},
					{
						...
						End:   &storepb.Position{Line: 2, Column: 79},
				...
				res: []base.Statement{
					{
						...
						End:   &storepb.Position{Line: 3, Column: 77},
					...
					},
					{
						...
						End:      &storepb.Position{Line: 7, Column: 83},
			...
			want: resData{
				res: []base.Statement{
					...
					},
					{
						...
						End:      &storepb.Position{Line: 9, Column: 17},
					...
					},
					{
						...
						// TODO(zp): Wait, but why the start position is larger than the end position?
						End:   &storepb.Position{Line: 10, Column: 7},
						Empty: true,
		...
		},
		{
			...
			want: resData{
				res: []base.Statement{
					{
						Text:  "# test for defining stored programs\n\t\t\t\t\t\tCREATE PROCEDURE dorepeat(p1 INT)\n\t\t\t\t\t\t/* This is a comment */\n\t\t\t\t\t\tBEGIN\n\t\t\t\t\t\t\tSET @x = 0;\n\t\t\t\t\t\t\tREPEAT SET @x = @x + 1; UNTIL @x > p1 END REPEAT;\n\t\t\t\t\t\tEND\n\t\t\t\t\t\t;",
						End:   &storepb.Position{Line: 8, Column: 8},
						Start: &storepb.Position{Line: 2, Column: 7},
					...
					},
					{
						...
						BaseLine: 7,
						Start:    &storepb.Position{Line: 9, Column: 7},
						End:      &storepb.Position{Line: 9, Column: 27},
					...
					},
					{
						...
						BaseLine: 8,
						Start:    &storepb.Position{Line: 10, Column: 7},
						End:      &storepb.Position{Line: 10, Column: 17},
					...
					},
					{
						...
						End:      &storepb.Position{Line: 11, Column: 7},
						Empty:    true,
