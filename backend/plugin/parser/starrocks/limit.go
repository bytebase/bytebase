...
func init() {
	base.RegisterResultLimitFunc(storepb.Engine_STARROCKS, statementWithResultLimit)
}

// statementWithResultLimit implements base.ResultLimitFunc for StarRocks, which
