...
`,
		...
		{
			name: "reverse_synonyms_and_complex_references",
			initialSchema: `
CREATE TABLE LOCAL_PRODUCTS (
    ID NUMBER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    NAME VARCHAR2(100) NOT NULL,
...
-- Drop view using synonyms
DROP VIEW PRODUCT_CUSTOMER_SUMMARY;

-- Drop synonyms
DROP SYNONYM CUSTOMERS;
DROP SYNONYM PRODUCTS;
`,
			description: "Reverse: Remove synonyms, sequences, and complex references",
		},
		{
