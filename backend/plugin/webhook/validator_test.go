...
func TestValidateWebhookURL(t *testing.T) {
	tests := []struct {
		name        string
		webhookType storepb.ProjectWebhook_Type
		webhookURL  string
		wantErr     bool
	}{
		// Slack tests
		{
			...
			webhookType: storepb.ProjectWebhook_SLACK,
		...
		// Discord tests
		{
			...
			webhookType: storepb.ProjectWebhook_DISCORD,
		...
		// Teams tests
		{
			...
			webhookType: storepb.ProjectWebhook_TEAMS,
		...
		// DingTalk tests
		{
			...
			webhookType: storepb.ProjectWebhook_DINGTALK,
		...
		// Feishu tests
		{
			...
			webhookType: storepb.ProjectWebhook_FEISHU,
		...
		{
			name:        "valid lark URL",
			webhookType: storepb.ProjectWebhook_LARK,
		...
		// WeCom tests
		{
			...
			webhookType: storepb.ProjectWebhook_WECOM,
		...
		// Unknown webhook type
		{
			...
			webhookType: storepb.ProjectWebhook_TYPE_UNSPECIFIED,
