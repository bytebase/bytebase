...
import (
	...
	v1 "github.com/bytebase/bytebase/backend/server/api/v1"
	...
	"github.com/bytebase/bytebase/backend/server/runner/anomaly"
	"github.com/bytebase/bytebase/backend/server/runner/apprun"
	"github.com/bytebase/bytebase/backend/server/runner/backuprun"
	"github.com/bytebase/bytebase/backend/server/runner/metricreport"
	"github.com/bytebase/bytebase/backend/server/runner/rollbackrun"
	"github.com/bytebase/bytebase/backend/server/runner/schemasync"
	"github.com/bytebase/bytebase/backend/server/runner/taskcheck"
	"github.com/bytebase/bytebase/backend/server/runner/taskrun"
...
func NewServer(ctx context.Context, profile config.Profile) (*Server, error) {
	...
	v1pb.RegisterInstanceRoleServiceServer(s.grpcServer, v1.NewInstanceRoleService(s.store, dbfactory.New(s.mysqlBinDir, s.mongoBinDir, s.pgBinDir, profile.DataDir)))
