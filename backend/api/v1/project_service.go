...
func (s *ProjectService) convertStoreToAPIDatabaseGroupFull(ctx context.Context, databaseGroup *store.DatabaseGroupMessage, projectResourceID string) (*v1pb.DatabaseGroup, error) {
	matches, unmatches, err := s.getMatchesAndUnmatchedDatabases(ctx, databaseGroup, projectResourceID)
	if err != nil {
		return nil, err
	}
...
func (s *ProjectService) getMatchesAndUnmatchedDatabases(ctx context.Context, databaseGroup *store.DatabaseGroupMessage, projectResourceID string) ([]*store.DatabaseMessage, []*store.DatabaseMessage, error) {
...
func (s *ProjectService) getMatchesAndUnmatchedTables(ctx context.Context, schemaGroup *store.SchemaGroupMessage, databaseGroup *store.DatabaseGroupMessage, projectResourceID string) ([]*v1pb.SchemaGroup_Table, []*v1pb.SchemaGroup_Table, error) {
	matchesDatabases, _, err := s.getMatchesAndUnmatchedDatabases(ctx, databaseGroup, projectResourceID)
	if err != nil {
		return nil, nil, err
	}
