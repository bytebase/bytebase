...
var methodPermissionMap = map[string]iam.Permission{
	v1pb.InstanceService_ListInstances_FullMethodName:     iam.PermissionInstanceList,
	v1pb.InstanceService_GetInstance_FullMethodName:       iam.PermissionInstanceGet,
	v1pb.InstanceService_CreateInstance_FullMethodName:    iam.PermissionInstanceCreate,
	v1pb.InstanceService_UpdateInstance_FullMethodName:    iam.PermissionInstanceUpdate,
	v1pb.InstanceService_DeleteInstance_FullMethodName:    iam.PermissionInstanceDelete,
	v1pb.InstanceService_UndeleteInstance_FullMethodName:  iam.PermissionInstanceUndelete,
	v1pb.InstanceService_SyncInstance_FullMethodName:      iam.PermissionInstanceSync,
	v1pb.InstanceService_BatchSyncInstance_FullMethodName: iam.PermissionInstanceSync,
	v1pb.InstanceService_AddDataSource_FullMethodName:     iam.PermissionInstanceUpdate,
	v1pb.InstanceService_RemoveDataSource_FullMethodName:  iam.PermissionInstanceUpdate,
	v1pb.InstanceService_UpdateDataSource_FullMethodName:  iam.PermissionInstanceUpdate,
	v1pb.InstanceService_SyncSlowQueries_FullMethodName:   iam.PermissionInstanceSync,
