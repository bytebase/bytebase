...
func (s *BranchService) checkSchemaDesignPermission(ctx context.Context, projectUID int) error {
...
func (s *BranchService) checkProtectionRules(ctx context.Context, project *store.ProjectMessage, schemaDesign *v1pb.SchemaDesign, currentPrincipalID int) error {
...
func (*BranchService) ParseSchemaString(_ context.Context, request *v1pb.ParseSchemaStringRequest) (*v1pb.ParseSchemaStringResponse, error) {
...
func (s *BranchService) listSheets(ctx context.Context, find *store.FindSheetMessage) ([]*store.SheetMessage, error) {
	principalID, ok := ctx.Value(common.PrincipalIDContextKey).(int)
	if !ok {
		return nil, status.Errorf(codes.Internal, "principal ID not found")
	}
...
func (s *BranchService) getSheet(ctx context.Context, find *store.FindSheetMessage) (*store.SheetMessage, error) {
	principalID, ok := ctx.Value(common.PrincipalIDContextKey).(int)
	if !ok {
		return nil, status.Errorf(codes.Internal, "principal ID not found")
	}
...
func (s *BranchService) convertSheetToSchemaDesign(ctx context.Context, sheet *store.SheetMessage, view v1pb.SchemaDesignView) (*v1pb.SchemaDesign, error) {
