...
type EnumTypeMetadata struct {
	...
	// The fingerprint is the hash value for the entire enum type.
...
func (x *EnumTypeMetadata) GetFingerprint() string {
	if x != nil {
...
type SequenceMetadata struct {
	...
	// The fingerprint is the hash value for the entire sequence.
...
func (x *SequenceMetadata) GetFingerprint() string {
	if x != nil {
		return x.Fingerprint
	}
	return ""
...
type TriggerMetadata struct {
	...
	// The fingerprint is the hash value for the entire trigger.
...
func (x *TriggerMetadata) GetFingerprint() string {
	if x != nil {
		return x.Fingerprint
	}
	return ""
...
type RuleMetadata struct {
	...
	// The fingerprint is the hash value for the entire rule.
...
func (x *RuleMetadata) GetFingerprint() string {
	if x != nil {
		return x.Fingerprint
	}
	return ""
...
type TableMetadata struct {
	...
	// The fingerprint is the hash value for the entire table.
...
func (x *TableMetadata) GetFingerprint() string {
	if x != nil {
		return x.Fingerprint
	}
	return ""
...
type CheckConstraintMetadata struct {
	...
	// The fingerprint is the hash value for the entire check constraint.
...
func (x *CheckConstraintMetadata) GetFingerprint() string {
	if x != nil {
		return x.Fingerprint
	}
	return ""
...
type TablePartitionMetadata struct {
	...
	// The fingerprint is the hash value for the entire table partition.
...
func (x *TablePartitionMetadata) GetFingerprint() string {
	if x != nil {
		return x.Fingerprint
	}
	return ""
...
type ColumnMetadata struct {
	...
	// The fingerprint is the hash value for the entire column.
	Fingerprint string `protobuf:"bytes,21,opt,name=fingerprint,proto3" json:"fingerprint,omitempty"`
	// The default_fingerprint is the hash value for the default value of a column.
	DefaultFingerprint string `protobuf:"bytes,22,opt,name=default_fingerprint,json=defaultFingerprint,proto3" json:"default_fingerprint,omitempty"`
	unknownFields      protoimpl.UnknownFields
	sizeCache          protoimpl.SizeCache
}
...
func (x *ColumnMetadata) GetFingerprint() string {
	if x != nil {
		return x.Fingerprint
	}
	return ""
...
func (x *ColumnMetadata) GetDefaultFingerprint() string {
	if x != nil {
		return x.DefaultFingerprint
	}
	return ""
}
...
func (x *GenerationMetadata) GetFingerprint() string {
	if x != nil {
		return x.Fingerprint
	}
	return ""
...
type ViewMetadata struct {
	...
	// The fingerprint is the hash value for the entire view.
	Fingerprint   string `protobuf:"bytes,9,opt,name=fingerprint,proto3" json:"fingerprint,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ViewMetadata) GetFingerprint() string {
	if x != nil {
		return x.Fingerprint
	}
	return ""
...
type MaterializedViewMetadata struct {
	...
	SkipDump bool             `protobuf:"varint,7,opt,name=skip_dump,json=skipDump,proto3" json:"skip_dump,omitempty"`
	// The fingerprint is the hash value for the entire materialized view.
	Fingerprint   string `protobuf:"bytes,8,opt,name=fingerprint,proto3" json:"fingerprint,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *MaterializedViewMetadata) GetFingerprint() string {
	if x != nil {
		return x.Fingerprint
	}
	return ""
...
type FunctionMetadata struct {
	...
	SkipDump         bool               `protobuf:"varint,10,opt,name=skip_dump,json=skipDump,proto3" json:"skip_dump,omitempty"`
	// The fingerprint is the hash value for the entire function.
	Fingerprint   string `protobuf:"bytes,11,opt,name=fingerprint,proto3" json:"fingerprint,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *FunctionMetadata) GetFingerprint() string {
	if x != nil {
		return x.Fingerprint
	}
	return ""
...
type ProcedureMetadata struct {
	...
	// The fingerprint is the hash value for the entire procedure.
...
func (x *ProcedureMetadata) GetFingerprint() string {
	if x != nil {
		return x.Fingerprint
	}
	return ""
...
type IndexMetadata struct {
	...
	// The fingerprint is the hash value for the entire index.
...
func (x *IndexMetadata) GetFingerprint() string {
	if x != nil {
		return x.Fingerprint
	}
	return ""
...
type ForeignKeyMetadata struct {
	...
	// The fingerprint is the hash value for the entire foreign key.
	Fingerprint   string `protobuf:"bytes,9,opt,name=fingerprint,proto3" json:"fingerprint,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ForeignKeyMetadata) GetFingerprint() string {
	if x != nil {
		return x.Fingerprint
	}
	return ""
...
const file_store_database_proto_rawDesc = "" +
	...
	"\tskip_dump\x18\x10 \x01(\bR\bskipDump\"\x97\x01\n" +
	"\x10EnumTypeMetadata\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x16\n" +
	"\x06values\x18\x02 \x03(\tR\x06values\x12\x18\n" +
	"\acomment\x18\x03 \x01(\tR\acomment\x12\x1b\n" +
	"\tskip_dump\x18\x04 \x01(\bR\bskipDump\x12 \n" +
	"\vfingerprint\x18\x05 \x01(\tR\vfingerprint\"\xfa\x01\n" +
	...
	"\acomment\x18\a \x01(\tR\acomment\"\xa2\x03\n" +
	...
	"\tskip_dump\x18\r \x01(\bR\bskipDump\x12 \n" +
	"\vfingerprint\x18\x0e \x01(\tR\vfingerprint\"\xc0\x02\n" +
	...
	"\tskip_dump\x18\n" +
	" \x01(\bR\bskipDump\x12 \n" +
	"\vfingerprint\x18\v \x01(\tR\vfingerprint\"\xee\x01\n" +
	...
	"definition\x12 \n" +
	"\vfingerprint\x18\b \x01(\tR\vfingerprint\"\x80\x03\n" +
	...
	"\x10MODE_INSERT_ONLY\x10\x03\"\xdd\a\n" +
	...
	"\vfingerprint\x18\x19 \x01(\tR\vfingerprint\"o\n" +
	"\x17CheckConstraintMetadata\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x1e\n" +
	"\n" +
	"expression\x18\x02 \x01(\tR\n" +
	"expression\x12 \n" +
	"\vfingerprint\x18\x03 \x01(\tR\vfingerprint\"\xcd\x01\n" +
	...
	"\acolumns\x18\x04 \x03(\v2\x1e.bytebase.store.ColumnMetadataR\acolumns\"\xd0\x04\n" +
	...
	"\x11check_constraints\x18\b \x03(\v2'.bytebase.store.CheckConstraintMetadataR\x10checkConstraints\x12 \n" +
	"\vfingerprint\x18\t \x01(\tR\vfingerprint\"\x8a\x01\n" +
	"\x04Type\x12\x14\n" +
	...
	"\x17default_constraint_name\x18\x14 \x01(\tR\x15defaultConstraintName\x12 \n" +
	"\vfingerprint\x18\x15 \x01(\tR\vfingerprint\x12/\n" +
	"\x13default_fingerprint\x18\x16 \x01(\tR\x12defaultFingerprint\"U\n" +
	"\x12IdentityGeneration\x12#\n" +
	"\x1fIDENTITY_GENERATION_UNSPECIFIED\x10\x00\x12\n" +
	"\n" +
	"\x06ALWAYS\x10\x01\x12\x0e\n" +
	"\n" +
	"BY_DEFAULT\x10\x02\"\xd4\x01\n" +
	...
	"\x05rules\x18\b \x03(\v2\x1c.bytebase.store.RuleMetadataR\x05rules\x12 \n" +
	"\vfingerprint\x18\t \x01(\tR\vfingerprint\"X\n" +
	"\x10DependencyColumn\x12\x16\n" +
	"\x06schema\x18\x01 \x01(\tR\x06schema\x12\x14\n" +
	"\x05table\x18\x02 \x01(\tR\x05table\x12\x16\n" +
	"\x06column\x18\x03 \x01(\tR\x06column\"\xee\x02\n" +
	...
	"\tskip_dump\x18\a \x01(\bR\bskipDump\x12 \n" +
	"\vfingerprint\x18\b \x01(\tR\vfingerprint\"?\n" +
	"\x0fDependencyTable\x12\x16\n" +
	"\x06schema\x18\x01 \x01(\tR\x06schema\x12\x14\n" +
	"\x05table\x18\x02 \x01(\tR\x05table\"\xba\x03\n" +
	...
	"\tskip_dump\x18\n" +
	" \x01(\bR\bskipDump\x12 \n" +
	"\vfingerprint\x18\v \x01(\tR\vfingerprint\"\xed\x02\n" +
	...
	"\bsql_mode\x18\a \x01(\tR\asqlMode\x12\x18\n" +
	"\acomment\x18\t \x01(\tR\acomment\x12\x1b\n" +
	"\tskip_dump\x18\b \x01(\bR\bskipDump\x12 \n" +
	"\vfingerprint\x18\n" +
	" \x01(\tR\vfingerprint\"E\n" +
	...
	"\x10opclass_defaults\x18\x11 \x03(\bR\x0fopclassDefaults\x12 \n" +
	"\vfingerprint\x18\x12 \x01(\tR\vfingerprint\"\x96\x03\n" +
	...
	"\vdescription\x18\x04 \x01(\tR\vdescription\"\xc4\x02\n" +
	...
	"\n" +
	"match_type\x18\b \x01(\tR\tmatchType\x12 \n" +
