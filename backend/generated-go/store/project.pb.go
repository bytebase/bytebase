...
type Project struct {
	...
	RequireIssueApproval bool `protobuf:"varint,16,opt,name=require_issue_approval,json=requireIssueApproval,proto3" json:"require_issue_approval,omitempty"`
	// Whether to block rollout when plan check finds errors.
	RequirePlanCheckNoError bool `protobuf:"varint,17,opt,name=require_plan_check_no_error,json=requirePlanCheckNoError,proto3" json:"require_plan_check_no_error,omitempty"`
	unknownFields           protoimpl.UnknownFields
	sizeCache               protoimpl.SizeCache
}
...
const file_store_project_proto_rawDesc = "" +
	...
	"\x05group\x18\x03 \x01(\tR\x05group\"\x80\b\n" +
	"\aProject\x128\n" +
	...
	"\x12enforce_sql_review\x18\x0f \x01(\bR\x10enforceSqlReview\x124\n" +
	"\x16require_issue_approval\x18\x10 \x01(\bR\x14requireIssueApproval\x12<\n" +
	"\x1brequire_plan_check_no_error\x18\x11 \x01(\bR\x17requirePlanCheckNoError\x1a?\n" +
