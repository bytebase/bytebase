...
type Project struct {
	...
	IssueLabels []*Label `protobuf:"bytes,1,rep,name=issue_labels,json=issueLabels,proto3" json:"issue_labels,omitempty"`
	// Force issue labels to be used when creating an issue.
	ForceIssueLabels bool `protobuf:"varint,2,opt,name=force_issue_labels,json=forceIssueLabels,proto3" json:"force_issue_labels,omitempty"`
	// Allow modifying statement after issue is created.
	AllowModifyStatement bool `protobuf:"varint,3,opt,name=allow_modify_statement,json=allowModifyStatement,proto3" json:"allow_modify_statement,omitempty"`
	// Enable auto resolve issue.
	AutoResolveIssue bool `protobuf:"varint,4,opt,name=auto_resolve_issue,json=autoResolveIssue,proto3" json:"auto_resolve_issue,omitempty"`
	// Enforce issue title created by user instead of generated by Bytebase.
	EnforceIssueTitle bool `protobuf:"varint,5,opt,name=enforce_issue_title,json=enforceIssueTitle,proto3" json:"enforce_issue_title,omitempty"`
	// Whether to automatically enable backup.
	AutoEnableBackup bool `protobuf:"varint,6,opt,name=auto_enable_backup,json=autoEnableBackup,proto3" json:"auto_enable_backup,omitempty"`
	// Whether to skip backup errors and continue the data migration.
	SkipBackupErrors bool `protobuf:"varint,7,opt,name=skip_backup_errors,json=skipBackupErrors,proto3" json:"skip_backup_errors,omitempty"`
	...
	PostgresDatabaseTenantMode bool `protobuf:"varint,8,opt,name=postgres_database_tenant_mode,json=postgresDatabaseTenantMode,proto3" json:"postgres_database_tenant_mode,omitempty"`
	// Whether to allow the issue creator to self-approve the issue.
	AllowSelfApproval bool `protobuf:"varint,9,opt,name=allow_self_approval,json=allowSelfApproval,proto3" json:"allow_self_approval,omitempty"`
	// Configuration for automatic retry on task execution failures.
	ExecutionRetryPolicy *Project_ExecutionRetryPolicy `protobuf:"bytes,10,opt,name=execution_retry_policy,json=executionRetryPolicy,proto3" json:"execution_retry_policy,omitempty"`
	...
	CiSamplingSize int32 `protobuf:"varint,11,opt,name=ci_sampling_size,json=ciSamplingSize,proto3" json:"ci_sampling_size,omitempty"`
	// The maximum number of parallel tasks to run during the rollout.
	ParallelTasksPerRollout int32 `protobuf:"varint,12,opt,name=parallel_tasks_per_rollout,json=parallelTasksPerRollout,proto3" json:"parallel_tasks_per_rollout,omitempty"`
	...
	EnforceSqlReview bool `protobuf:"varint,14,opt,name=enforce_sql_review,json=enforceSqlReview,proto3" json:"enforce_sql_review,omitempty"`
...
const file_store_project_proto_rawDesc = "" +
	...
	"\x05group\x18\x03 \x01(\tR\x05group\"\xfa\a\n" +
	"\aProject\x128\n" +
	"\fissue_labels\x18\x01 \x03(\v2\x15.bytebase.store.LabelR\vissueLabels\x12,\n" +
	"\x12force_issue_labels\x18\x02 \x01(\bR\x10forceIssueLabels\x124\n" +
	"\x16allow_modify_statement\x18\x03 \x01(\bR\x14allowModifyStatement\x12,\n" +
	"\x12auto_resolve_issue\x18\x04 \x01(\bR\x10autoResolveIssue\x12.\n" +
	"\x13enforce_issue_title\x18\x05 \x01(\bR\x11enforceIssueTitle\x12,\n" +
	"\x12auto_enable_backup\x18\x06 \x01(\bR\x10autoEnableBackup\x12,\n" +
	"\x12skip_backup_errors\x18\a \x01(\bR\x10skipBackupErrors\x12A\n" +
	"\x1dpostgres_database_tenant_mode\x18\b \x01(\bR\x1apostgresDatabaseTenantMode\x12.\n" +
	"\x13allow_self_approval\x18\t \x01(\bR\x11allowSelfApproval\x12b\n" +
	"\x16execution_retry_policy\x18\n" +
	" \x01(\v2,.bytebase.store.Project.ExecutionRetryPolicyR\x14executionRetryPolicy\x12(\n" +
	"\x10ci_sampling_size\x18\v \x01(\x05R\x0eciSamplingSize\x12;\n" +
	"\x1aparallel_tasks_per_rollout\x18\f \x01(\x05R\x17parallelTasksPerRollout\x12;\n" +
