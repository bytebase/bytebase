...
const file_v1_service_account_service_proto_rawDesc = "" +
	...
	"\x11GetServiceAccount\x12%.bytebase.v1.GetServiceAccountRequest\x1a\x1b.bytebase.v1.ServiceAccount\"Q\xdaA\x04name\x8a\xea0\x16bb.serviceAccounts.get\x90\xea0\x01\xa0\xea0\x04\xb0\xea0\x01\x82\xd3\xe4\x93\x02\x1e\x12\x1c/v1/{name=serviceAccounts/*}\x12\xf7\x01\n" +
	"\x13ListServiceAccounts\x12'.bytebase.v1.ListServiceAccountsRequest\x1a(.bytebase.v1.ListServiceAccountsResponse\"\x8c\x01\xdaA\x06parent\x8a\xea0\x17bb.serviceAccounts.list\x90\xea0\x01\xa0\xea0\x04\xb0\xea0\x01\x82\xd3\xe4\x93\x02VZ+\x12)/v1/{parent=workspaces/*}/serviceAccounts\x12'/v1/{parent=projects/*}/serviceAccounts\x12\xf0\x01\n" +
	...
	"\x14DeleteServiceAccount\x12(.bytebase.v1.DeleteServiceAccountRequest\x1a\x16.google.protobuf.Empty\"X\xdaA\x04name\x8a\xea0\x19bb.serviceAccounts.delete\x90\xea0\x01\x98\xea0\x01\xa0\xea0\x04\xb0\xea0\x01\x82\xd3\xe4\x93\x02\x1e*\x1c/v1/{name=serviceAccounts/*}\x12\xc2\x01\n" +
	"\x16UndeleteServiceAccount\x12*.bytebase.v1.UndeleteServiceAccountRequest\x1a\x1b.bytebase.v1.ServiceAccount\"_\x8a\xea0\x1bbb.serviceAccounts.undelete\x90\xea0\x01\x98\xea0\x01\xa0\xea0\x04\xb0\xea0\x01\x82\xd3\xe4\x93\x02*:\x01*\"%/v1/{name=serviceAccounts/*}:undeleteB\xb0\x01\n" +
