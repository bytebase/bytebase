...
func (DataSourceExternalSecret_TokenType) EnumDescriptor() ([]byte, []int) {
	return file_v1_instance_service_proto_rawDescGZIP(), []int{19, 2}
}
...
type CreateInstanceRequest struct {
	...
	SyncDatabasesToProject string `protobuf:"bytes,4,opt,name=sync_databases_to_project,json=syncDatabasesToProject,proto3" json:"sync_databases_to_project,omitempty"`
	unknownFields          protoimpl.UnknownFields
	sizeCache              protoimpl.SizeCache
}
...
func (x *CreateInstanceRequest) GetSyncDatabasesToProject() string {
	if x != nil {
		return x.SyncDatabasesToProject
	}
	return ""
}
...
const file_v1_instance_service_proto_rawDesc = "" +
	...
	"instanceId\x12#\n" +
	"\rvalidate_only\x18\x03 \x01(\bR\fvalidateOnly\x129\n" +
	"\x19sync_databases_to_project\x18\x04 \x01(\tR\x16syncDatabasesToProject\"\xb1\x01\n" +
