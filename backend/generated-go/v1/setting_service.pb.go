...
const file_v1_setting_service_proto_rawDesc = "" +
	...
	"\x11password_rotation\x18\a \x01(\v2\x19.google.protobuf.DurationR\x10passwordRotation\"b\n" +
	...
	"\rUpdateSetting\x12!.bytebase.v1.UpdateSettingRequest\x1a\x14.bytebase.v1.Setting\"I\x8a\xea0\x0fbb.settings.set\x90\xea0\x02\x98\xea0\x01\x82\xd3\xe4\x93\x02(:\asetting2\x1d/v1/{setting.name=settings/*}\x12\xb4\x01\n" +
	"\x10TestEmailSetting\x12$.bytebase.v1.TestEmailSettingRequest\x1a%.bytebase.v1.TestEmailSettingResponse\"S\x8a\xea0\x0fbb.settings.set\x90\xea0\x01\xa0\xea0\x03\x82\xd3\xe4\x93\x022:\x01*\"-/v1/{parent=workspaces/*}/settings/EMAIL:testB\xa9\x01\n" +
