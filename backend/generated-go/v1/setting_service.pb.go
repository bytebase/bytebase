...
type WorkspaceApprovalSetting_Rule struct {
	...
	// When source is REQUEST_ACCESS, support: resource.environment_id, resource.project_id, request.unmask, request.data_export
	//
	// For examples:
...
const file_v1_setting_service_proto_rawDesc = "" +
	...
	"\x17allow_email_code_signin\x18\x16 \x01(\bR\x14allowEmailCodeSignin\x1a\x93\x03\n" +
