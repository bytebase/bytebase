...
const file_v1_query_history_service_proto_rawDesc = "" +
	...
	"\x06_error2\xad\x04\n" +
	"\x13QueryHistoryService\x12\xba\x01\n" +
	"\x14SearchQueryHistories\x12(.bytebase.v1.SearchQueryHistoriesRequest\x1a).bytebase.v1.SearchQueryHistoriesResponse\"M\xdaA\x06parent\x90\xea0\x02\xa0\xea0\x01\xb8\xea0\x01\x82\xd3\xe4\x93\x022:\x01*\"-/v1/{parent=projects/*}/queryHistories:search\x12\xc8\x01\n" +
	"\x12ListQueryHistories\x12&.bytebase.v1.ListQueryHistoriesRequest\x1a'.bytebase.v1.ListQueryHistoriesResponse\"a\xdaA\x06parent\x8a\xea0\x16bb.queryHistories.list\x90\xea0\x01\xa0\xea0\x04\xa8\xea0\n" +
	"\xb8\xea0\x01\x82\xd3\xe4\x93\x02(\x12&/v1/{parent=projects/*}/queryHistories\x12\x8d\x01\n" +
	"\x0fGetQueryHistory\x12#.bytebase.v1.GetQueryHistoryRequest\x1a\x19.bytebase.v1.QueryHistory\":\x90\xea0\x02\xa0\xea0\x01\xb8\xea0\x01\x82\xd3\xe4\x93\x02(\x12&/v1/{name=projects/*/queryHistories/*}B\xae\x01\n" +
