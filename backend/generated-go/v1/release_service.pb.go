...
type ListReleaseCategoriesRequest struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Format: projects/{project}
	Parent        string `protobuf:"bytes,1,opt,name=parent,proto3" json:"parent,omitempty"`
	unknownFields protoimpl.UnknownFields
...
func (x *ListReleaseCategoriesRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
type ListReleaseCategoriesResponse struct {
	state protoimpl.MessageState `protogen:"open.v1"`
...
func (x *ListReleaseCategoriesResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *Release) GetCategory() string {
	if x != nil {
		return x.Category
	}
	return ""
...
const file_v1_release_service_proto_rawDesc = "" +
	...
	"\x14bytebase.com/ReleaseR\x04name\"\xc2\x01\n" +
	...
	"\n" +
	"risk_level\x18\x05 \x01(\x0e2\x16.bytebase.v1.RiskLevelR\triskLevel\"T\n" +
	"\x1cListReleaseCategoriesRequest\x124\n" +
	"\x06parent\x18\x01 \x01(\tB\x1c\xe0A\x02\xfaA\x16\n" +
	...
	"\x14bytebase.com/Release\x12%projects/{project}/releases/{release}2\x80\v\n" +
	"\x0eReleaseService\x12\x92\x01\n" +
	"\n" +
	"GetRelease\x12\x1e.bytebase.v1.GetReleaseRequest\x1a\x14.bytebase.v1.Release\"N\xdaA\x04name\x8a\xea0\x0fbb.releases.get\x90\xea0\x01\xa0\xea0\x01\xb8\xea0\x01\x82\xd3\xe4\x93\x02\"\x12 /v1/{name=projects/*/releases/*}\x12\xa6\x01\n" +
	"\fListReleases\x12 .bytebase.v1.ListReleasesRequest\x1a!.bytebase.v1.ListReleasesResponse\"Q\xdaA\x06parent\x8a\xea0\x10bb.releases.list\x90\xea0\x01\xa0\xea0\x01\xb8\xea0\x01\x82\xd3\xe4\x93\x02\"\x12 /v1/{parent=projects/*}/releases\x12\xae\x01\n" +
	"\rCreateRelease\x12!.bytebase.v1.CreateReleaseRequest\x1a\x14.bytebase.v1.Release\"d\xdaA\x0eparent,release\x8a\xea0\x12bb.releases.create\x90\xea0\x01\xa0\xea0\x02\xb8\xea0\x02\x82\xd3\xe4\x93\x02+:\arelease\" /v1/{parent=projects/*}/releases\x12\xbb\x01\n" +
	"\rUpdateRelease\x12!.bytebase.v1.UpdateReleaseRequest\x1a\x14.bytebase.v1.Release\"q\xdaA\x13release,update_mask\x8a\xea0\x12bb.releases.update\x90\xea0\x01\xa0\xea0\x02\xb8\xea0\x02\x82\xd3\xe4\x93\x023:\arelease2(/v1/{release.name=projects/*/releases/*}\x12\x9d\x01\n" +
	"\rDeleteRelease\x12!.bytebase.v1.DeleteReleaseRequest\x1a\x16.google.protobuf.Empty\"Q\xdaA\x04name\x8a\xea0\x12bb.releases.delete\x90\xea0\x01\xa0\xea0\x02\xb8\xea0\x02\x82\xd3\xe4\x93\x02\"* /v1/{name=projects/*/releases/*}\x12\xa3\x01\n" +
	"\x0fUndeleteRelease\x12#.bytebase.v1.UndeleteReleaseRequest\x1a\x14.bytebase.v1.Release\"U\x8a\xea0\x14bb.releases.undelete\x90\xea0\x01\xa0\xea0\x02\xb8\xea0\x02\x82\xd3\xe4\x93\x02+\")/v1/{name=projects/*/releases/*}:undelete\x12\xa7\x01\n" +
	"\fCheckRelease\x12 .bytebase.v1.CheckReleaseRequest\x1a!.bytebase.v1.CheckReleaseResponse\"R\x8a\xea0\x11bb.releases.check\x90\xea0\x01\xa0\xea0\x02\xb8\xea0\x01\x82\xd3\xe4\x93\x02+:\x01*\"&/v1/{parent=projects/*}/releases:check\x12\xd0\x01\n" +
	"\x15ListReleaseCategories\x12).bytebase.v1.ListReleaseCategoriesRequest\x1a*.bytebase.v1.ListReleaseCategoriesResponse\"`\xdaA\x06parent\x8a\xea0\x10bb.releases.list\x90\xea0\x01\xa0\xea0\x01\xb8\xea0\x01\x82\xd3\xe4\x93\x021\x12//v1/{parent=projects/*}/releases:listCategoriesB\xa9\x01\n" +
