...
const file_v1_workload_identity_service_proto_rawDesc = "" +
	...
	"\x04name\x18\x01 \x01(\tB%\xe0A\x02\xfaA\x1f\n" +
	"\x1dbytebase.com/WorkloadIdentityR\x04name2\x9d\v\n" +
	"\x17WorkloadIdentityService\x12\xcb\x02\n" +
	"\x16CreateWorkloadIdentity\x12*.bytebase.v1.CreateWorkloadIdentityRequest\x1a\x1d.bytebase.v1.WorkloadIdentity\"\xe5\x01\xdaA-parent,workload_identity,workload_identity_id\x8a\xea0\x1cbb.workloadIdentities.create\x90\xea0\x01\x98\xea0\x01\xa0\xea0\x03\x82\xd3\xe4\x93\x02\x82\x01:\x11workload_identityZA:\x11workload_identity\",/v1/{parent=workspaces/*}/workloadIdentities\"*/v1/{parent=projects/*}/workloadIdentities\x12\xae\x01\n" +
	...
	"\x16ListWorkloadIdentities\x12*.bytebase.v1.ListWorkloadIdentitiesRequest\x1a+.bytebase.v1.ListWorkloadIdentitiesResponse\"\x8d\x01\xdaA\x06parent\x8a\xea0\x1abb.workloadIdentities.list\x90\xea0\x01\x82\xd3\xe4\x93\x02\\Z.\x12,/v1/{parent=workspaces/*}/workloadIdentities\x12*/v1/{parent=projects/*}/workloadIdentities\x12\xfe\x01\n" +
	"\x16UpdateWorkloadIdentity\x12*.bytebase.v1.UpdateWorkloadIdentityRequest\x1a\x1d.bytebase.v1.WorkloadIdentity\"\x98\x01\xdaA\x1dworkload_identity,update_mask\x8a\xea0\x1cbb.workloadIdentities.update\x90\xea0\x01\x98\xea0\x01\xa0\xea0\x03\x82\xd3\xe4\x93\x02F:\x11workload_identity21/v1/{workload_identity.name=workloadIdentities/*}\x12\xb4\x01\n" +
