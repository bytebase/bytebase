...
const file_v1_changelog_service_proto_rawDesc = "" +
	...
	"\x13CHANGELOG_VIEW_FULL\x10\x022\xfc\x03\n" +
	"\x10ChangelogService\x12\xfc\x01\n" +
	"\x0eListChangelogs\x12\".bytebase.v1.ListChangelogsRequest\x1a#.bytebase.v1.ListChangelogsResponse\"\xa0\x01\xdaA\x06parent\x8a\xea0\x12bb.changelogs.list\x90\xea0\x01\xa0\xea0\x01\xb8\xea0\x01\x82\xd3\xe4\x93\x02oZ<\x12:/v1/{parent=projects/*/instances/*/databases/*}/changelogs\x12//v1/{parent=instances/*/databases/*}/changelogs\x12\xe8\x01\n" +
	"\fGetChangelog\x12 .bytebase.v1.GetChangelogRequest\x1a\x16.bytebase.v1.Changelog\"\x9d\x01\xdaA\x04name\x8a\xea0\x11bb.changelogs.get\x90\xea0\x01\xa0\xea0\x01\xb8\xea0\x01\x82\xd3\xe4\x93\x02oZ<\x12:/v1/{name=projects/*/instances/*/databases/*/changelogs/*}\x12//v1/{name=instances/*/databases/*/changelogs/*}B\xab\x01\n" +
