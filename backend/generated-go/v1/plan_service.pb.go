...
type Plan_RolloutStageSummary struct {
	...
	// Keys are Task.Status enum names: NOT_STARTED, PENDING, RUNNING, DONE, FAILED, CANCELED, SKIPPED.
	TaskStatusCount map[string]int32 `protobuf:"bytes,2,rep,name=task_status_count,json=taskStatusCount,proto3" json:"task_status_count,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"varint,2,opt,name=value"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
func (x *Plan_RolloutStageSummary) GetTaskStatusCount() map[string]int32 {
	if x != nil {
...
const file_v1_plan_service_proto_rawDesc = "" +
	"\n" +
	"\x15v1/plan_service.proto\x12\vbytebase.v1\x1a\x1bbuf/validate/validate.proto\x1a\x1cgoogle/api/annotations.proto\x1a\x17google/api/client.proto\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\x1a google/protobuf/field_mask.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x13v1/annotation.proto\x1a\x0fv1/common.proto\x1a\x16v1/issue_service.proto\x1a\x14v1/sql_service.proto\"?\n" +
	...
	"updateMask\x12#\n" +
	"\rallow_missing\x18\x03 \x01(\bR\fallowMissing\"\xd4\x0f\n" +
	"\x04Plan\x12\x12\n" +
	...
	"\x13enable_prior_backup\x18\x06 \x01(\bR\x11enablePriorBackup\x1a\xa3\x01\n" +
	...
	"\t_password\x1a\xd7\x01\n" +
	"\x13RolloutStageSummary\x12\x14\n" +
	"\x05stage\x18\x01 \x01(\tR\x05stage\x12f\n" +
	"\x11task_status_count\x18\x02 \x03(\v2:.bytebase.v1.Plan.RolloutStageSummary.TaskStatusCountEntryR\x0ftaskStatusCount\x1aB\n" +
	"\x14TaskStatusCountEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\x05R\x05value:\x028\x01:7\xeaA4\n" +
...
var file_v1_plan_service_proto_goTypes = []any{
	...
	nil,                                          // 20: bytebase.v1.Plan.RolloutStageSummary.TaskStatusCountEntry
...
var file_v1_plan_service_proto_depIdxs = []int32{
	...
	20, // 18: bytebase.v1.Plan.RolloutStageSummary.task_status_count:type_name -> bytebase.v1.Plan.RolloutStageSummary.TaskStatusCountEntry
	...
	22, // 21: bytebase.v1.PlanCheckRun.Result.sql_summary_report:type_name -> bytebase.v1.PlanCheckRun.Result.SqlSummaryReport
	23, // 22: bytebase.v1.PlanCheckRun.Result.sql_review_report:type_name -> bytebase.v1.PlanCheckRun.Result.SqlReviewReport
