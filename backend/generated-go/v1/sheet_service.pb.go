...
const file_v1_sheet_service_proto_rawDesc = "" +
	...
	"\x12bytebase.com/Sheet\x12!projects/{project}/sheets/{sheet}2\xe8\x03\n" +
	"\fSheetService\x12\x9c\x01\n" +
	"\vCreateSheet\x12\x1f.bytebase.v1.CreateSheetRequest\x1a\x12.bytebase.v1.Sheet\"X\xdaA\fparent,sheet\x8a\xea0\x10bb.sheets.create\x90\xea0\x01\x98\xea0\x01\x82\xd3\xe4\x93\x02':\x05sheet\"\x1e/v1/{parent=projects/*}/sheets\x12\xb5\x01\n" +
	"\x11BatchCreateSheets\x12%.bytebase.v1.BatchCreateSheetsRequest\x1a&.bytebase.v1.BatchCreateSheetsResponse\"Q\x8a\xea0\x10bb.sheets.create\x90\xea0\x01\x98\xea0\x01\x82\xd3\xe4\x93\x02/:\x01*\"*/v1/{parent=projects/*}/sheets:batchCreate\x12\x80\x01\n" +
