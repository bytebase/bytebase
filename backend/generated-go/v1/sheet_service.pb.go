...
type Sheet struct {
	...
	//
	// Deprecated: Marked as deprecated in v1/sheet_service.proto.
...
const file_v1_sheet_service_proto_rawDesc = "" +
	...
	"\x03raw\x18\x02 \x01(\bR\x03raw\"\xcc\x01\n" +
	"\x05Sheet\x12\x1a\n" +
	"\x04name\x18\x01 \x01(\tB\x06\xe0A\x02\xe0A\x05R\x04name\x12\x18\n" +
	"\x05title\x18\x02 \x01(\tB\x02\x18\x01R\x05title\x12\x1d\n" +
	"\acontent\x18\x05 \x01(\fB\x03\xe0A\x02R\acontent\x12&\n" +
	"\fcontent_size\x18\x06 \x01(\x03B\x03\xe0A\x03R\vcontentSize::\xeaA7\n" +
	"\x12bytebase.com/Sheet\x12!projects/{project}/sheets/{sheet}J\x04\b\x03\x10\x04J\x04\b\x04\x10\x052\xe0\x03\n" +
