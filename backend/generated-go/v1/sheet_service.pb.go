...
const file_v1_sheet_service_proto_rawDesc = "" +
	...
	"\x12bytebase.com/Sheet\x12!projects/{project}/sheets/{sheet}2\xf4\x03\n" +
	"\fSheetService\x12\xa0\x01\n" +
	"\vCreateSheet\x12\x1f.bytebase.v1.CreateSheetRequest\x1a\x12.bytebase.v1.Sheet\"\\\xdaA\fparent,sheet\x8a\xea0\x10bb.sheets.create\x90\xea0\x01\x98\xea0\x01\xa0\xea0\x02\x82\xd3\xe4\x93\x02':\x05sheet\"\x1e/v1/{parent=projects/*}/sheets\x12\xb9\x01\n" +
	"\x11BatchCreateSheets\x12%.bytebase.v1.BatchCreateSheetsRequest\x1a&.bytebase.v1.BatchCreateSheetsResponse\"U\x8a\xea0\x10bb.sheets.create\x90\xea0\x01\x98\xea0\x01\xa0\xea0\x02\x82\xd3\xe4\x93\x02/:\x01*\"*/v1/{parent=projects/*}/sheets:batchCreate\x12\x84\x01\n" +
	"\bGetSheet\x12\x1c.bytebase.v1.GetSheetRequest\x1a\x12.bytebase.v1.Sheet\"F\xdaA\x04name\x8a\xea0\rbb.sheets.get\x90\xea0\x01\xa0\xea0\x01\x82\xd3\xe4\x93\x02 \x12\x1e/v1/{name=projects/*/sheets/*}B\xa7\x01\n" +
