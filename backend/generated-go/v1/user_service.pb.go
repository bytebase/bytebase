...
const file_v1_user_service_proto_rawDesc = "" +
	...
	"J\x04\b\n" +
	"\x10\vJ\x04\b\v\x10\fR\x0ftemp_otp_secretR\x13temp_recovery_codesR\x1ctemp_otp_secret_created_time2\x94\x12\n" +
	"\vUserService\x12|\n" +
	"\aGetUser\x12\x1b.bytebase.v1.GetUserRequest\x1a\x11.bytebase.v1.User\"A\xdaA\x04name\x8a\xea0\fbb.users.get\x90\xea0\x01\xa0\xea0\x04\xa8\xea0\t\xb8\xea0\x01\x82\xd3\xe4\x93\x02\x14\x12\x12/v1/{name=users/*}\x12\x92\x01\n" +
	"\rBatchGetUsers\x12!.bytebase.v1.BatchGetUsersRequest\x1a\".bytebase.v1.BatchGetUsersResponse\":\x8a\xea0\fbb.users.get\x90\xea0\x01\xa0\xea0\x04\xa8\xea0\t\xb8\xea0\x01\x82\xd3\xe4\x93\x02\x14\x12\x12/v1/users:batchGet\x12a\n" +
	"\x0eGetCurrentUser\x12\x16.google.protobuf.Empty\x1a\x11.bytebase.v1.User\"$\x80\xea0\x01\x90\xea0\x02\xa0\xea0\x01\xb8\xea0\x01\x82\xd3\xe4\x93\x02\x0e\x12\f/v1/users/me\x12\x87\x01\n" +
	"\tListUsers\x12\x1d.bytebase.v1.ListUsersRequest\x1a\x1e.bytebase.v1.ListUsersResponse\";\xdaA\x06parent\x8a\xea0\rbb.users.list\x90\xea0\x01\xa0\xea0\x04\xa8\xea0\t\xb8\xea0\x01\x82\xd3\xe4\x93\x02\v\x12\t/v1/users\x12\x82\x01\n" +
	"\n" +
	"CreateUser\x12\x1e.bytebase.v1.CreateUserRequest\x1a\x11.bytebase.v1.User\"A\xdaA\x04user\x8a\xea0\x0fbb.users.create\x90\xea0\x01\xa0\xea0\x03\xa8\xea0\x06\xb8\xea0\x02\x82\xd3\xe4\x93\x02\x11:\x04user\"\t/v1/users\x12\x89\x01\n" +
	"\n" +
	"UpdateUser\x12\x1e.bytebase.v1.UpdateUserRequest\x1a\x11.bytebase.v1.User\"H\xdaA\x10user,update_mask\x90\xea0\x02\xa0\xea0\x03\xa8\xea0\x03\xb8\xea0\x02\x82\xd3\xe4\x93\x02\x1f:\x04user2\x17/v1/{user.name=users/*}\x12w\n" +
	"\n" +
	"DeleteUser\x12\x1e.bytebase.v1.DeleteUserRequest\x1a\x16.google.protobuf.Empty\"1\xdaA\x04name\x90\xea0\x02\xa0\xea0\x04\xa8\xea0\t\xb8\xea0\x02\x82\xd3\xe4\x93\x02\x14*\x12/v1/{name=users/*}\x12{\n" +
	"\fUndeleteUser\x12 .bytebase.v1.UndeleteUserRequest\x1a\x11.bytebase.v1.User\"6\x90\xea0\x02\xa0\xea0\x04\xa8\xea0\t\xb8\xea0\x02\x82\xd3\xe4\x93\x02 :\x01*\"\x1b/v1/{name=users/*}:undelete\x12\xa1\x01\n" +
	"\vUpdateEmail\x12\x1f.bytebase.v1.UpdateEmailRequest\x1a\x11.bytebase.v1.User\"^\xdaA\n" +
	"name,email\x8a\xea0\x14bb.users.updateEmail\x90\xea0\x01\xa0\xea0\x03\xa8\xea0\x06\xb8\xea0\x02\x82\xd3\xe4\x93\x02#:\x01*\"\x1e/v1/{name=users/*}:updateEmail\x12\x9a\x01\n" +
	"\x11RequestReauthCode\x12%.bytebase.v1.RequestReauthCodeRequest\x1a\x16.google.protobuf.Empty\"F\xdaA\x04name\x90\xea0\x02\xa0\xea0\x03\xa8\xea0\x02\xb8\xea0\x02\x82\xd3\xe4\x93\x02):\x01*\"$/v1/{name=users/*}:requestReauthCode\x12\x99\x01\n" +
	"\x0eChangePassword\x12\".bytebase.v1.ChangePasswordRequest\x1a\x11.bytebase.v1.User\"P\xdaA\x11name,new_password\x90\xea0\x02\xa0\xea0\x03\xa8\xea0\x03\xb8\xea0\x02\x82\xd3\xe4\x93\x02&:\x01*\"!/v1/{name=users/*}:changePassword\x12\xae\x01\n" +
	"\x12StartMFAEnrollment\x12&.bytebase.v1.StartMFAEnrollmentRequest\x1a'.bytebase.v1.StartMFAEnrollmentResponse\"G\xdaA\x04name\x90\xea0\x02\xa0\xea0\x03\xa8\xea0\x01\xb8\xea0\x02\x82\xd3\xe4\x93\x02*:\x01*\"%/v1/{name=users/*}:startMFAEnrollment\x12\x86\x01\n" +
	"\tEnableMFA\x12\x1d.bytebase.v1.EnableMFARequest\x1a\x11.bytebase.v1.User\"G\xdaA\rname,otp_code\x90\xea0\x02\xa0\xea0\x03\xa8\xea0\x03\xb8\xea0\x02\x82\xd3\xe4\x93\x02!:\x01*\"\x1c/v1/{name=users/*}:enableMFA\x12\x80\x01\n" +
	"\n" +
	"DisableMFA\x12\x1e.bytebase.v1.DisableMFARequest\x1a\x11.bytebase.v1.User\"?\xdaA\x04name\x90\xea0\x02\xa0\xea0\x03\xa8\xea0\x03\xb8\xea0\x02\x82\xd3\xe4\x93\x02\":\x01*\"\x1d/v1/{name=users/*}:disableMFA\x12\xc2\x01\n" +
	"\x17RegenerateRecoveryCodes\x12+.bytebase.v1.RegenerateRecoveryCodesRequest\x1a,.bytebase.v1.RegenerateRecoveryCodesResponse\"L\xdaA\x04name\x90\xea0\x02\xa0\xea0\x03\xa8\xea0\x01\xb8\xea0\x02\x82\xd3\xe4\x93\x02/:\x01*\"*/v1/{name=users/*}:regenerateRecoveryCodes\x12\x9e\x01\n" +
	"\x14ConfirmRecoveryCodes\x12(.bytebase.v1.ConfirmRecoveryCodesRequest\x1a\x11.bytebase.v1.User\"I\xdaA\x04name\x90\xea0\x02\xa0\xea0\x03\xa8\xea0\x03\xb8\xea0\x02\x82\xd3\xe4\x93\x02,:\x01*\"'/v1/{name=users/*}:confirmRecoveryCodesB\xa6\x01\n" +
