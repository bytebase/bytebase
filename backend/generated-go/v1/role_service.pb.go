...
const file_v1_role_service_proto_rawDesc = "" +
	...
	"\x11bytebase.com/Role\x12\froles/{role}2\xac\x05\n" +
	"\vRoleService\x12z\n" +
	"\tListRoles\x12\x1d.bytebase.v1.ListRolesRequest\x1a\x1e.bytebase.v1.ListRolesResponse\".\x8a\xea0\rbb.roles.list\x90\xea0\x01\xa0\xea0\x04\xb0\xea0\x01\x82\xd3\xe4\x93\x02\v\x12\t/v1/roles\x12x\n" +
	"\aGetRole\x12\x1b.bytebase.v1.GetRoleRequest\x1a\x11.bytebase.v1.Role\"=\xdaA\x04name\x8a\xea0\fbb.roles.get\x90\xea0\x01\xa0\xea0\x04\xb0\xea0\x01\x82\xd3\xe4\x93\x02\x14\x12\x12/v1/{name=roles/*}\x12{\n" +
	"\n" +
	"CreateRole\x12\x1e.bytebase.v1.CreateRoleRequest\x1a\x11.bytebase.v1.Role\":\x8a\xea0\x0fbb.roles.create\x90\xea0\x01\x98\xea0\x01\xa0\xea0\x04\xb0\xea0\x01\x82\xd3\xe4\x93\x02\x11:\x04role\"\t/v1/roles\x12\x9c\x01\n" +
	"\n" +
	"UpdateRole\x12\x1e.bytebase.v1.UpdateRoleRequest\x1a\x11.bytebase.v1.Role\"[\xdaA\x10role,update_mask\x8a\xea0\x0fbb.roles.update\x90\xea0\x01\x98\xea0\x01\xa0\xea0\x04\xb0\xea0\x01\x82\xd3\xe4\x93\x02\x1f:\x04role2\x17/v1/{role.name=roles/*}\x12\x8a\x01\n" +
	"\n" +
	"DeleteRole\x12\x1e.bytebase.v1.DeleteRoleRequest\x1a\x16.google.protobuf.Empty\"D\xdaA\x04name\x8a\xea0\x0fbb.roles.delete\x90\xea0\x01\x98\xea0\x01\xa0\xea0\x04\xb0\xea0\x01\x82\xd3\xe4\x93\x02\x14*\x12/v1/{name=roles/*}B\xa6\x01\n" +
