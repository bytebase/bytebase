...
type SearchAuditLogsRequest struct {
	...
	// - mcp: "true" selects the entries an MCP (AI agent) session produced, "false" the rest. Support "==" operator.
	// - mcp_correlation_id: the MCP session an entry belongs to, taken from an entry's mcp_delegation.correlation_id. Support "==" operator.
	//
