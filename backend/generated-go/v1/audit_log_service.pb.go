...
const file_v1_audit_log_service_proto_rawDesc = "" +
	...
	"\x0fSearchAuditLogs\x12#.bytebase.v1.SearchAuditLogsRequest\x1a$.bytebase.v1.SearchAuditLogsResponse\"u\x8a\xea0\x13bb.auditLogs.search\x90\xea0\x01\xa0\xea0\x04\xa8\xea0\t\xb8\xea0\x01\x82\xd3\xe4\x93\x02H:\x01*Z\x19:\x01*\"\x14/v1/auditLogs:search\"(/v1/{parent=projects/*}/auditLogs:search\x12\xd3\x01\n" +
	"\x0fExportAuditLogs\x12#.bytebase.v1.ExportAuditLogsRequest\x1a$.bytebase.v1.ExportAuditLogsResponse\"u\x8a\xea0\x13bb.auditLogs.export\x90\xea0\x01\xa0\xea0\x04\xa8\xea0\t\xb8\xea0\x02\x82\xd3\xe4\x93\x02H:\x01*Z\x19:\x01*\"\x14/v1/auditLogs:export\"(/v1/{parent=projects/*}/auditLogs:exportB\xaa\x01\n" +
