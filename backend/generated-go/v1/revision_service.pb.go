...
const file_v1_revision_service_proto_rawDesc = "" +
	...
	"\x10\r2\x84\b\n" +
	"\x0fRevisionService\x12\xf6\x01\n" +
	"\rListRevisions\x12!.bytebase.v1.ListRevisionsRequest\x1a\".bytebase.v1.ListRevisionsResponse\"\x9d\x01\xdaA\x06parent\x8a\xea0\x11bb.revisions.list\x90\xea0\x01\xa0\xea0\x01\xb8\xea0\x01\x82\xd3\xe4\x93\x02mZ;\x129/v1/{parent=projects/*/instances/*/databases/*}/revisions\x12./v1/{parent=instances/*/databases/*}/revisions\x12\xe2\x01\n" +
	"\vGetRevision\x12\x1f.bytebase.v1.GetRevisionRequest\x1a\x15.bytebase.v1.Revision\"\x9a\x01\xdaA\x04name\x8a\xea0\x10bb.revisions.get\x90\xea0\x01\xa0\xea0\x01\xb8\xea0\x01\x82\xd3\xe4\x93\x02mZ;\x129/v1/{name=projects/*/instances/*/databases/*/revisions/*}\x12./v1/{name=instances/*/databases/*/revisions/*}\x12\xa3\x02\n" +
	"\x14BatchCreateRevisions\x12(.bytebase.v1.BatchCreateRevisionsRequest\x1a).bytebase.v1.BatchCreateRevisionsResponse\"\xb5\x01\x8a\xea0\x13bb.revisions.create\x90\xea0\x01\xa0\xea0\x02\xb8\xea0\x02\x82\xd3\xe4\x93\x02\x8b\x01:\x01*ZJ:\x01*\"E/v1/{parent=projects/*/instances/*/databases/*}/revisions:batchCreate\":/v1/{parent=instances/*/databases/*}/revisions:batchCreate\x12\xec\x01\n" +
	"\x0eDeleteRevision\x12\".bytebase.v1.DeleteRevisionRequest\x1a\x16.google.protobuf.Empty\"\x9d\x01\xdaA\x04name\x8a\xea0\x13bb.revisions.delete\x90\xea0\x01\xa0\xea0\x02\xb8\xea0\x02\x82\xd3\xe4\x93\x02mZ;*9/v1/{name=projects/*/instances/*/databases/*/revisions/*}*./v1/{name=instances/*/databases/*/revisions/*}B\xaa\x01\n" +
