...
func ChangeIssueStatus(ctx context.Context, stores *store.Store, webhookManager *Manager, issue *store.IssueMessage, newStatus storepb.IssueStatus, updater *store.UserMessage, comment string) error {
