...
func TestActionCheckCommand_ValidMigrations(t *testing.T) {
	t.Parallel()
	a := require.New(t)
...
func TestActionCheckCommand_ValidMigrationsForDatabaseGroup(t *testing.T) {
	t.Parallel()
	a := require.New(t)
	ctx := context.Background()
	ctl := &controller{}
...
func TestActionCheckCommand_PolicyViolations(t *testing.T) {
	t.Skip("Skipping policy violations test - SQL review policies not configured in test environment")
}

func TestActionCheckCommand_SyntaxErrors(t *testing.T) {
	t.Parallel()
	a := require.New(t)
	ctx := context.Background()
	ctl := &controller{}
...
func TestActionCheckCommand_MultipleTargets(t *testing.T) {
	t.Parallel()
	a := require.New(t)
	ctx := context.Background()
	ctl := &controller{}
...
func TestActionCheckCommand_DeclarativeCheckValidSchema(t *testing.T) {
	t.Parallel()
	a := require.New(t)
	ctx := context.Background()
	ctl := &controller{}
...
func TestActionCheckCommand_DeclarativeCheckMultipleFiles(t *testing.T) {
	t.Parallel()
	a := require.New(t)
	ctx := context.Background()
	ctl := &controller{}
...
func TestActionCheckCommand_DeclarativeCheckWithDatabaseGroup(t *testing.T) {
	t.Parallel()
	a := require.New(t)
	ctx := context.Background()
	ctl := &controller{}
...
func TestActionCheckCommand_DeclarativeCheckSyntaxErrors(t *testing.T) {
	t.Parallel()
	a := require.New(t)
	ctx := context.Background()
	ctl := &controller{}
...
func TestActionRolloutCommand_MultipleFiles(t *testing.T) {
	t.Parallel()
	a := require.New(t)
	ctx := context.Background()
	ctl := &controller{}
...
func TestActionRolloutCommand_FileContentVersionMatch(t *testing.T) {
...
func TestActionRolloutDeclarativeMode_BasicDeclarativeRollout(t *testing.T) {
	t.Parallel()
	a := require.New(t)
	ctx := context.Background()
	ctl := &controller{}
...
func TestActionRolloutDeclarativeMode_DeclarativeSchemaEvolution(t *testing.T) {
	t.Parallel()
	a := require.New(t)
	ctx := context.Background()
	ctl := &controller{}
...
func TestActionRolloutDeclarativeMode_DeclarativeIdempotency(t *testing.T) {
	t.Parallel()
	a := require.New(t)
	ctx := context.Background()
	ctl := &controller{}
...
func TestActionRolloutDeclarativeMode_DeclarativeMultipleDatabases(t *testing.T) {
	t.Parallel()
	a := require.New(t)
	ctx := context.Background()
	ctl := &controller{}
...
func TestActionRolloutDeclarativeMode_DeclarativeWithDatabaseGroup(t *testing.T) {
	t.Parallel()
	a := require.New(t)
	ctx := context.Background()
	ctl := &controller{}
...
func TestActionRolloutDeclarativeMode_DeclarativeMultipleFilesMerged(t *testing.T) {
	t.Parallel()
	a := require.New(t)
	ctx := context.Background()
	ctl := &controller{}
...
func TestActionErrorScenarios_InvalidServiceAccountSecret(t *testing.T) {
	t.Parallel()
	a := require.New(t)
	ctx := context.Background()
	ctl := &controller{}
...
func TestActionErrorScenarios_NonExistentDatabase(t *testing.T) {
	t.Parallel()
	a := require.New(t)
	ctx := context.Background()
	ctl := &controller{}
...
func TestActionErrorScenarios_EmptyFilePattern(t *testing.T) {
	t.Parallel()
	a := require.New(t)
	ctx := context.Background()
	ctl := &controller{}
