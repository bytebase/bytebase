...
func TestLatestVersion(t *testing.T) {
	...
	require.Equal(t, semver.MustParse("3.23.1-backport.0"), *files[len(files)-1].version)
	require.Equal(t, "migration/3.23.1-backport/0000##workload_identity_audiences.sql", files[len(files)-1].path)
}
