...
func TestLatestVersion(t *testing.T) {
	...
	require.Equal(t, semver.MustParse("3.22.9"), *files[len(files)-1].version)
	require.Equal(t, "migration/3.22/0009##split_saved_query_manage.sql", files[len(files)-1].path)
}
