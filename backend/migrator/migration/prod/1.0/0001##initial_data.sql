...
-- Both instances contains the connection info we expect user to setup according to https://www.bytebase.com/docs/tutorials/local-mysql-instance
...
VALUES
    (
        ...
        '3306',
        'https://www.bytebase.com/docs/tutorials/local-mysql-instance'
    );
