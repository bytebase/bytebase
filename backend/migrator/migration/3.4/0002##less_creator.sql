...
ALTER TABLE role DROP COLUMN IF EXISTS row_status, DROP COLUMN IF EXISTS creator_id, DROP COLUMN IF EXISTS created_ts, DROP COLUMN IF EXISTS updater_id, DROP COLUMN IF EXISTS updated_ts, DROP COLUMN IF EXISTS description;
