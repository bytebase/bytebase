...
INSERT INTO "public"."task_run" ("id", "creator_id", "created_ts", "updater_id", "updated_ts", "task_id", "name", "status", "code", "result") VALUES
(101, 1, 1657272778, 1, 1657272778, 101, 'Welcome', 'FAILED', 0, '{"detail": "Something is not right..."}'),
(102, 1, 1657272778, 1, 1657272778, 101, 'Welcome', 'RUNNING', 0, '{}'),
...
(102, 1, 1657272890, 1, 1657272891, 103, 'DONE', 'bb.task-check.database.statement.syntax', 0, '', '{"resultList": [{"title": "Syntax OK", "status": "SUCCESS", "content": "OK"}]}', '{"dbType": "MYSQL", "charset": "utf8mb4", "collation": "utf8mb4_general_ci", "statement": "/* Establish baseline using current schema */"}'),
(103, 1, 1657272890, 1, 1657272891, 103, 'DONE', 'bb.task-check.database.statement.advise', 0, '', '{"resultList": [{"code": 401, "title": "Empty SQL review policy or disabled", "status": "WARN"}]}', '{"dbType": "MYSQL", "charset": "utf8mb4", "collation": "utf8mb4_general_ci", "statement": "/* Establish baseline using current schema */"}'),
(104, 1, 1657272927, 1, 1657272929, 104, 'DONE', 'bb.task-check.database.connect', 0, '', '{"resultList": [{"title": "OK", "status": "SUCCESS", "content": "Successfully connected \"employee\""}]}', '{}'),
(105, 1, 1657272927, 1, 1657272928, 104, 'DONE', 'bb.task-check.database.statement.syntax', 0, '', '{"resultList": [{"title": "Syntax OK", "status": "SUCCESS", "content": "OK"}]}', '{"dbType": "MYSQL", "charset": "utf8mb4", "collation": "utf8mb4_general_ci", "statement": "Alter table\n  employee\nadd\n  column (\n    EduBackgrounds varchar(50) not null,\n    Email varchar(40) not null,\n    PhoneNo varchar(15) not null,\n    Credentials_type char(4) not null,\n    Credentials_No varchar(10) not null,\n    Manager varchar(14),\n    Emergency_name varchar(16) not null,\n    Emergency_phoneNo varchar(15) not null,\n    Address varchar(60) not null\n  )"}'),
(106, 1, 1657272927, 1, 1657272928, 104, 'DONE', 'bb.task-check.database.statement.advise', 0, '', '{"resultList": [{"code": 401, "title": "Empty SQL review policy or disabled", "status": "WARN"}]}', '{"dbType": "MYSQL", "charset": "utf8mb4", "collation": "utf8mb4_general_ci", "statement": "Alter table\n  employee\nadd\n  column (\n    EduBackgrounds varchar(50) not null,\n    Email varchar(40) not null,\n    PhoneNo varchar(15) not null,\n    Credentials_type char(4) not null,\n    Credentials_No varchar(10) not null,\n    Manager varchar(14),\n    Emergency_name varchar(16) not null,\n    Emergency_phoneNo varchar(15) not null,\n    Address varchar(60) not null\n  )"}'),
(107, 1, 1657273475, 1, 1657273477, 105, 'DONE', 'bb.task-check.database.connect', 0, '', '{"resultList": [{"title": "OK", "status": "SUCCESS", "content": "Successfully connected \"employee\""}]}', '{}'),
(108, 1, 1657273475, 1, 1657273476, 105, 'DONE', 'bb.task-check.database.statement.syntax', 0, '', '{"resultList": [{"title": "Syntax OK", "status": "SUCCESS", "content": "OK"}]}', '{"dbType": "MYSQL", "charset": "utf8mb4", "collation": "utf8mb4_general_ci", "statement": "alter table\n  employee drop column Address;"}'),
(109, 1, 1657273475, 1, 1657273476, 105, 'DONE', 'bb.task-check.database.statement.advise', 0, '', '{"resultList": [{"code": 401, "title": "Empty SQL review policy or disabled", "status": "WARN"}]}', '{"dbType": "MYSQL", "charset": "utf8mb4", "collation": "utf8mb4_general_ci", "statement": "alter table\n  employee drop column Address;"}');
