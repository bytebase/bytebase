...
//    (This rule is always satisfied since every time when users patch the EarliestAllowedTs, we will check if this field has been modified and force scheduling one if needed.)
