...
func TestCreateTableSeparateIndex(t *testing.T) {
	...
	want := "CREATE TABLE `t1` (`id` INT DEFAULT NULL,`c1` INT DEFAULT NULL,`c2` INT DEFAULT NULL) ENGINE = InnoDB DEFAULT CHARACTER SET = UTF8MB4 DEFAULT COLLATE = UTF8MB4_0900_AI_CI;\n" +
