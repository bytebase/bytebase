							...
							"t": {
								...
								indexSet: indexStateMap{
									"idx_a": {
										complete:       true,
										name:           "idx_a",
										expressionList: newStateStringSlice([]string{"a"}),
										indextype:      newStateString("BTREE"),
										unique:         newStateBool(false),
							...
							"t": {
								...
								indexSet: indexStateMap{
									...
									"b": {
										complete:       true,
										name:           "b",
										expressionList: newStateStringSlice([]string{"b"}),
										indextype:      newStateString("BTREE"),
										unique:         newStateBool(true),
										primary:        newStateBool(false),
										visible:        newStateBool(true),
									...
									"b_2": {
										complete:       true,
										name:           "b_2",
										expressionList: newStateStringSlice([]string{"b", "a"}),
										indextype:      newStateString("BTREE"),
										unique:         newStateBool(false),
										primary:        newStateBool(false),
										visible:        newStateBool(true),
									...
									"b_3": {
										complete:       true,
										name:           "b_3",
										expressionList: newStateStringSlice([]string{"b", "c", "d"}),
										indextype:      newStateString("BTREE"),
										unique:         newStateBool(true),
										primary:        newStateBool(false),
										visible:        newStateBool(true),
									...
									"b_4": {
										complete:       true,
										name:           "b_4",
										expressionList: newStateStringSlice([]string{"b", "d"}),
										indextype:      newStateString("FULLTEXT"),
										unique:         newStateBool(false),
										primary:        newStateBool(false),
										visible:        newStateBool(false),
										comment:        newStateString(""),
									},
								},
							},
							...
							"t": {
								...
								columnSet: columnStateMap{
									"a": {
										complete:     true,
										name:         "a",
										position:     newStateInt(1),
										defaultValue: newStateStringPointer(&one),
										nullable:     newStateBool(false),
										columnType:   newStateString("int(11)"),
										characterSet: newStateString(""),
										collation:    newStateString(""),
										comment:      newStateString(""),
									},
									"b": {
										complete:     true,
										name:         "b",
										position:     newStateInt(2),
										defaultValue: newStateStringPointer(nil),
										nullable:     newStateBool(false),
										columnType:   newStateString("varchar(200)"),
										characterSet: newStateString("utf8mb4"),
										collation:    newStateString(""),
										comment:      newStateString(""),
									},
									"c": {
										complete:     true,
										name:         "c",
										position:     newStateInt(3),
										defaultValue: newStateStringPointer(nil),
										nullable:     newStateBool(true),
										columnType:   newStateString("int(11)"),
										characterSet: newStateString(""),
										collation:    newStateString(""),
										comment:      newStateString("This is a comment"),
									},
									"d": {
										complete:     true,
										name:         "d",
										position:     newStateInt(4),
										defaultValue: newStateStringPointer(nil),
										nullable:     newStateBool(true),
										columnType:   newStateString("varchar(10)"),
										characterSet: newStateString(""),
										collation:    newStateString("utf8mb4_polish_ci"),
										comment:      newStateString(""),
									},
								},
								indexSet: indexStateMap{
