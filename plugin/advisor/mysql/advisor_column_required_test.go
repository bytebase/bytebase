			...
			want: []advisor.Advice{
				{
					...
					Content: "\"book\" requires columns: created_ts, creator_id, updated_ts, updater_id",
				},
			},
		},
		{
			...
			want: []advisor.Advice{
				{
					...
					Code:    common.NoRequiredColumn,
					Title:   "Require columns",
					Content: "\"book\" requires columns: creator_id",
				},
			},
		},
		{
			...
			want: []advisor.Advice{
				{
					...
					Code:    common.NoRequiredColumn,
					Title:   "Require columns",
					Content: "\"book\" requires columns: updater_id",
				},
			},
		},
		{
		...
		},
		{
			...
			want: []advisor.Advice{
				...
				},
				{
					...
					Code:    common.NoRequiredColumn,
					Title:   "Require columns",
					Content: "\"student\" requires columns: creator_id, updater_id",
				},
			},
		},
	}
