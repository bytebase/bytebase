			...
			want: []advisor.Advice{
				{
					...
					Content: "Foreign key mismatches the naming convention, expect \"^fk_tech_book_author_id_author_id$\" but found `fk_author_id`",
				},
			},
		},
		{
			...
			want: []advisor.Advice{
				{
					...
					Code:    common.NamingFKConventionMismatch,
					Title:   "Mismatch foreign key naming convention",
					Content: "Foreign key mismatches the naming convention, expect \"^fk_book_author_id_author_id$\" but found `fk_book_author_id`",
				},
			},
		},
	}
