			...
			want: []advisor.Advice{
				{
					...
					Code:    common.NamingIndexConventionMismatch,
					Title:   "Mismatch index naming convention",
					Content: "\"CREATE UNIQUE INDEX tech_book_id_name ON tech_book(id, name)\" mismatches index naming convention, expect \"uk_{{table}}_{{column_list}}\" but found \"tech_book_id_name\"",
				},
			},
		},
		{
			...
			want: []advisor.Advice{
				{
					...
					Code:    common.NamingIndexConventionMismatch,
					Title:   "Mismatch index naming convention",
					Content: "\"ALTER TABLE tech_book ADD UNIQUE tech_book_id_name (id, name)\" mismatches index naming convention, expect \"uk_{{table}}_{{column_list}}\" but found \"tech_book_id_name\"",
				},
			},
		},
		{
			...
			want: []advisor.Advice{
				{
					...
					Code:    common.NamingIndexConventionMismatch,
					Title:   "Mismatch index naming convention",
					Content: "\"CREATE TABLE tech_book(id INT PRIMARY KEY, name VARCHAR(20), UNIQUE KEY (name))\" mismatches index naming convention, expect \"uk_{{table}}_{{column_list}}\" but found \"\"",
				},
			},
		},
		{
			...
			want: []advisor.Advice{
				{
					...
					Code:    common.NamingIndexConventionMismatch,
					Title:   "Mismatch index naming convention",
					Content: "\"CREATE TABLE tech_book(id INT PRIMARY KEY, name VARCHAR(20), UNIQUE INDEX (name))\" mismatches index naming convention, expect \"uk_{{table}}_{{column_list}}\" but found \"\"",
				},
			},
		},
		{
			...
			want: []advisor.Advice{
				{
					...
					Code:    common.NamingIndexConventionMismatch,
					Title:   "Mismatch index naming convention",
					Content: "\"ALTER TABLE tech_book ADD PRIMARY KEY tech_book_id (id)\" mismatches index naming convention, expect \"pk_{{table}}_{{column_list}}\" but found \"tech_book_id\"",
				},
			},
		},
		{
			...
			want: []advisor.Advice{
				{
					...
					Code:    common.NamingIndexConventionMismatch,
					Title:   "Mismatch index naming convention",
					Content: "\"CREATE TABLE tech_book(id INT, name VARCHAR(20), PRIMARY KEY (name))\" mismatches index naming convention, expect \"pk_{{table}}_{{column_list}}\" but found \"\"",
				},
			},
		},
	}
