			...
			want: []advisor.Advice{
				{
					...
					Content: "\"book\" requires columns: created_ts, creator_id, id, updated_ts, updater_id",
				},
			},
		},
		{
		...
		},
		{
			...
			want: []advisor.Advice{
				...
				},
				{
					...
					Code:    common.NoRequiredColumn,
					Title:   "Require columns",
					Content: "\"student\" requires columns: created_ts, creator_id, id, updated_ts, updater_id",
				},
			},
		},
	}
