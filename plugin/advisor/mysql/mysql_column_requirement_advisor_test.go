			...
			want: []advisor.Advice{
				{
					...
					Content: "\"book\" requires columns: id, created_ts, updated_ts, creator_id, updater_id",
				},
			},
		},
		{
		...
		},
		{
			...
			want: []advisor.Advice{
				...
				},
				{
					...
					Code:    common.NoRequiredColumn,
					Title:   "Require columns",
					Content: "\"student\" requires columns: id, created_ts, updated_ts, creator_id, updater_id",
				},
			},
		},
	}
