			...
			want: []advisor.Advice{
				{
					...
					Content: "Unique key mismatches the naming convention, expect \"^uk_tech_book_id_name$\" but found `tech_book_id_name`",
				},
			},
		},
		{
			...
			want: []advisor.Advice{
				{
					...
					Code:    common.NamingUKConventionMismatch,
					Title:   "Mismatch unique key naming convention",
					Content: "Unique key mismatches the naming convention, expect \"^uk_tech_book_id_name$\" but found `uk_tech_book`",
				},
			},
		},
		{
			...
			want: []advisor.Advice{
				{
					...
					Code:    common.NamingUKConventionMismatch,
					Title:   "Mismatch unique key naming convention",
					Content: "Unique key mismatches the naming convention, expect \"^uk_tech_book_name$\" but found ``",
				},
			},
		},
		{
