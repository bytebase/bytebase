...
type KerberosConfig struct {
	...
	KdcHosr              string `protobuf:"bytes,5,opt,name=kdc_hosr,json=kdcHosr,proto3" json:"kdc_hosr,omitempty"`
...
func (x *KerberosConfig) GetKdcHosr() string {
	if x != nil {
		return x.KdcHosr
	}
	return ""
...
var file_store_data_source_proto_rawDesc = []byte{
	...
	0x64, 0x63, 0x5f, 0x68, 0x6f, 0x73, 0x72, 0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x6b,
	0x64, 0x63, 0x48, 0x6f, 0x73, 0x72, 0x12, 0x34, 0x0a, 0x16, 0x6b, 0x64, 0x63, 0x5f, 0x74, 0x72,
