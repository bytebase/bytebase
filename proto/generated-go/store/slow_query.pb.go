...
type SlowQueryStatistics struct {
	...
	Details []*SlowQueryDetails `protobuf:"bytes,4,rep,name=details,proto3" json:"details,omitempty"`
}
...
var file_store_slow_query_proto_rawDesc = []byte{
	...
	0x54, 0x69, 0x6d, 0x65, 0x12, 0x3a, 0x0a, 0x07, 0x64, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x73, 0x18,
...
var file_store_slow_query_proto_depIdxs = []int32{
	...
	1, // 1: bytebase.store.SlowQueryStatistics.details:type_name -> bytebase.store.SlowQueryDetails
