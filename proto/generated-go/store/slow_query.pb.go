...
func (x *SlowQueryStatisticsItem) GetCount() int64 {
	if x != nil {
		return x.Count
	}
	return 0
...
func (x *SlowQueryStatisticsItem) GetMaximumRowsSent() int64 {
	if x != nil {
...
func (x *SlowQueryStatisticsItem) GetMaximumRowsExamined() int64 {
	if x != nil {
...
var file_store_slow_query_proto_rawDesc = string([]byte{
...
var (
	...
	file_store_slow_query_proto_rawDescData []byte
)

func file_store_slow_query_proto_rawDescGZIP() []byte {
	file_store_slow_query_proto_rawDescOnce.Do(func() {
		file_store_slow_query_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_store_slow_query_proto_rawDesc), len(file_store_slow_query_proto_rawDesc)))
	})
...
func file_store_slow_query_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_store_slow_query_proto_rawDesc), len(file_store_slow_query_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
