...
type SlowQueryStatisticsList struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// slow_query_statistics_list is the list of slow query statistics.
	SlowQueryStatisticsList []*SlowQueryStatistics `protobuf:"bytes,1,rep,name=slow_query_statistics_list,json=slowQueryStatisticsList,proto3" json:"slow_query_statistics_list,omitempty"`
}

func (x *SlowQueryStatisticsList) Reset() {
	*x = SlowQueryStatisticsList{}
...
func (x *SlowQueryStatisticsList) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SlowQueryStatisticsList) ProtoMessage() {}

func (x *SlowQueryStatisticsList) ProtoReflect() protoreflect.Message {
	mi := &file_store_slow_query_proto_msgTypes[0]
...
// Deprecated: Use SlowQueryStatisticsList.ProtoReflect.Descriptor instead.
func (*SlowQueryStatisticsList) Descriptor() ([]byte, []int) {
	return file_store_slow_query_proto_rawDescGZIP(), []int{0}
}

func (x *SlowQueryStatisticsList) GetSlowQueryStatisticsList() []*SlowQueryStatistics {
	if x != nil {
		return x.SlowQueryStatisticsList
	}
	return nil
}
...
type SlowQueryStatistics struct {
	...
	Samples []*SlowQueryDetails `protobuf:"bytes,4,rep,name=samples,proto3" json:"samples,omitempty"`
}
...
var file_store_slow_query_proto_rawDesc = []byte{
	...
	,
	...
	0x65, 0x12, 0x3a, 0x0a, 0x07, 0x73, 0x61, 0x6d, 0x70, 0x6c, 0x65, 0x73, 0x18, 0x04, 0x20, 0x03,
	0x28, 0x0b, 0x32, 0x20, 0x2e, 0x62, 0x79, 0x74, 0x65, 0x62, 0x61, 0x73, 0x65, 0x2e, 0x73, 0x74,
	0x6f, 0x72, 0x65, 0x2e, 0x53, 0x6c, 0x6f, 0x77, 0x51, 0x75, 0x65, 0x72, 0x79, 0x44, 0x65, 0x74,
	...
	0x01, 0x28, 0x09, 0x52, 0x07, 0x73, 0x71, 0x6c, 0x54, 0x65, 0x78, 0x74, 0x42, 0x14, 0x5a, 0x12,
...
var file_store_slow_query_proto_goTypes = []interface{}{
	(*SlowQueryStatisticsList)(nil), // 0: bytebase.store.SlowQueryStatisticsList
	(*SlowQueryStatistics)(nil),     // 1: bytebase.store.SlowQueryStatistics
	(*SlowQueryDetails)(nil),        // 2: bytebase.store.SlowQueryDetails
	(*timestamppb.Timestamp)(nil),   // 3: google.protobuf.Timestamp
	(*durationpb.Duration)(nil),     // 4: google.protobuf.Duration
}
var file_store_slow_query_proto_depIdxs = []int32{
	1, // 0: bytebase.store.SlowQueryStatisticsList.slow_query_statistics_list:type_name -> bytebase.store.SlowQueryStatistics
	3, // 1: bytebase.store.SlowQueryStatistics.latest_log_time:type_name -> google.protobuf.Timestamp
	2, // 2: bytebase.store.SlowQueryStatistics.samples:type_name -> bytebase.store.SlowQueryDetails
	3, // 3: bytebase.store.SlowQueryDetails.start_time:type_name -> google.protobuf.Timestamp
	4, // 4: bytebase.store.SlowQueryDetails.query_time:type_name -> google.protobuf.Duration
	4, // 5: bytebase.store.SlowQueryDetails.lock_time:type_name -> google.protobuf.Duration
...
func file_store_slow_query_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_store_slow_query_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SlowQueryStatisticsList); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
