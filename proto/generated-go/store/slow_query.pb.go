...
var file_store_slow_query_proto_rawDesc = []byte{
	...
	0x69, 0x6f, 0x6e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xd4, 0x01, 0x0a, 0x13, 0x53, 0x6c,
	...
	0x54, 0x69, 0x6d, 0x65, 0x12, 0x3a, 0x0a, 0x07, 0x73, 0x61, 0x6d, 0x70, 0x6c, 0x65, 0x73, 0x18,
...
var file_store_slow_query_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_store_slow_query_proto_goTypes = []interface{}{
	(*SlowQueryStatistics)(nil),   // 0: bytebase.store.SlowQueryStatistics
	(*SlowQueryDetails)(nil),      // 1: bytebase.store.SlowQueryDetails
	(*timestamppb.Timestamp)(nil), // 2: google.protobuf.Timestamp
	(*durationpb.Duration)(nil),   // 3: google.protobuf.Duration
}
var file_store_slow_query_proto_depIdxs = []int32{
	2, // 0: bytebase.store.SlowQueryStatistics.latest_log_time:type_name -> google.protobuf.Timestamp
	1, // 1: bytebase.store.SlowQueryStatistics.samples:type_name -> bytebase.store.SlowQueryDetails
	2, // 2: bytebase.store.SlowQueryDetails.start_time:type_name -> google.protobuf.Timestamp
	3, // 3: bytebase.store.SlowQueryDetails.query_time:type_name -> google.protobuf.Duration
	3, // 4: bytebase.store.SlowQueryDetails.lock_time:type_name -> google.protobuf.Duration
