...
var file_store_database_proto_rawDesc = []byte{
	...
	0x45, 0x52, 0x54, 0x5f, 0x4f, 0x4e, 0x4c, 0x59, 0x10, 0x03, 0x22, 0xb5, 0x04, 0x0a, 0x0d, 0x54,
	...
	0x6e, 0x73, 0x22, 0xcd, 0x01, 0x0a, 0x15, 0x45, 0x78, 0x74, 0x65, 0x72, 0x6e, 0x61, 0x6c, 0x54,
	0x61, 0x62, 0x6c, 0x65, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x12, 0x12, 0x0a, 0x04,
	0x6e, 0x61, 0x6d, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65,
	...
	0x6e, 0x73, 0x22, 0x9f, 0x03, 0x0a, 0x16, 0x54, 0x61, 0x62, 0x6c, 0x65, 0x50, 0x61, 0x72, 0x74,
	...
	0x0b, 0x54, 0x59, 0x50, 0x45, 0x5f, 0x53, 0x54, 0x4f, 0x52, 0x45, 0x44, 0x10, 0x02, 0x22, 0xaa,
	...
	0x6c, 0x75, 0x6d, 0x6e, 0x22, 0xb6, 0x01, 0x0a, 0x18, 0x4d, 0x61, 0x74, 0x65, 0x72, 0x69, 0x61,
	...
	0x28, 0x09, 0x52, 0x0a, 0x64, 0x65, 0x66, 0x69, 0x6e, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0xfe,
	...
	0x65, 0x73, 0x63, 0x72, 0x69, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0xa7, 0x01, 0x0a, 0x0e, 0x44,
	0x61, 0x74, 0x61, 0x62, 0x61, 0x73, 0x65, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x12, 0x12, 0x0a,
	0x04, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x6e, 0x61, 0x6d,
	0x65, 0x12, 0x43, 0x0a, 0x0e, 0x73, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x5f, 0x63, 0x6f, 0x6e, 0x66,
	0x69, 0x67, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1c, 0x2e, 0x62, 0x79, 0x74, 0x65,
	...
	0x6f, 0x6e, 0x66, 0x69, 0x67, 0x73, 0x12, 0x3c, 0x0a, 0x1a, 0x63, 0x6c, 0x61, 0x73, 0x73, 0x69,
	...
	0x6e, 0x66, 0x69, 0x67, 0x22, 0xbc, 0x02, 0x0a, 0x0c, 0x53, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x43,
	...
	0x69, 0x67, 0x73, 0x22, 0xf6, 0x01, 0x0a, 0x0b, 0x54, 0x61, 0x62, 0x6c, 0x65, 0x43, 0x6f, 0x6e,
...
var file_store_database_proto_msgTypes = make([]protoimpl.MessageInfo, 32)
var file_store_database_proto_goTypes = []any{
	...
	(*ExternalTableMetadata)(nil),    // 11: bytebase.store.ExternalTableMetadata
	(*TablePartitionMetadata)(nil),   // 12: bytebase.store.TablePartitionMetadata
	(*ColumnMetadata)(nil),           // 13: bytebase.store.ColumnMetadata
	(*GenerationMetadata)(nil),       // 14: bytebase.store.GenerationMetadata
	(*ViewMetadata)(nil),             // 15: bytebase.store.ViewMetadata
	(*DependentColumn)(nil),          // 16: bytebase.store.DependentColumn
	(*MaterializedViewMetadata)(nil), // 17: bytebase.store.MaterializedViewMetadata
	(*FunctionMetadata)(nil),         // 18: bytebase.store.FunctionMetadata
	(*ProcedureMetadata)(nil),        // 19: bytebase.store.ProcedureMetadata
	(*IndexMetadata)(nil),            // 20: bytebase.store.IndexMetadata
	(*ExtensionMetadata)(nil),        // 21: bytebase.store.ExtensionMetadata
	(*ForeignKeyMetadata)(nil),       // 22: bytebase.store.ForeignKeyMetadata
	(*InstanceRoleMetadata)(nil),     // 23: bytebase.store.InstanceRoleMetadata
	(*Secrets)(nil),                  // 24: bytebase.store.Secrets
	(*SecretItem)(nil),               // 25: bytebase.store.SecretItem
	(*DatabaseConfig)(nil),           // 26: bytebase.store.DatabaseConfig
	(*SchemaConfig)(nil),             // 27: bytebase.store.SchemaConfig
	(*TableConfig)(nil),              // 28: bytebase.store.TableConfig
	(*FunctionConfig)(nil),           // 29: bytebase.store.FunctionConfig
	(*ProcedureConfig)(nil),          // 30: bytebase.store.ProcedureConfig
	(*ViewConfig)(nil),               // 31: bytebase.store.ViewConfig
	(*ColumnConfig)(nil),             // 32: bytebase.store.ColumnConfig
	(*LinkedDatabaseMetadata)(nil),   // 33: bytebase.store.LinkedDatabaseMetadata
	(*SequenceMetadata)(nil),         // 34: bytebase.store.SequenceMetadata
	nil,                              // 35: bytebase.store.DatabaseMetadata.LabelsEntry
	nil,                              // 36: bytebase.store.ColumnConfig.LabelsEntry
	(*timestamppb.Timestamp)(nil),    // 37: google.protobuf.Timestamp
	(*wrapperspb.StringValue)(nil),   // 38: google.protobuf.StringValue
}
var file_store_database_proto_depIdxs = []int32{
	35, // 0: bytebase.store.DatabaseMetadata.labels:type_name -> bytebase.store.DatabaseMetadata.LabelsEntry
	37, // 1: bytebase.store.DatabaseMetadata.last_sync_time:type_name -> google.protobuf.Timestamp
	7,  // 2: bytebase.store.DatabaseSchemaMetadata.schemas:type_name -> bytebase.store.SchemaMetadata
	21, // 3: bytebase.store.DatabaseSchemaMetadata.extensions:type_name -> bytebase.store.ExtensionMetadata
	33, // 4: bytebase.store.DatabaseSchemaMetadata.linked_databases:type_name -> bytebase.store.LinkedDatabaseMetadata
	10, // 5: bytebase.store.SchemaMetadata.tables:type_name -> bytebase.store.TableMetadata
	11, // 6: bytebase.store.SchemaMetadata.external_tables:type_name -> bytebase.store.ExternalTableMetadata
	15, // 7: bytebase.store.SchemaMetadata.views:type_name -> bytebase.store.ViewMetadata
	18, // 8: bytebase.store.SchemaMetadata.functions:type_name -> bytebase.store.FunctionMetadata
	19, // 9: bytebase.store.SchemaMetadata.procedures:type_name -> bytebase.store.ProcedureMetadata
	...
	17, // 12: bytebase.store.SchemaMetadata.materialized_views:type_name -> bytebase.store.MaterializedViewMetadata
	34, // 13: bytebase.store.SchemaMetadata.sequences:type_name -> bytebase.store.SequenceMetadata
	...
	13, // 17: bytebase.store.TableMetadata.columns:type_name -> bytebase.store.ColumnMetadata
	20, // 18: bytebase.store.TableMetadata.indexes:type_name -> bytebase.store.IndexMetadata
	22, // 19: bytebase.store.TableMetadata.foreign_keys:type_name -> bytebase.store.ForeignKeyMetadata
	12, // 20: bytebase.store.TableMetadata.partitions:type_name -> bytebase.store.TablePartitionMetadata
	13, // 21: bytebase.store.ExternalTableMetadata.columns:type_name -> bytebase.store.ColumnMetadata
	3,  // 22: bytebase.store.TablePartitionMetadata.type:type_name -> bytebase.store.TablePartitionMetadata.Type
	12, // 23: bytebase.store.TablePartitionMetadata.subpartitions:type_name -> bytebase.store.TablePartitionMetadata
	38, // 24: bytebase.store.ColumnMetadata.default:type_name -> google.protobuf.StringValue
	14, // 25: bytebase.store.ColumnMetadata.generation:type_name -> bytebase.store.GenerationMetadata
	4,  // 26: bytebase.store.GenerationMetadata.type:type_name -> bytebase.store.GenerationMetadata.Type
	16, // 27: bytebase.store.ViewMetadata.dependent_columns:type_name -> bytebase.store.DependentColumn
	16, // 28: bytebase.store.MaterializedViewMetadata.dependent_columns:type_name -> bytebase.store.DependentColumn
	25, // 29: bytebase.store.Secrets.items:type_name -> bytebase.store.SecretItem
	27, // 30: bytebase.store.DatabaseConfig.schema_configs:type_name -> bytebase.store.SchemaConfig
	28, // 31: bytebase.store.SchemaConfig.table_configs:type_name -> bytebase.store.TableConfig
	29, // 32: bytebase.store.SchemaConfig.function_configs:type_name -> bytebase.store.FunctionConfig
	30, // 33: bytebase.store.SchemaConfig.procedure_configs:type_name -> bytebase.store.ProcedureConfig
	31, // 34: bytebase.store.SchemaConfig.view_configs:type_name -> bytebase.store.ViewConfig
	32, // 35: bytebase.store.TableConfig.column_configs:type_name -> bytebase.store.ColumnConfig
	37, // 36: bytebase.store.TableConfig.update_time:type_name -> google.protobuf.Timestamp
	37, // 37: bytebase.store.FunctionConfig.update_time:type_name -> google.protobuf.Timestamp
	37, // 38: bytebase.store.ProcedureConfig.update_time:type_name -> google.protobuf.Timestamp
	37, // 39: bytebase.store.ViewConfig.update_time:type_name -> google.protobuf.Timestamp
	36, // 40: bytebase.store.ColumnConfig.labels:type_name -> bytebase.store.ColumnConfig.LabelsEntry
...
func file_store_database_proto_init() {
	...
	file_store_database_proto_msgTypes[8].OneofWrappers = []any{
