...
var file_store_database_proto_depIdxs = []int32{
	...
	10, // 15: bytebase.store.SchemaMetadata.events:type_name -> bytebase.store.EventMetadata
	9,  // 16: bytebase.store.SchemaMetadata.enum_types:type_name -> bytebase.store.EnumTypeMetadata
	...
	19, // 20: bytebase.store.TableMetadata.columns:type_name -> bytebase.store.ColumnMetadata
	27, // 21: bytebase.store.TableMetadata.indexes:type_name -> bytebase.store.IndexMetadata
	29, // 22: bytebase.store.TableMetadata.foreign_keys:type_name -> bytebase.store.ForeignKeyMetadata
	18, // 23: bytebase.store.TableMetadata.partitions:type_name -> bytebase.store.TablePartitionMetadata
	16, // 24: bytebase.store.TableMetadata.check_constraints:type_name -> bytebase.store.CheckConstraintMetadata
	12, // 25: bytebase.store.TableMetadata.triggers:type_name -> bytebase.store.TriggerMetadata
