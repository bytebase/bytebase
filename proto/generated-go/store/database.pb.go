...
var file_store_database_proto_rawDesc = []byte{
	...
	0x03, 0x20, 0x01, 0x28, 0x03, 0x52, 0x05, 0x73, 0x74, 0x61, 0x72, 0x74, 0x12, 0x1b, 0x0a, 0x09,
...
var file_store_database_proto_goTypes = []any{
	...
	(*SequenceMetadata)(nil),         // 8: bytebase.store.SequenceMetadata
	(*TriggerMetadata)(nil),          // 9: bytebase.store.TriggerMetadata
	(*TaskMetadata)(nil),             // 10: bytebase.store.TaskMetadata
	(*StreamMetadata)(nil),           // 11: bytebase.store.StreamMetadata
	(*TableMetadata)(nil),            // 12: bytebase.store.TableMetadata
	(*CheckConstraintMetadata)(nil),  // 13: bytebase.store.CheckConstraintMetadata
	(*ExternalTableMetadata)(nil),    // 14: bytebase.store.ExternalTableMetadata
	(*TablePartitionMetadata)(nil),   // 15: bytebase.store.TablePartitionMetadata
	(*ColumnMetadata)(nil),           // 16: bytebase.store.ColumnMetadata
	(*GenerationMetadata)(nil),       // 17: bytebase.store.GenerationMetadata
	(*ViewMetadata)(nil),             // 18: bytebase.store.ViewMetadata
	(*DependentColumn)(nil),          // 19: bytebase.store.DependentColumn
	(*MaterializedViewMetadata)(nil), // 20: bytebase.store.MaterializedViewMetadata
	(*FunctionMetadata)(nil),         // 21: bytebase.store.FunctionMetadata
	(*ProcedureMetadata)(nil),        // 22: bytebase.store.ProcedureMetadata
	(*PackageMetadata)(nil),          // 23: bytebase.store.PackageMetadata
	(*IndexMetadata)(nil),            // 24: bytebase.store.IndexMetadata
	(*ExtensionMetadata)(nil),        // 25: bytebase.store.ExtensionMetadata
	(*ForeignKeyMetadata)(nil),       // 26: bytebase.store.ForeignKeyMetadata
	(*InstanceRoleMetadata)(nil),     // 27: bytebase.store.InstanceRoleMetadata
	(*Secrets)(nil),                  // 28: bytebase.store.Secrets
	(*SecretItem)(nil),               // 29: bytebase.store.SecretItem
	(*DatabaseConfig)(nil),           // 30: bytebase.store.DatabaseConfig
	(*SchemaConfig)(nil),             // 31: bytebase.store.SchemaConfig
	(*TableConfig)(nil),              // 32: bytebase.store.TableConfig
	(*FunctionConfig)(nil),           // 33: bytebase.store.FunctionConfig
	(*ProcedureConfig)(nil),          // 34: bytebase.store.ProcedureConfig
	(*ViewConfig)(nil),               // 35: bytebase.store.ViewConfig
	(*ColumnConfig)(nil),             // 36: bytebase.store.ColumnConfig
	(*LinkedDatabaseMetadata)(nil),   // 37: bytebase.store.LinkedDatabaseMetadata
...
var file_store_database_proto_depIdxs = []int32{
	...
	25, // 3: bytebase.store.DatabaseSchemaMetadata.extensions:type_name -> bytebase.store.ExtensionMetadata
	37, // 4: bytebase.store.DatabaseSchemaMetadata.linked_databases:type_name -> bytebase.store.LinkedDatabaseMetadata
	12, // 5: bytebase.store.SchemaMetadata.tables:type_name -> bytebase.store.TableMetadata
	14, // 6: bytebase.store.SchemaMetadata.external_tables:type_name -> bytebase.store.ExternalTableMetadata
	18, // 7: bytebase.store.SchemaMetadata.views:type_name -> bytebase.store.ViewMetadata
	21, // 8: bytebase.store.SchemaMetadata.functions:type_name -> bytebase.store.FunctionMetadata
	22, // 9: bytebase.store.SchemaMetadata.procedures:type_name -> bytebase.store.ProcedureMetadata
	11, // 10: bytebase.store.SchemaMetadata.streams:type_name -> bytebase.store.StreamMetadata
	10, // 11: bytebase.store.SchemaMetadata.tasks:type_name -> bytebase.store.TaskMetadata
	20, // 12: bytebase.store.SchemaMetadata.materialized_views:type_name -> bytebase.store.MaterializedViewMetadata
	8,  // 13: bytebase.store.SchemaMetadata.sequences:type_name -> bytebase.store.SequenceMetadata
	23, // 14: bytebase.store.SchemaMetadata.packages:type_name -> bytebase.store.PackageMetadata
	9,  // 15: bytebase.store.SchemaMetadata.triggers:type_name -> bytebase.store.TriggerMetadata
	...
	16, // 19: bytebase.store.TableMetadata.columns:type_name -> bytebase.store.ColumnMetadata
	24, // 20: bytebase.store.TableMetadata.indexes:type_name -> bytebase.store.IndexMetadata
	26, // 21: bytebase.store.TableMetadata.foreign_keys:type_name -> bytebase.store.ForeignKeyMetadata
	15, // 22: bytebase.store.TableMetadata.partitions:type_name -> bytebase.store.TablePartitionMetadata
	13, // 23: bytebase.store.TableMetadata.check_constraints:type_name -> bytebase.store.CheckConstraintMetadata
	16, // 24: bytebase.store.ExternalTableMetadata.columns:type_name -> bytebase.store.ColumnMetadata
	3,  // 25: bytebase.store.TablePartitionMetadata.type:type_name -> bytebase.store.TablePartitionMetadata.Type
	15, // 26: bytebase.store.TablePartitionMetadata.subpartitions:type_name -> bytebase.store.TablePartitionMetadata
	41, // 27: bytebase.store.ColumnMetadata.default:type_name -> google.protobuf.StringValue
	17, // 28: bytebase.store.ColumnMetadata.generation:type_name -> bytebase.store.GenerationMetadata
	4,  // 29: bytebase.store.GenerationMetadata.type:type_name -> bytebase.store.GenerationMetadata.Type
	19, // 30: bytebase.store.ViewMetadata.dependent_columns:type_name -> bytebase.store.DependentColumn
	16, // 31: bytebase.store.ViewMetadata.columns:type_name -> bytebase.store.ColumnMetadata
	19, // 32: bytebase.store.MaterializedViewMetadata.dependent_columns:type_name -> bytebase.store.DependentColumn
	29, // 33: bytebase.store.Secrets.items:type_name -> bytebase.store.SecretItem
	31, // 34: bytebase.store.DatabaseConfig.schema_configs:type_name -> bytebase.store.SchemaConfig
	32, // 35: bytebase.store.SchemaConfig.table_configs:type_name -> bytebase.store.TableConfig
	33, // 36: bytebase.store.SchemaConfig.function_configs:type_name -> bytebase.store.FunctionConfig
	34, // 37: bytebase.store.SchemaConfig.procedure_configs:type_name -> bytebase.store.ProcedureConfig
	35, // 38: bytebase.store.SchemaConfig.view_configs:type_name -> bytebase.store.ViewConfig
	36, // 39: bytebase.store.TableConfig.column_configs:type_name -> bytebase.store.ColumnConfig
