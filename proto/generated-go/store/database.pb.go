...
type Secrets struct {
	...
	// The list of secrets.
	SecretEntries []*SecretEntry `protobuf:"bytes,1,rep,name=secret_entries,json=secretEntries,proto3" json:"secret_entries,omitempty"`
}
...
func (x *Secrets) GetSecretEntries() []*SecretEntry {
	if x != nil {
		return x.SecretEntries
	}
	return nil
}
...
func (x *SecretEntry) GetDescription() string {
	if x != nil {
		return x.Description
	}
	return ""
...
var file_store_database_proto_rawDesc = []byte{
	...
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xe6, 0x01, 0x0a, 0x10, 0x44, 0x61, 0x74, 0x61, 0x62,
	...
	0xcf, 0x01, 0x0a, 0x0e, 0x53, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61,
	...
	0x73, 0x22, 0xca, 0x03, 0x0a, 0x0d, 0x54, 0x61, 0x62, 0x6c, 0x65, 0x4d, 0x65, 0x74, 0x61, 0x64,
	...
	0x63, 0x6f, 0x6d, 0x6d, 0x65, 0x6e, 0x74, 0x12, 0x45, 0x0a, 0x0c, 0x66, 0x6f, 0x72, 0x65, 0x69,
	...
	0x01, 0x28, 0x09, 0x52, 0x05, 0x67, 0x72, 0x61, 0x6e, 0x74, 0x22, 0x4d, 0x0a, 0x07, 0x53, 0x65,
	0x63, 0x72, 0x65, 0x74, 0x73, 0x12, 0x42, 0x0a, 0x0e, 0x73, 0x65, 0x63, 0x72, 0x65, 0x74, 0x5f,
	...
	0x65, 0x63, 0x72, 0x65, 0x74, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x52, 0x0d, 0x73, 0x65, 0x63, 0x72,
	0x65, 0x74, 0x45, 0x6e, 0x74, 0x72, 0x69, 0x65, 0x73, 0x22, 0x59, 0x0a, 0x0b, 0x53, 0x65, 0x63,
	0x72, 0x65, 0x74, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x12, 0x12, 0x0a, 0x04, 0x6e, 0x61, 0x6d, 0x65,
...
var file_store_database_proto_goTypes = []interface{}{
	...
	(*DependentColumn)(nil),        // 5: bytebase.store.DependentColumn
	(*FunctionMetadata)(nil),       // 6: bytebase.store.FunctionMetadata
	(*IndexMetadata)(nil),          // 7: bytebase.store.IndexMetadata
	...
	(*SecretEntry)(nil),            // 12: bytebase.store.SecretEntry
...
var file_store_database_proto_depIdxs = []int32{
	...
	8,  // 1: bytebase.store.DatabaseMetadata.extensions:type_name -> bytebase.store.ExtensionMetadata
	...
	6,  // 4: bytebase.store.SchemaMetadata.functions:type_name -> bytebase.store.FunctionMetadata
	...
	12, // 10: bytebase.store.Secrets.secret_entries:type_name -> bytebase.store.SecretEntry
