...
var file_store_common_proto_rawDesc = []byte{
	...
	0x06, 0x63, 0x6f, 0x6c, 0x75, 0x6d, 0x6e, 0x22, 0x37, 0x0a, 0x0d, 0x44, 0x61, 0x74, 0x61, 0x62,
	0x61, 0x73, 0x65, 0x4c, 0x61, 0x62, 0x65, 0x6c, 0x12, 0x10, 0x0a, 0x03, 0x6b, 0x65, 0x79, 0x18,
	...
	0x53, 0x58, 0x10, 0x04, 0x42, 0x14, 0x5a, 0x12, 0x67, 0x65, 0x6e, 0x65, 0x72, 0x61, 0x74, 0x65,
...
var file_store_common_proto_goTypes = []any{
	...
	(*DatabaseLabel)(nil), // 6: bytebase.store.DatabaseLabel
}
...
func file_store_common_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_store_common_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_store_common_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_store_common_proto_msgTypes[2].Exporter = func(v any, i int) any {
			switch v := v.(*DatabaseLabel); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
