...
type ApprovalConfigSetting struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Rules []*ApprovalConfigSetting_Rule `protobuf:"bytes,1,rep,name=rules,proto3" json:"rules,omitempty"`
}

func (x *ApprovalConfigSetting) Reset() {
	*x = ApprovalConfigSetting{}
	if protoimpl.UnsafeEnabled {
...
func (x *ApprovalConfigSetting) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ApprovalConfigSetting) ProtoMessage() {}

func (x *ApprovalConfigSetting) ProtoReflect() protoreflect.Message {
	mi := &file_store_setting_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ApprovalConfigSetting.ProtoReflect.Descriptor instead.
func (*ApprovalConfigSetting) Descriptor() ([]byte, []int) {
	return file_store_setting_proto_rawDescGZIP(), []int{2}
}

func (x *ApprovalConfigSetting) GetRules() []*ApprovalConfigSetting_Rule {
	if x != nil {
		return x.Rules
	}
	return nil
...
func (x *ApprovalConfigSetting_Rule) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
// Deprecated: Use ApprovalConfigSetting_Rule.ProtoReflect.Descriptor instead.
func (*ApprovalConfigSetting_Rule) Descriptor() ([]byte, []int) {
	return file_store_setting_proto_rawDescGZIP(), []int{2, 0}
}

func (x *ApprovalConfigSetting_Rule) GetExpression() *v1alpha1.ParsedExpr {
	if x != nil {
		return x.Expression
	}
	return nil
...
func (x *ApprovalConfigSetting_Rule) GetTemplate() *ApprovalTemplate {
	if x != nil {
		return x.Template
	}
	return nil
...
var file_store_setting_proto_rawDesc = []byte{
	...
	0x52, 0x05, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0xe6, 0x01, 0x0a, 0x15, 0x41, 0x70, 0x70, 0x72,
	0x6f, 0x76, 0x61, 0x6c, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x53, 0x65, 0x74, 0x74, 0x69, 0x6e,
	0x67, 0x12, 0x40, 0x0a, 0x05, 0x72, 0x75, 0x6c, 0x65, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b,
	0x32, 0x2a, 0x2e, 0x62, 0x79, 0x74, 0x65, 0x62, 0x61, 0x73, 0x65, 0x2e, 0x73, 0x74, 0x6f, 0x72,
	0x65, 0x2e, 0x41, 0x70, 0x70, 0x72, 0x6f, 0x76, 0x61, 0x6c, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67,
...
func file_store_setting_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_store_setting_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ApprovalConfigSetting); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
