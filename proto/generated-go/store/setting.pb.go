...
type SchemaTemplateSetting_FieldTemplate struct {
	...
	Payload *ColumnMetadata `protobuf:"bytes,3,opt,name=payload,proto3" json:"payload,omitempty"`
}
...
func (x *SchemaTemplateSetting_FieldTemplate) GetPayload() *ColumnMetadata {
	if x != nil {
		return x.Payload
	}
	return nil
...
var file_store_setting_proto_rawDesc = []byte{
	...
	0x41, 0x4d, 0x5f, 0x4d, 0x44, 0x35, 0x10, 0x04, 0x22, 0x81, 0x02, 0x0a, 0x15, 0x53, 0x63, 0x68,
	...
	0x1a, 0x89, 0x01, 0x0a, 0x0d, 0x46, 0x69, 0x65, 0x6c, 0x64, 0x54, 0x65, 0x6d, 0x70, 0x6c, 0x61,
	...
	0x6e, 0x65, 0x12, 0x38, 0x0a, 0x07, 0x70, 0x61, 0x79, 0x6c, 0x6f, 0x61, 0x64, 0x18, 0x03, 0x20,
	...
	0x61, 0x74, 0x61, 0x52, 0x07, 0x70, 0x61, 0x79, 0x6c, 0x6f, 0x61, 0x64, 0x42, 0x14, 0x5a, 0x12,
...
var file_store_setting_proto_depIdxs = []int32{
	...
	15, // 9: bytebase.store.SchemaTemplateSetting.FieldTemplate.payload:type_name -> bytebase.store.ColumnMetadata
