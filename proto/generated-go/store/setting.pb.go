...
func (x *MaskingAlgorithmSetting_Algorithm) GetMask() isMaskingAlgorithmSetting_Algorithm_Mask {
	if x != nil {
		return x.Mask
	}
	return nil
...
func (x *MaskingAlgorithmSetting_Algorithm) GetFullMask() *MaskingAlgorithmSetting_Algorithm_FullMask {
	if x != nil {
		if x, ok := x.Mask.(*MaskingAlgorithmSetting_Algorithm_FullMask_); ok {
			return x.FullMask
		}
	}
	return nil
...
func (x *MaskingAlgorithmSetting_Algorithm) GetRangeMask() *MaskingAlgorithmSetting_Algorithm_RangeMask {
	if x != nil {
		if x, ok := x.Mask.(*MaskingAlgorithmSetting_Algorithm_RangeMask_); ok {
			return x.RangeMask
		}
	}
	return nil
...
func (x *MaskingAlgorithmSetting_Algorithm) GetMd5Mask() *MaskingAlgorithmSetting_Algorithm_MD5Mask {
	if x != nil {
		if x, ok := x.Mask.(*MaskingAlgorithmSetting_Algorithm_Md5Mask); ok {
			return x.Md5Mask
		}
	}
	return nil
...
func (x *MaskingAlgorithmSetting_Algorithm) GetInnerOuterMask() *MaskingAlgorithmSetting_Algorithm_InnerOuterMask {
	if x != nil {
		if x, ok := x.Mask.(*MaskingAlgorithmSetting_Algorithm_InnerOuterMask_); ok {
...
var file_store_setting_proto_depIdxs = []int32{
	...
	39, // 18: bytebase.store.AppIMSetting.lark:type_name -> bytebase.store.AppIMSetting.Lark
	40, // 19: bytebase.store.PasswordRestrictionSetting.password_rotation:type_name -> google.protobuf.Duration
	41, // 20: bytebase.store.WorkspaceApprovalSetting.Rule.expression:type_name -> google.api.expr.v1alpha1.Expr
	42, // 21: bytebase.store.WorkspaceApprovalSetting.Rule.template:type_name -> bytebase.store.ApprovalTemplate
	43, // 22: bytebase.store.WorkspaceApprovalSetting.Rule.condition:type_name -> google.type.Expr
	...
	26, // 30: bytebase.store.DataClassificationSetting.DataClassificationConfig.levels:type_name -> bytebase.store.DataClassificationSetting.DataClassificationConfig.Level
	28, // 31: bytebase.store.DataClassificationSetting.DataClassificationConfig.classification:type_name -> bytebase.store.DataClassificationSetting.DataClassificationConfig.ClassificationEntry
	27, // 32: bytebase.store.DataClassificationSetting.DataClassificationConfig.ClassificationEntry.value:type_name -> bytebase.store.DataClassificationSetting.DataClassificationConfig.DataClassification
	31, // 33: bytebase.store.MaskingAlgorithmSetting.Algorithm.full_mask:type_name -> bytebase.store.MaskingAlgorithmSetting.Algorithm.FullMask
	32, // 34: bytebase.store.MaskingAlgorithmSetting.Algorithm.range_mask:type_name -> bytebase.store.MaskingAlgorithmSetting.Algorithm.RangeMask
	33, // 35: bytebase.store.MaskingAlgorithmSetting.Algorithm.md5_mask:type_name -> bytebase.store.MaskingAlgorithmSetting.Algorithm.MD5Mask
	34, // 36: bytebase.store.MaskingAlgorithmSetting.Algorithm.inner_outer_mask:type_name -> bytebase.store.MaskingAlgorithmSetting.Algorithm.InnerOuterMask
	35, // 37: bytebase.store.MaskingAlgorithmSetting.Algorithm.RangeMask.slices:type_name -> bytebase.store.MaskingAlgorithmSetting.Algorithm.RangeMask.Slice
	4,  // 38: bytebase.store.MaskingAlgorithmSetting.Algorithm.InnerOuterMask.type:type_name -> bytebase.store.MaskingAlgorithmSetting.Algorithm.InnerOuterMask.MaskType
