...
var file_store_setting_proto_rawDesc = []byte{
	...
	0x28, 0x09, 0x52, 0x05, 0x74, 0x79, 0x70, 0x65, 0x73, 0x42, 0x14, 0x5a, 0x12, 0x67, 0x65, 0x6e,
...
var file_store_setting_proto_goTypes = []interface{}{
	...
	(*ApprovalTemplate)(nil),                    // 13: bytebase.store.ApprovalTemplate
	(*expr.Expr)(nil),                           // 14: google.type.Expr
	(Engine)(0),                                 // 15: bytebase.store.Engine
	(*ColumnMetadata)(nil),                      // 16: bytebase.store.ColumnMetadata
}
var file_store_setting_proto_depIdxs = []int32{
	...
	11, // 5: bytebase.store.SchemaTemplateSetting.column_types:type_name -> bytebase.store.SchemaTemplateSetting.ColumnType
	12, // 6: bytebase.store.WorkspaceApprovalSetting.Rule.expression:type_name -> google.api.expr.v1alpha1.ParsedExpr
	13, // 7: bytebase.store.WorkspaceApprovalSetting.Rule.template:type_name -> bytebase.store.ApprovalTemplate
	14, // 8: bytebase.store.WorkspaceApprovalSetting.Rule.condition:type_name -> google.type.Expr
	15, // 9: bytebase.store.SchemaTemplateSetting.FieldTemplate.engine:type_name -> bytebase.store.Engine
	16, // 10: bytebase.store.SchemaTemplateSetting.FieldTemplate.column:type_name -> bytebase.store.ColumnMetadata
	15, // 11: bytebase.store.SchemaTemplateSetting.ColumnType.engine:type_name -> bytebase.store.Engine
