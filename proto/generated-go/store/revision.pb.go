...
func (x *RevisionPayload) GetSheetSha1() string {
	if x != nil {
		return x.SheetSha1
	}
	return ""
...
var file_store_revision_proto_rawDesc = []byte{
	...
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xad, 0x02, 0x0a, 0x0f, 0x52, 0x65, 0x76, 0x69, 0x73,
	...
	0x28, 0x09, 0x52, 0x09, 0x73, 0x68, 0x65, 0x65, 0x74, 0x53, 0x68, 0x61, 0x31, 0x12, 0x33, 0x0a,
	0x04, 0x74, 0x79, 0x70, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x1f, 0x2e, 0x62, 0x79,
	0x74, 0x65, 0x62, 0x61, 0x73, 0x65, 0x2e, 0x73, 0x74, 0x6f, 0x72, 0x65, 0x2e, 0x52, 0x65, 0x6c,
	0x65, 0x61, 0x73, 0x65, 0x46, 0x69, 0x6c, 0x65, 0x54, 0x79, 0x70, 0x65, 0x52, 0x04, 0x74, 0x79,
	...
	0x12, 0x34, 0x0a, 0x08, 0x74, 0x61, 0x73, 0x6b, 0x5f, 0x72, 0x75, 0x6e, 0x18, 0x07, 0x20, 0x01,
...
func file_store_revision_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_store_revision_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*RevisionPayload); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
