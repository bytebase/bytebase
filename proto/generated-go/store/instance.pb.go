...
func (x *InstanceOption) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*InstanceOption) ProtoMessage() {}

func (x *InstanceOption) ProtoReflect() protoreflect.Message {
	mi := &file_store_instance_proto_msgTypes[0]
...
// Deprecated: Use InstanceOption.ProtoReflect.Descriptor instead.
func (*InstanceOption) Descriptor() ([]byte, []int) {
	return file_store_instance_proto_rawDescGZIP(), []int{0}
}

func (x *InstanceOption) GetSchemaTenantMode() bool {
	if x != nil {
...
var file_store_instance_proto_rawDesc = []byte{
	...
	0x2e, 0x73, 0x74, 0x6f, 0x72, 0x65, 0x22, 0x3e, 0x0a, 0x0e, 0x49, 0x6e, 0x73, 0x74, 0x61, 0x6e,
	0x63, 0x65, 0x4f, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x2c, 0x0a, 0x12, 0x73, 0x63, 0x68, 0x65,
	...
	0x6e, 0x74, 0x4d, 0x6f, 0x64, 0x65, 0x42, 0x14, 0x5a, 0x12, 0x67, 0x65, 0x6e, 0x65, 0x72, 0x61,
...
var file_store_instance_proto_goTypes = []interface{}{
	(*InstanceOption)(nil), // 0: bytebase.store.InstanceOption
}
