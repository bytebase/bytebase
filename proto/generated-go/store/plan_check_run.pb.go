...
func (PlanCheckRunConfig_ChangeDatabaseType) Descriptor() protoreflect.EnumDescriptor {
	return file_plan_check_run_proto_enumTypes[0].Descriptor()
}

func (PlanCheckRunConfig_ChangeDatabaseType) Type() protoreflect.EnumType {
	return &file_plan_check_run_proto_enumTypes[0]
}
...
func (PlanCheckRunConfig_ChangeDatabaseType) EnumDescriptor() ([]byte, []int) {
	return file_plan_check_run_proto_rawDescGZIP(), []int{0, 0}
}
...
func (PlanCheckRunResult_Result_Status) Descriptor() protoreflect.EnumDescriptor {
	return file_plan_check_run_proto_enumTypes[1].Descriptor()
}

func (PlanCheckRunResult_Result_Status) Type() protoreflect.EnumType {
	return &file_plan_check_run_proto_enumTypes[1]
}
...
func (PlanCheckRunResult_Result_Status) EnumDescriptor() ([]byte, []int) {
	return file_plan_check_run_proto_rawDescGZIP(), []int{1, 0, 0}
}
...
func (x *PlanCheckRunConfig) Reset() {
	*x = PlanCheckRunConfig{}
	if protoimpl.UnsafeEnabled {
		mi := &file_plan_check_run_proto_msgTypes[0]
...
func (*PlanCheckRunConfig) Descriptor() ([]byte, []int) {
	return file_plan_check_run_proto_rawDescGZIP(), []int{0}
}
...
func (x *PlanCheckRunResult) Reset() {
	*x = PlanCheckRunResult{}
	if protoimpl.UnsafeEnabled {
		mi := &file_plan_check_run_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*PlanCheckRunResult) Descriptor() ([]byte, []int) {
	return file_plan_check_run_proto_rawDescGZIP(), []int{1}
}
...
func (x *PlanCheckRunConfig_PreUpdateBackupDetail) Reset() {
	*x = PlanCheckRunConfig_PreUpdateBackupDetail{}
	if protoimpl.UnsafeEnabled {
		mi := &file_plan_check_run_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*PlanCheckRunConfig_PreUpdateBackupDetail) Descriptor() ([]byte, []int) {
	return file_plan_check_run_proto_rawDescGZIP(), []int{0, 1}
}
...
func (x *PlanCheckRunResult_Result) Reset() {
	*x = PlanCheckRunResult_Result{}
	if protoimpl.UnsafeEnabled {
		mi := &file_plan_check_run_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*PlanCheckRunResult_Result) Descriptor() ([]byte, []int) {
	return file_plan_check_run_proto_rawDescGZIP(), []int{1, 0}
}
...
func (x *PlanCheckRunResult_Result_SqlSummaryReport) Reset() {
	*x = PlanCheckRunResult_Result_SqlSummaryReport{}
	if protoimpl.UnsafeEnabled {
		mi := &file_plan_check_run_proto_msgTypes[5]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (x *PlanCheckRunResult_Result_SqlReviewReport) Reset() {
	*x = PlanCheckRunResult_Result_SqlReviewReport{}
	if protoimpl.UnsafeEnabled {
		mi := &file_plan_check_run_proto_msgTypes[6]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*PlanCheckRunResult_Result_SqlReviewReport) Descriptor() ([]byte, []int) {
	return file_plan_check_run_proto_rawDescGZIP(), []int{1, 0, 1}
}
...
var File_plan_check_run_proto protoreflect.FileDescriptor

var file_plan_check_run_proto_rawDesc = []byte{
	,
	...
	0x67, 0x73, 0x12, 0x76, 0x0a, 0x18, 0x70, 0x72, 0x65, 0x5f, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65,
	0x5f, 0x62, 0x61, 0x63, 0x6b, 0x75, 0x70, 0x5f, 0x64, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x18, 0x07,
	0x20, 0x01, 0x28, 0x0b, 0x32, 0x38, 0x2e, 0x62, 0x79, 0x74, 0x65, 0x62, 0x61, 0x73, 0x65, 0x2e,
	0x73, 0x74, 0x6f, 0x72, 0x65, 0x2e, 0x50, 0x6c, 0x61, 0x6e, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x52,
	0x75, 0x6e, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x2e, 0x50, 0x72, 0x65, 0x55, 0x70, 0x64, 0x61,
	...
	0x0a, 0x12, 0x43, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x44, 0x61, 0x74, 0x61, 0x62, 0x61, 0x73, 0x65,
	0x54, 0x79, 0x70, 0x65, 0x12, 0x24, 0x0a, 0x20, 0x43, 0x48, 0x41, 0x4e, 0x47, 0x45, 0x5f, 0x44,
	...
	0x4c, 0x10, 0x01, 0x12, 0x07, 0x0a, 0x03, 0x44, 0x4d, 0x4c, 0x10, 0x02, 0x12, 0x07, 0x0a, 0x03,
	0x53, 0x44, 0x4c, 0x10, 0x03, 0x12, 0x0d, 0x0a, 0x09, 0x44, 0x44, 0x4c, 0x5f, 0x47, 0x48, 0x4f,
	0x53, 0x54, 0x10, 0x04, 0x42, 0x15, 0x0a, 0x13, 0x5f, 0x64, 0x61, 0x74, 0x61, 0x62, 0x61, 0x73,
	0x65, 0x5f, 0x67, 0x72, 0x6f, 0x75, 0x70, 0x5f, 0x75, 0x69, 0x64, 0x42, 0x1b, 0x0a, 0x19, 0x5f,
	0x70, 0x72, 0x65, 0x5f, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x5f, 0x62, 0x61, 0x63, 0x6b, 0x75,
	0x70, 0x5f, 0x64, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x22, 0xdf, 0x06, 0x0a, 0x12, 0x50, 0x6c, 0x61,
	0x6e, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x52, 0x75, 0x6e, 0x52, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x12,
	...
	0x01, 0x28, 0x09, 0x52, 0x05, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x1a, 0xed, 0x05, 0x0a, 0x06, 0x52,
	...
	0x6f, 0x64, 0x65, 0x12, 0x6a, 0x0a, 0x12, 0x73, 0x71, 0x6c, 0x5f, 0x73, 0x75, 0x6d, 0x6d, 0x61,
	...
	0x2e, 0x50, 0x6c, 0x61, 0x6e, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x52, 0x75, 0x6e, 0x52, 0x65, 0x73,
	0x75, 0x6c, 0x74, 0x2e, 0x52, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x2e, 0x53, 0x71, 0x6c, 0x53, 0x75,
	...
	0x67, 0x0a, 0x11, 0x73, 0x71, 0x6c, 0x5f, 0x72, 0x65, 0x76, 0x69, 0x65, 0x77, 0x5f, 0x72, 0x65,
	0x70, 0x6f, 0x72, 0x74, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x39, 0x2e, 0x62, 0x79, 0x74,
	...
	0x65, 0x77, 0x52, 0x65, 0x70, 0x6f, 0x72, 0x74, 0x1a, 0xc3, 0x01, 0x0a, 0x10, 0x53, 0x71, 0x6c,
	...
	0x72, 0x63, 0x65, 0x73, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x20, 0x2e, 0x62, 0x79, 0x74,
...
var (
	file_plan_check_run_proto_rawDescOnce sync.Once
	file_plan_check_run_proto_rawDescData = file_plan_check_run_proto_rawDesc
)

func file_plan_check_run_proto_rawDescGZIP() []byte {
	file_plan_check_run_proto_rawDescOnce.Do(func() {
		file_plan_check_run_proto_rawDescData = protoimpl.X.CompressGZIP(file_plan_check_run_proto_rawDescData)
	})
	return file_plan_check_run_proto_rawDescData
}

var file_plan_check_run_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
var file_plan_check_run_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_plan_check_run_proto_goTypes = []interface{}{
...
var file_plan_check_run_proto_depIdxs = []int32{
...
func init() { file_plan_check_run_proto_init() }
func file_plan_check_run_proto_init() {
	if File_plan_check_run_proto != nil {
		return
	}
	file_instance_change_history_proto_init()
	if !protoimpl.UnsafeEnabled {
		file_plan_check_run_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_plan_check_run_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_plan_check_run_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_plan_check_run_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_plan_check_run_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
		...
		file_plan_check_run_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
	...
	file_plan_check_run_proto_msgTypes[0].OneofWrappers = []interface{}{}
	file_plan_check_run_proto_msgTypes[4].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_plan_check_run_proto_rawDesc,
			NumEnums:      2,
			NumMessages:   7,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_plan_check_run_proto_goTypes,
		DependencyIndexes: file_plan_check_run_proto_depIdxs,
		EnumInfos:         file_plan_check_run_proto_enumTypes,
		MessageInfos:      file_plan_check_run_proto_msgTypes,
	}.Build()
	File_plan_check_run_proto = out.File
	file_plan_check_run_proto_rawDesc = nil
	file_plan_check_run_proto_goTypes = nil
	file_plan_check_run_proto_depIdxs = nil
}
