...
type PlanCheckRunConfig_DatabaseGroupTarget struct {
	...
	DatabaseGroupUid int32 `protobuf:"varint,1,opt,name=database_group_uid,json=databaseGroupUid,proto3" json:"database_group_uid,omitempty"`
}
...
var file_store_plan_check_run_proto_rawDesc = []byte{
	...
	0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x05, 0x52, 0x10, 0x64, 0x61, 0x74, 0x61, 0x62, 0x61, 0x73,
