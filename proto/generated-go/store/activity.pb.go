...
func file_store_activity_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_store_activity_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_store_activity_proto_msgTypes[5].Exporter = func(v any, i int) any {
	...
	file_store_activity_proto_msgTypes[1].OneofWrappers = []any{
