...
func file_store_anomaly_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_store_anomaly_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*AnomalyConnectionPayload); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_store_anomaly_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*AnomalyDatabaseSchemaDriftPayload); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
