...
func file_store_task_run_log_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_store_task_run_log_proto_msgTypes[8].Exporter = func(v any, i int) any {
			switch v := v.(*TaskRunLog_TransactionControl); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_store_task_run_log_proto_msgTypes[9].Exporter = func(v any, i int) any {
			switch v := v.(*TaskRunLog_PriorBackupStart); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_store_task_run_log_proto_msgTypes[10].Exporter = func(v any, i int) any {
			switch v := v.(*TaskRunLog_PriorBackupEnd); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
