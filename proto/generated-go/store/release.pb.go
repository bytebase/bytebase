...
type ReleasePayload_File struct {
	...
	Type      ReleasePayload_File_Type `protobuf:"varint,4,opt,name=type,proto3,enum=bytebase.store.ReleasePayload_File_Type" json:"type,omitempty"`
...
func (x *ReleasePayload_File) GetTitle() string {
	if x != nil {
		return x.Title
	}
	return ""
...
func (x *ReleasePayload_File) GetSheetSha1() string {
	if x != nil {
		return x.SheetSha1
	}
	return ""
...
var file_store_release_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x22, 0x87, 0x04, 0x0a, 0x0e, 0x52, 0x65, 0x6c, 0x65, 0x61, 0x73, 0x65,
	...
	0x65, 0x1a, 0xef, 0x01, 0x0a, 0x04, 0x46, 0x69, 0x6c, 0x65, 0x12, 0x14, 0x0a, 0x05, 0x74, 0x69,
	...
	0x1d, 0x0a, 0x0a, 0x73, 0x68, 0x65, 0x65, 0x74, 0x5f, 0x73, 0x68, 0x61, 0x31, 0x18, 0x03, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x09, 0x73, 0x68, 0x65, 0x65, 0x74, 0x53, 0x68, 0x61, 0x31, 0x12, 0x3c,
	0x0a, 0x04, 0x74, 0x79, 0x70, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x28, 0x2e, 0x62,
	0x79, 0x74, 0x65, 0x62, 0x61, 0x73, 0x65, 0x2e, 0x73, 0x74, 0x6f, 0x72, 0x65, 0x2e, 0x52, 0x65,
	0x6c, 0x65, 0x61, 0x73, 0x65, 0x50, 0x61, 0x79, 0x6c, 0x6f, 0x61, 0x64, 0x2e, 0x46, 0x69, 0x6c,
	...
	0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x22, 0x2b, 0x0a, 0x04, 0x54, 0x79, 0x70, 0x65, 0x12, 0x14,
	...
	0x44, 0x10, 0x01, 0x1a, 0x69, 0x0a, 0x09, 0x56, 0x43, 0x53, 0x53, 0x6f, 0x75, 0x72, 0x63, 0x65,
	...
	0x54, 0x79, 0x70, 0x65, 0x12, 0x28, 0x0a, 0x10, 0x70, 0x75, 0x6c, 0x6c, 0x5f, 0x72, 0x65, 0x71,
	0x75, 0x65, 0x73, 0x74, 0x5f, 0x75, 0x72, 0x6c, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0e,
...
func file_store_release_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_store_release_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_store_release_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*ReleasePayload_File); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_store_release_proto_msgTypes[2].Exporter = func(v any, i int) any {
			switch v := v.(*ReleasePayload_VCSSource); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
