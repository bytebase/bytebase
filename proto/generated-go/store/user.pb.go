...
var file_store_user_proto_rawDesc = []byte{
	...
	0xa8, 0x01, 0x0a, 0x0b, 0x55, 0x73, 0x65, 0x72, 0x50, 0x72, 0x6f, 0x66, 0x69, 0x6c, 0x65, 0x12,
	...
	0x73, 0x73, 0x77, 0x6f, 0x72, 0x64, 0x54, 0x69, 0x6d, 0x65, 0x42, 0x14, 0x5a, 0x12, 0x67, 0x65,
...
func file_store_user_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_store_user_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_store_user_proto_msgTypes[1].Exporter = func(v any, i int) any {
