...
type Advice struct {
	...
	StartPosition *Advice_Position `protobuf:"bytes,6,opt,name=start_position,json=startPosition,proto3" json:"start_position,omitempty"`
}
...
func (x *Advice) GetStartPosition() *Advice_Position {
	if x != nil {
...
func (x *Advice_Position) Reset() {
	*x = Advice_Position{}
	if protoimpl.UnsafeEnabled {
		mi := &file_store_advice_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *Advice_Position) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Advice_Position) ProtoMessage() {}

func (x *Advice_Position) ProtoReflect() protoreflect.Message {
	mi := &file_store_advice_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Advice_Position.ProtoReflect.Descriptor instead.
func (*Advice_Position) Descriptor() ([]byte, []int) {
	return file_store_advice_proto_rawDescGZIP(), []int{0, 0}
}

func (x *Advice_Position) GetLine() int32 {
	if x != nil {
		return x.Line
	}
	return 0
...
func (x *Advice_Position) GetColumn() int32 {
	if x != nil {
		return x.Column
	}
	return 0
...
var file_store_advice_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x72, 0x65, 0x22, 0xe2, 0x02, 0x0a, 0x06, 0x41, 0x64, 0x76, 0x69, 0x63, 0x65, 0x12,
	...
	0x09, 0x52, 0x07, 0x63, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x12, 0x16, 0x0a, 0x06, 0x64, 0x65,
	0x74, 0x61, 0x69, 0x6c, 0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x64, 0x65, 0x74, 0x61,
	0x69, 0x6c, 0x12, 0x46, 0x0a, 0x0e, 0x73, 0x74, 0x61, 0x72, 0x74, 0x5f, 0x70, 0x6f, 0x73, 0x69,
	0x74, 0x69, 0x6f, 0x6e, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1f, 0x2e, 0x62, 0x79, 0x74,
	0x65, 0x62, 0x61, 0x73, 0x65, 0x2e, 0x73, 0x74, 0x6f, 0x72, 0x65, 0x2e, 0x41, 0x64, 0x76, 0x69,
	0x63, 0x65, 0x2e, 0x50, 0x6f, 0x73, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x0d, 0x73, 0x74, 0x61,
	0x72, 0x74, 0x50, 0x6f, 0x73, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x1a, 0x36, 0x0a, 0x08, 0x50, 0x6f,
	...
	0x6d, 0x6e, 0x22, 0x45, 0x0a, 0x06, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x16, 0x0a, 0x12,
	...
	0x0a, 0x05, 0x45, 0x52, 0x52, 0x4f, 0x52, 0x10, 0x03, 0x42, 0x14, 0x5a, 0x12, 0x67, 0x65, 0x6e,
...
var file_store_advice_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_store_advice_proto_goTypes = []interface{}{
	(Advice_Status)(0),      // 0: bytebase.store.Advice.Status
	(*Advice)(nil),          // 1: bytebase.store.Advice
	(*Advice_Position)(nil), // 2: bytebase.store.Advice.Position
}
var file_store_advice_proto_depIdxs = []int32{
	0, // 0: bytebase.store.Advice.status:type_name -> bytebase.store.Advice.Status
	2, // 1: bytebase.store.Advice.start_position:type_name -> bytebase.store.Advice.Position
...
func file_store_advice_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_store_advice_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Advice); i {
			case 0:
				return &v.state
			case 1:
		...
		file_store_advice_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Advice_Position); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
