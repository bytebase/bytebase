...
var file_store_plan_proto_rawDesc = string([]byte{
	...
	0x68, 0x65, 0x63, 0x6b, 0x5f, 0x72, 0x75, 0x6e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x84,
	0x14, 0x0a, 0x0a, 0x50, 0x6c, 0x61, 0x6e, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x12, 0x35, 0x0a,
	...
	0x70, 0x65, 0x63, 0x52, 0x05, 0x73, 0x70, 0x65, 0x63, 0x73, 0x1a, 0xfd, 0x03, 0x0a, 0x04, 0x53,
	...
	0x02, 0x69, 0x64, 0x12, 0x5c, 0x0a, 0x13, 0x73, 0x70, 0x65, 0x63, 0x5f, 0x72, 0x65, 0x6c, 0x65,
	...
	0x42, 0x08, 0x0a, 0x06, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x1a, 0xc3, 0x02, 0x0a, 0x14, 0x43,
...
var file_store_plan_proto_msgTypes = make([]protoimpl.MessageInfo, 12)
var file_store_plan_proto_goTypes = []any{
	...
	(*PlanConfig_DeploymentSnapshot_DeploymentConfigSnapshot)(nil), // 11: bytebase.store.PlanConfig.DeploymentSnapshot.DeploymentConfigSnapshot
	(*PlanConfig_DeploymentSnapshot_DatabaseGroupSnapshot)(nil),    // 12: bytebase.store.PlanConfig.DeploymentSnapshot.DatabaseGroupSnapshot
	(*timestamppb.Timestamp)(nil),                                  // 13: google.protobuf.Timestamp
	(*PreUpdateBackupDetail)(nil),                                  // 14: bytebase.store.PreUpdateBackupDetail
	(ExportFormat)(0),                                              // 15: bytebase.store.ExportFormat
	(*DeploymentConfig)(nil),                                       // 16: bytebase.store.DeploymentConfig
}
var file_store_plan_proto_depIdxs = []int32{
	...
	13, // 4: bytebase.store.PlanConfig.Spec.earliest_allowed_time:type_name -> google.protobuf.Timestamp
	...
	14, // 11: bytebase.store.PlanConfig.ChangeDatabaseConfig.pre_update_backup_detail:type_name -> bytebase.store.PreUpdateBackupDetail
	15, // 12: bytebase.store.PlanConfig.ExportDataConfig.format:type_name -> bytebase.store.ExportFormat
	11, // 13: bytebase.store.PlanConfig.DeploymentSnapshot.deployment_config_snapshot:type_name -> bytebase.store.PlanConfig.DeploymentSnapshot.DeploymentConfigSnapshot
	12, // 14: bytebase.store.PlanConfig.DeploymentSnapshot.database_group_snapshots:type_name -> bytebase.store.PlanConfig.DeploymentSnapshot.DatabaseGroupSnapshot
	16, // 15: bytebase.store.PlanConfig.DeploymentSnapshot.DeploymentConfigSnapshot.deployment_config:type_name -> bytebase.store.DeploymentConfig
