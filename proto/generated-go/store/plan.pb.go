...
var file_store_plan_proto_goTypes = []any{
	...
	(VCSType)(0),                              // 15: bytebase.store.VCSType
}
var file_store_plan_proto_depIdxs = []int32{
	...
	9,  // 5: bytebase.store.PlanConfig.Spec.spec_release_source:type_name -> bytebase.store.PlanConfig.SpecReleaseSource
	...
	13, // 12: bytebase.store.PlanConfig.ChangeDatabaseConfig.pre_update_backup_detail:type_name -> bytebase.store.PreUpdateBackupDetail
	14, // 13: bytebase.store.PlanConfig.ExportDataConfig.format:type_name -> bytebase.store.ExportFormat
	15, // 14: bytebase.store.PlanConfig.VCSSource.vcs_type:type_name -> bytebase.store.VCSType
