...
// 	protoc        (unknown)
// source: api/v1alpha/iam_policy.proto
...
func (BindingDelta_Action) Descriptor() protoreflect.EnumDescriptor {
	return file_api_v1alpha_iam_policy_proto_enumTypes[0].Descriptor()
}

func (BindingDelta_Action) Type() protoreflect.EnumType {
	return &file_api_v1alpha_iam_policy_proto_enumTypes[0]
}
...
func (BindingDelta_Action) EnumDescriptor() ([]byte, []int) {
	return file_api_v1alpha_iam_policy_proto_rawDescGZIP(), []int{5, 0}
}
...
func (x *GetIamPolicyRequest) Reset() {
	*x = GetIamPolicyRequest{}
	mi := &file_api_v1alpha_iam_policy_proto_msgTypes[0]
...
func (*GetIamPolicyRequest) Descriptor() ([]byte, []int) {
	return file_api_v1alpha_iam_policy_proto_rawDescGZIP(), []int{0}
}
...
func (x *SetIamPolicyRequest) Reset() {
	*x = SetIamPolicyRequest{}
	mi := &file_api_v1alpha_iam_policy_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SetIamPolicyRequest) Descriptor() ([]byte, []int) {
	return file_api_v1alpha_iam_policy_proto_rawDescGZIP(), []int{1}
}
...
func (x *IamPolicy) Reset() {
	*x = IamPolicy{}
	mi := &file_api_v1alpha_iam_policy_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*IamPolicy) Descriptor() ([]byte, []int) {
	return file_api_v1alpha_iam_policy_proto_rawDescGZIP(), []int{2}
}
...
func (x *Binding) Reset() {
	*x = Binding{}
	mi := &file_api_v1alpha_iam_policy_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Binding) Descriptor() ([]byte, []int) {
	return file_api_v1alpha_iam_policy_proto_rawDescGZIP(), []int{3}
}
...
func (x *PolicyDelta) Reset() {
	*x = PolicyDelta{}
	mi := &file_api_v1alpha_iam_policy_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*PolicyDelta) Descriptor() ([]byte, []int) {
	return file_api_v1alpha_iam_policy_proto_rawDescGZIP(), []int{4}
}
...
type BindingDelta struct {
	...
	Action BindingDelta_Action `protobuf:"varint,1,opt,name=action,proto3,enum=bytebase.api.v1alpha.BindingDelta_Action" json:"action,omitempty"`
...
func (x *BindingDelta) Reset() {
	*x = BindingDelta{}
	mi := &file_api_v1alpha_iam_policy_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*BindingDelta) Descriptor() ([]byte, []int) {
	return file_api_v1alpha_iam_policy_proto_rawDescGZIP(), []int{5}
}
...
var File_api_v1alpha_iam_policy_proto protoreflect.FileDescriptor

const file_api_v1alpha_iam_policy_proto_rawDesc = "" +
	"\n" +
	"\x1capi/v1alpha/iam_policy.proto\x12\x14bytebase.api.v1alpha\x1a%google/api/expr/v1alpha1/syntax.proto\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\x1a\x16google/type/expr.proto\"R\n" +
	"\x13GetIamPolicyRequest\x12;\n" +
	"\bresource\x18\x01 \x01(\tB\x1f\xe2A\x01\x02\xfaA\x18\x12\x16bytebase.com/IAMPolicyR\bresource\"\xa5\x01\n" +
	"\x13SetIamPolicyRequest\x12;\n" +
	"\bresource\x18\x01 \x01(\tB\x1f\xe2A\x01\x02\xfaA\x18\x12\x16bytebase.com/IAMPolicyR\bresource\x12=\n" +
	"\x06policy\x18\x02 \x01(\v2\x1f.bytebase.api.v1alpha.IamPolicyB\x04\xe2A\x01\x02R\x06policy\x12\x12\n" +
	"\x04etag\x18\x03 \x01(\tR\x04etag\"Z\n" +
	"\tIamPolicy\x129\n" +
	"\bbindings\x18\x01 \x03(\v2\x1d.bytebase.api.v1alpha.BindingR\bbindings\x12\x12\n" +
	...
	"parsedExpr\"X\n" +
	"\vPolicyDelta\x12I\n" +
	"\x0ebinding_deltas\x18\x01 \x03(\v2\".bytebase.api.v1alpha.BindingDeltaR\rbindingDeltas\"\xe5\x01\n" +
	"\fBindingDelta\x12A\n" +
	"\x06action\x18\x01 \x01(\x0e2).bytebase.api.v1alpha.BindingDelta.ActionR\x06action\x12\x12\n" +
...
var (
	file_api_v1alpha_iam_policy_proto_rawDescOnce sync.Once
	file_api_v1alpha_iam_policy_proto_rawDescData []byte
)

func file_api_v1alpha_iam_policy_proto_rawDescGZIP() []byte {
	file_api_v1alpha_iam_policy_proto_rawDescOnce.Do(func() {
		file_api_v1alpha_iam_policy_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_api_v1alpha_iam_policy_proto_rawDesc), len(file_api_v1alpha_iam_policy_proto_rawDesc)))
	})
	return file_api_v1alpha_iam_policy_proto_rawDescData
}

var file_api_v1alpha_iam_policy_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_api_v1alpha_iam_policy_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_api_v1alpha_iam_policy_proto_goTypes = []any{
	(BindingDelta_Action)(0),    // 0: bytebase.api.v1alpha.BindingDelta.Action
	(*GetIamPolicyRequest)(nil), // 1: bytebase.api.v1alpha.GetIamPolicyRequest
	(*SetIamPolicyRequest)(nil), // 2: bytebase.api.v1alpha.SetIamPolicyRequest
	(*IamPolicy)(nil),           // 3: bytebase.api.v1alpha.IamPolicy
	(*Binding)(nil),             // 4: bytebase.api.v1alpha.Binding
	(*PolicyDelta)(nil),         // 5: bytebase.api.v1alpha.PolicyDelta
	(*BindingDelta)(nil),        // 6: bytebase.api.v1alpha.BindingDelta
	(*expr.Expr)(nil),           // 7: google.type.Expr
	(*v1alpha1.Expr)(nil),       // 8: google.api.expr.v1alpha1.Expr
}
var file_api_v1alpha_iam_policy_proto_depIdxs = []int32{
	3, // 0: bytebase.api.v1alpha.SetIamPolicyRequest.policy:type_name -> bytebase.api.v1alpha.IamPolicy
	4, // 1: bytebase.api.v1alpha.IamPolicy.bindings:type_name -> bytebase.api.v1alpha.Binding
	7, // 2: bytebase.api.v1alpha.Binding.condition:type_name -> google.type.Expr
	8, // 3: bytebase.api.v1alpha.Binding.parsed_expr:type_name -> google.api.expr.v1alpha1.Expr
	6, // 4: bytebase.api.v1alpha.PolicyDelta.binding_deltas:type_name -> bytebase.api.v1alpha.BindingDelta
	0, // 5: bytebase.api.v1alpha.BindingDelta.action:type_name -> bytebase.api.v1alpha.BindingDelta.Action
	7, // 6: bytebase.api.v1alpha.BindingDelta.condition:type_name -> google.type.Expr
...
func init() { file_api_v1alpha_iam_policy_proto_init() }
func file_api_v1alpha_iam_policy_proto_init() {
	if File_api_v1alpha_iam_policy_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_api_v1alpha_iam_policy_proto_rawDesc), len(file_api_v1alpha_iam_policy_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_api_v1alpha_iam_policy_proto_goTypes,
		DependencyIndexes: file_api_v1alpha_iam_policy_proto_depIdxs,
		EnumInfos:         file_api_v1alpha_iam_policy_proto_enumTypes,
		MessageInfos:      file_api_v1alpha_iam_policy_proto_msgTypes,
	}.Build()
	File_api_v1alpha_iam_policy_proto = out.File
	file_api_v1alpha_iam_policy_proto_goTypes = nil
	file_api_v1alpha_iam_policy_proto_depIdxs = nil
}
