...
// 	protoc        (unknown)
// source: api/v1alpha/common.proto
...
func (State) Descriptor() protoreflect.EnumDescriptor {
	return file_api_v1alpha_common_proto_enumTypes[0].Descriptor()
}

func (State) Type() protoreflect.EnumType {
	return &file_api_v1alpha_common_proto_enumTypes[0]
}
...
func (State) EnumDescriptor() ([]byte, []int) {
	return file_api_v1alpha_common_proto_rawDescGZIP(), []int{0}
}
...
func (Engine) Descriptor() protoreflect.EnumDescriptor {
	return file_api_v1alpha_common_proto_enumTypes[1].Descriptor()
}

func (Engine) Type() protoreflect.EnumType {
	return &file_api_v1alpha_common_proto_enumTypes[1]
}
...
func (Engine) EnumDescriptor() ([]byte, []int) {
	return file_api_v1alpha_common_proto_rawDescGZIP(), []int{1}
}
...
func (VCSType) Descriptor() protoreflect.EnumDescriptor {
	return file_api_v1alpha_common_proto_enumTypes[2].Descriptor()
}

func (VCSType) Type() protoreflect.EnumType {
	return &file_api_v1alpha_common_proto_enumTypes[2]
}
...
func (VCSType) EnumDescriptor() ([]byte, []int) {
	return file_api_v1alpha_common_proto_rawDescGZIP(), []int{2}
}
...
func (ExportFormat) Descriptor() protoreflect.EnumDescriptor {
	return file_api_v1alpha_common_proto_enumTypes[3].Descriptor()
}

func (ExportFormat) Type() protoreflect.EnumType {
	return &file_api_v1alpha_common_proto_enumTypes[3]
}
...
func (ExportFormat) EnumDescriptor() ([]byte, []int) {
	return file_api_v1alpha_common_proto_rawDescGZIP(), []int{3}
}
...
func (x *Position) Reset() {
	*x = Position{}
	mi := &file_api_v1alpha_common_proto_msgTypes[0]
...
func (x *Range) Reset() {
	*x = Range{}
	mi := &file_api_v1alpha_common_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
var File_api_v1alpha_common_proto protoreflect.FileDescriptor

const file_api_v1alpha_common_proto_rawDesc = "" +
	"\n" +
	"\x18api/v1alpha/common.proto\x12\x14bytebase.api.v1alpha\"6\n" +
	"\bPosition\x12\x12\n" +
...
var (
	file_api_v1alpha_common_proto_rawDescOnce sync.Once
	file_api_v1alpha_common_proto_rawDescData []byte
)

func file_api_v1alpha_common_proto_rawDescGZIP() []byte {
	file_api_v1alpha_common_proto_rawDescOnce.Do(func() {
		file_api_v1alpha_common_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_api_v1alpha_common_proto_rawDesc), len(file_api_v1alpha_common_proto_rawDesc)))
	})
	return file_api_v1alpha_common_proto_rawDescData
}

var file_api_v1alpha_common_proto_enumTypes = make([]protoimpl.EnumInfo, 4)
var file_api_v1alpha_common_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_api_v1alpha_common_proto_goTypes = []any{
	(State)(0),        // 0: bytebase.api.v1alpha.State
	(Engine)(0),       // 1: bytebase.api.v1alpha.Engine
	(VCSType)(0),      // 2: bytebase.api.v1alpha.VCSType
	(ExportFormat)(0), // 3: bytebase.api.v1alpha.ExportFormat
	(*Position)(nil),  // 4: bytebase.api.v1alpha.Position
	(*Range)(nil),     // 5: bytebase.api.v1alpha.Range
}
var file_api_v1alpha_common_proto_depIdxs = []int32{
...
func init() { file_api_v1alpha_common_proto_init() }
func file_api_v1alpha_common_proto_init() {
	if File_api_v1alpha_common_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_api_v1alpha_common_proto_rawDesc), len(file_api_v1alpha_common_proto_rawDesc)),
			NumEnums:      4,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_api_v1alpha_common_proto_goTypes,
		DependencyIndexes: file_api_v1alpha_common_proto_depIdxs,
		EnumInfos:         file_api_v1alpha_common_proto_enumTypes,
		MessageInfos:      file_api_v1alpha_common_proto_msgTypes,
	}.Build()
	File_api_v1alpha_common_proto = out.File
	file_api_v1alpha_common_proto_goTypes = nil
	file_api_v1alpha_common_proto_depIdxs = nil
}
