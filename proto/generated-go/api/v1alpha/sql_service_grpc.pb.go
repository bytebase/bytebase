...
const (
	SQLService_Query_FullMethodName                = "/bytebase.api.v1alpha.SQLService/Query"
	SQLService_AdminExecute_FullMethodName         = "/bytebase.api.v1alpha.SQLService/AdminExecute"
	SQLService_SearchQueryHistories_FullMethodName = "/bytebase.api.v1alpha.SQLService/SearchQueryHistories"
	SQLService_Export_FullMethodName               = "/bytebase.api.v1alpha.SQLService/Export"
	SQLService_Check_FullMethodName                = "/bytebase.api.v1alpha.SQLService/Check"
	SQLService_ParseMyBatisMapper_FullMethodName   = "/bytebase.api.v1alpha.SQLService/ParseMyBatisMapper"
	SQLService_Pretty_FullMethodName               = "/bytebase.api.v1alpha.SQLService/Pretty"
	SQLService_DiffMetadata_FullMethodName         = "/bytebase.api.v1alpha.SQLService/DiffMetadata"
	SQLService_AICompletion_FullMethodName         = "/bytebase.api.v1alpha.SQLService/AICompletion"
)
...
var SQLService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "bytebase.api.v1alpha.SQLService",
	...
	Metadata: "api/v1alpha/sql_service.proto",
}
