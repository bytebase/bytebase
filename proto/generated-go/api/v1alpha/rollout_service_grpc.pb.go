...
const (
	RolloutService_GetRollout_FullMethodName             = "/bytebase.api.v1alpha.RolloutService/GetRollout"
	RolloutService_ListRollouts_FullMethodName           = "/bytebase.api.v1alpha.RolloutService/ListRollouts"
	RolloutService_CreateRollout_FullMethodName          = "/bytebase.api.v1alpha.RolloutService/CreateRollout"
	RolloutService_PreviewRollout_FullMethodName         = "/bytebase.api.v1alpha.RolloutService/PreviewRollout"
	RolloutService_ListTaskRuns_FullMethodName           = "/bytebase.api.v1alpha.RolloutService/ListTaskRuns"
	RolloutService_GetTaskRun_FullMethodName             = "/bytebase.api.v1alpha.RolloutService/GetTaskRun"
	RolloutService_GetTaskRunLog_FullMethodName          = "/bytebase.api.v1alpha.RolloutService/GetTaskRunLog"
	RolloutService_GetTaskRunSession_FullMethodName      = "/bytebase.api.v1alpha.RolloutService/GetTaskRunSession"
	RolloutService_BatchRunTasks_FullMethodName          = "/bytebase.api.v1alpha.RolloutService/BatchRunTasks"
	RolloutService_BatchSkipTasks_FullMethodName         = "/bytebase.api.v1alpha.RolloutService/BatchSkipTasks"
	RolloutService_BatchCancelTaskRuns_FullMethodName    = "/bytebase.api.v1alpha.RolloutService/BatchCancelTaskRuns"
	RolloutService_PreviewTaskRunRollback_FullMethodName = "/bytebase.api.v1alpha.RolloutService/PreviewTaskRunRollback"
)
...
var RolloutService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "bytebase.api.v1alpha.RolloutService",
	...
	Metadata: "api/v1alpha/rollout_service.proto",
}
