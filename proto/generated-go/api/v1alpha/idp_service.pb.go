...
func (IdentityProviderType) Descriptor() protoreflect.EnumDescriptor {
	return file_api_v1alpha_idp_service_proto_enumTypes[0].Descriptor()
}

func (IdentityProviderType) Type() protoreflect.EnumType {
	return &file_api_v1alpha_idp_service_proto_enumTypes[0]
}
...
func (IdentityProviderType) EnumDescriptor() ([]byte, []int) {
	return file_api_v1alpha_idp_service_proto_rawDescGZIP(), []int{0}
}
...
func (OAuth2AuthStyle) Descriptor() protoreflect.EnumDescriptor {
	return file_api_v1alpha_idp_service_proto_enumTypes[1].Descriptor()
}

func (OAuth2AuthStyle) Type() protoreflect.EnumType {
	return &file_api_v1alpha_idp_service_proto_enumTypes[1]
}
...
func (OAuth2AuthStyle) EnumDescriptor() ([]byte, []int) {
	return file_api_v1alpha_idp_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *GetIdentityProviderRequest) Reset() {
	*x = GetIdentityProviderRequest{}
	mi := &file_api_v1alpha_idp_service_proto_msgTypes[0]
...
func (x *ListIdentityProvidersRequest) Reset() {
	*x = ListIdentityProvidersRequest{}
	mi := &file_api_v1alpha_idp_service_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *ListIdentityProvidersResponse) Reset() {
	*x = ListIdentityProvidersResponse{}
	mi := &file_api_v1alpha_idp_service_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ListIdentityProvidersResponse) Descriptor() ([]byte, []int) {
	return file_api_v1alpha_idp_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *CreateIdentityProviderRequest) Reset() {
	*x = CreateIdentityProviderRequest{}
	mi := &file_api_v1alpha_idp_service_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CreateIdentityProviderRequest) Descriptor() ([]byte, []int) {
	return file_api_v1alpha_idp_service_proto_rawDescGZIP(), []int{3}
}
...
func (x *UpdateIdentityProviderRequest) Reset() {
	*x = UpdateIdentityProviderRequest{}
	mi := &file_api_v1alpha_idp_service_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*UpdateIdentityProviderRequest) Descriptor() ([]byte, []int) {
	return file_api_v1alpha_idp_service_proto_rawDescGZIP(), []int{4}
}
...
func (x *DeleteIdentityProviderRequest) Reset() {
	*x = DeleteIdentityProviderRequest{}
	mi := &file_api_v1alpha_idp_service_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*DeleteIdentityProviderRequest) Descriptor() ([]byte, []int) {
	return file_api_v1alpha_idp_service_proto_rawDescGZIP(), []int{5}
}
...
func (x *TestIdentityProviderRequest) Reset() {
	*x = TestIdentityProviderRequest{}
	mi := &file_api_v1alpha_idp_service_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*TestIdentityProviderRequest) Descriptor() ([]byte, []int) {
	return file_api_v1alpha_idp_service_proto_rawDescGZIP(), []int{6}
}
...
func (x *OAuth2IdentityProviderTestRequestContext) Reset() {
	*x = OAuth2IdentityProviderTestRequestContext{}
	mi := &file_api_v1alpha_idp_service_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*OAuth2IdentityProviderTestRequestContext) Descriptor() ([]byte, []int) {
	return file_api_v1alpha_idp_service_proto_rawDescGZIP(), []int{7}
}
...
func (x *TestIdentityProviderResponse) Reset() {
	*x = TestIdentityProviderResponse{}
	mi := &file_api_v1alpha_idp_service_proto_msgTypes[8]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*TestIdentityProviderResponse) Descriptor() ([]byte, []int) {
	return file_api_v1alpha_idp_service_proto_rawDescGZIP(), []int{8}
}
...
type IdentityProvider struct {
	...
	Type          IdentityProviderType    `protobuf:"varint,6,opt,name=type,proto3,enum=bytebase.api.v1alpha.IdentityProviderType" json:"type,omitempty"`
...
func (x *IdentityProvider) Reset() {
	*x = IdentityProvider{}
	mi := &file_api_v1alpha_idp_service_proto_msgTypes[9]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*IdentityProvider) Descriptor() ([]byte, []int) {
	return file_api_v1alpha_idp_service_proto_rawDescGZIP(), []int{9}
}
...
func (x *IdentityProviderConfig) Reset() {
	*x = IdentityProviderConfig{}
	mi := &file_api_v1alpha_idp_service_proto_msgTypes[10]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*IdentityProviderConfig) Descriptor() ([]byte, []int) {
	return file_api_v1alpha_idp_service_proto_rawDescGZIP(), []int{10}
}
...
type OAuth2IdentityProviderConfig struct {
	...
	AuthStyle     OAuth2AuthStyle        `protobuf:"varint,9,opt,name=auth_style,json=authStyle,proto3,enum=bytebase.api.v1alpha.OAuth2AuthStyle" json:"auth_style,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *OAuth2IdentityProviderConfig) Reset() {
	*x = OAuth2IdentityProviderConfig{}
	mi := &file_api_v1alpha_idp_service_proto_msgTypes[11]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*OAuth2IdentityProviderConfig) Descriptor() ([]byte, []int) {
	return file_api_v1alpha_idp_service_proto_rawDescGZIP(), []int{11}
}
...
type OIDCIdentityProviderConfig struct {
	...
	AuthStyle     OAuth2AuthStyle `protobuf:"varint,7,opt,name=auth_style,json=authStyle,proto3,enum=bytebase.api.v1alpha.OAuth2AuthStyle" json:"auth_style,omitempty"`
...
func (x *OIDCIdentityProviderConfig) Reset() {
	*x = OIDCIdentityProviderConfig{}
	mi := &file_api_v1alpha_idp_service_proto_msgTypes[12]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*OIDCIdentityProviderConfig) Descriptor() ([]byte, []int) {
	return file_api_v1alpha_idp_service_proto_rawDescGZIP(), []int{12}
}
...
func (x *LDAPIdentityProviderConfig) Reset() {
	*x = LDAPIdentityProviderConfig{}
	mi := &file_api_v1alpha_idp_service_proto_msgTypes[13]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*LDAPIdentityProviderConfig) Descriptor() ([]byte, []int) {
	return file_api_v1alpha_idp_service_proto_rawDescGZIP(), []int{13}
}
...
func (x *FieldMapping) Reset() {
	*x = FieldMapping{}
	mi := &file_api_v1alpha_idp_service_proto_msgTypes[14]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*FieldMapping) Descriptor() ([]byte, []int) {
	return file_api_v1alpha_idp_service_proto_rawDescGZIP(), []int{14}
}
...
var File_api_v1alpha_idp_service_proto protoreflect.FileDescriptor

const file_api_v1alpha_idp_service_proto_rawDesc = "" +
	"\n" +
	"\x1dapi/v1alpha/idp_service.proto\x12\x14bytebase.api.v1alpha\x1a\x1cgoogle/api/annotations.proto\x1a\x17google/api/client.proto\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\x1a\x1bgoogle/protobuf/empty.proto\x1a google/protobuf/field_mask.proto\x1a\x1capi/v1alpha/annotation.proto\"K\n" +
	...
	"\x1dListIdentityProvidersResponse\x12U\n" +
	"\x12identity_providers\x18\x01 \x03(\v2&.bytebase.api.v1alpha.IdentityProviderR\x11identityProviders\x12&\n" +
	"\x0fnext_page_token\x18\x02 \x01(\tR\rnextPageToken\"\xd1\x01\n" +
	"\x1dCreateIdentityProviderRequest\x12Y\n" +
	"\x11identity_provider\x18\x01 \x01(\v2&.bytebase.api.v1alpha.IdentityProviderB\x04\xe2A\x01\x02R\x10identityProvider\x120\n" +
	"\x14identity_provider_id\x18\x02 \x01(\tR\x12identityProviderId\x12#\n" +
	"\rvalidate_only\x18\x03 \x01(\bR\fvalidateOnly\"\xb7\x01\n" +
	"\x1dUpdateIdentityProviderRequest\x12Y\n" +
	"\x11identity_provider\x18\x01 \x01(\v2&.bytebase.api.v1alpha.IdentityProviderB\x04\xe2A\x01\x02R\x10identityProvider\x12;\n" +
	"\vupdate_mask\x18\x02 \x01(\v2\x1a.google.protobuf.FieldMaskR\n" +
	"updateMask\"N\n" +
	"\x1dDeleteIdentityProviderRequest\x12-\n" +
	"\x04name\x18\x01 \x01(\tB\x19\xe2A\x01\x02\xfaA\x12\n" +
	"\x10bytebase.com/IdPR\x04name\"\xe6\x01\n" +
	"\x1bTestIdentityProviderRequest\x12S\n" +
	"\x11identity_provider\x18\x01 \x01(\v2&.bytebase.api.v1alpha.IdentityProviderR\x10identityProvider\x12g\n" +
	"\x0eoauth2_context\x18\x02 \x01(\v2>.bytebase.api.v1alpha.OAuth2IdentityProviderTestRequestContextH\x00R\roauth2ContextB\t\n" +
	"\acontext\">\n" +
	"(OAuth2IdentityProviderTestRequestContext\x12\x12\n" +
	"\x04code\x18\x01 \x01(\tR\x04code\"\x1e\n" +
	"\x1cTestIdentityProviderResponse\"\x83\x02\n" +
	"\x10IdentityProvider\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x14\n" +
	"\x05title\x18\x04 \x01(\tR\x05title\x12\x16\n" +
	"\x06domain\x18\x05 \x01(\tR\x06domain\x12>\n" +
	"\x04type\x18\x06 \x01(\x0e2*.bytebase.api.v1alpha.IdentityProviderTypeR\x04type\x12D\n" +
	"\x06config\x18\a \x01(\v2,.bytebase.api.v1alpha.IdentityProviderConfigR\x06config:!\xeaA\x1e\n" +
	"\x10bytebase.com/IdP\x12\n" +
	"idps/{idp}J\x04\b\x02\x10\x03\"\xa7\x02\n" +
	"\x16IdentityProviderConfig\x12Y\n" +
	"\roauth2_config\x18\x01 \x01(\v22.bytebase.api.v1alpha.OAuth2IdentityProviderConfigH\x00R\foauth2Config\x12S\n" +
	"\voidc_config\x18\x02 \x01(\v20.bytebase.api.v1alpha.OIDCIdentityProviderConfigH\x00R\n" +
	"oidcConfig\x12S\n" +
	"\vldap_config\x18\x03 \x01(\v20.bytebase.api.v1alpha.LDAPIdentityProviderConfigH\x00R\n" +
	"ldapConfigB\b\n" +
	"\x06config\"\x8b\x03\n" +
	...
	"\rfield_mapping\x18\a \x01(\v2\".bytebase.api.v1alpha.FieldMappingR\ffieldMapping\x12&\n" +
	"\x0fskip_tls_verify\x18\b \x01(\bR\rskipTlsVerify\x12D\n" +
	"\n" +
	"auth_style\x18\t \x01(\x0e2%.bytebase.api.v1alpha.OAuth2AuthStyleR\tauthStyle\"\xf0\x02\n" +
	...
	"\rfield_mapping\x18\x05 \x01(\v2\".bytebase.api.v1alpha.FieldMappingR\ffieldMapping\x12&\n" +
	"\x0fskip_tls_verify\x18\x06 \x01(\bR\rskipTlsVerify\x12D\n" +
	"\n" +
	"auth_style\x18\a \x01(\x0e2%.bytebase.api.v1alpha.OAuth2AuthStyleR\tauthStyle\x12)\n" +
	"\rauth_endpoint\x18\b \x01(\tB\x04\xe2A\x01\x03R\fauthEndpoint\"\xda\x02\n" +
	...
	"userFilter\x12+\n" +
	"\x11security_protocol\x18\b \x01(\tR\x10securityProtocol\x12G\n" +
	"\rfield_mapping\x18\t \x01(\v2\".bytebase.api.v1alpha.FieldMappingR\ffieldMapping\"\x85\x01\n" +
	...
	"\tIN_HEADER\x10\x022\xa0\t\n" +
	"\x17IdentityProviderService\x12\xb1\x01\n" +
	"\x13GetIdentityProvider\x120.bytebase.api.v1alpha.GetIdentityProviderRequest\x1a&.bytebase.api.v1alpha.IdentityProvider\"@\xdaA\x04name\x8a\xea0\x18bb.identityProviders.get\x90\xea0\x01\x82\xd3\xe4\x93\x02\x13\x12\x11/v1/{name=idps/*}\x12\x99\x01\n" +
	"\x15ListIdentityProviders\x122.bytebase.api.v1alpha.ListIdentityProvidersRequest\x1a3.bytebase.api.v1alpha.ListIdentityProvidersResponse\"\x17\xdaA\x00\x80\xea0\x01\x82\xd3\xe4\x93\x02\n" +
	"\x12\b/v1/idps\x12\xc4\x01\n" +
	"\x16CreateIdentityProvider\x123.bytebase.api.v1alpha.CreateIdentityProviderRequest\x1a&.bytebase.api.v1alpha.IdentityProvider\"M\xdaA\x00\x8a\xea0\x1bbb.identityProviders.create\x90\xea0\x01\x98\xea0\x01\x82\xd3\xe4\x93\x02\x1d:\x11identity_provider\"\b/v1/idps\x12\xfd\x01\n" +
	"\x16UpdateIdentityProvider\x123.bytebase.api.v1alpha.UpdateIdentityProviderRequest\x1a&.bytebase.api.v1alpha.IdentityProvider\"\x85\x01\xdaA\x1didentity_provider,update_mask\x8a\xea0\x1bbb.identityProviders.update\x90\xea0\x01\x98\xea0\x01\x82\xd3\xe4\x93\x028:\x11identity_provider2#/v1/{identity_provider.name=idps/*}\x12\xae\x01\n" +
	"\x16DeleteIdentityProvider\x123.bytebase.api.v1alpha.DeleteIdentityProviderRequest\x1a\x16.google.protobuf.Empty\"G\xdaA\x04name\x8a\xea0\x1bbb.identityProviders.delete\x90\xea0\x01\x98\xea0\x01\x82\xd3\xe4\x93\x02\x13*\x11/v1/{name=idps/*}\x12\xbc\x01\n" +
	"\x14TestIdentityProvider\x121.bytebase.api.v1alpha.TestIdentityProviderRequest\x1a2.bytebase.api.v1alpha.TestIdentityProviderResponse\"=\x8a\xea0\x1bbb.identityProviders.update\x90\xea0\x01\x82\xd3\xe4\x93\x02\x14:\x01*\"\x0f/v1/idps/*:testB\x11Z\x0fgenerated-go/v1b\x06proto3"

var (
	file_api_v1alpha_idp_service_proto_rawDescOnce sync.Once
	file_api_v1alpha_idp_service_proto_rawDescData []byte
)

func file_api_v1alpha_idp_service_proto_rawDescGZIP() []byte {
	file_api_v1alpha_idp_service_proto_rawDescOnce.Do(func() {
		file_api_v1alpha_idp_service_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_api_v1alpha_idp_service_proto_rawDesc), len(file_api_v1alpha_idp_service_proto_rawDesc)))
	})
	return file_api_v1alpha_idp_service_proto_rawDescData
}

var file_api_v1alpha_idp_service_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
var file_api_v1alpha_idp_service_proto_msgTypes = make([]protoimpl.MessageInfo, 15)
var file_api_v1alpha_idp_service_proto_goTypes = []any{
	(IdentityProviderType)(0),                        // 0: bytebase.api.v1alpha.IdentityProviderType
	(OAuth2AuthStyle)(0),                             // 1: bytebase.api.v1alpha.OAuth2AuthStyle
	(*GetIdentityProviderRequest)(nil),               // 2: bytebase.api.v1alpha.GetIdentityProviderRequest
	(*ListIdentityProvidersRequest)(nil),             // 3: bytebase.api.v1alpha.ListIdentityProvidersRequest
	(*ListIdentityProvidersResponse)(nil),            // 4: bytebase.api.v1alpha.ListIdentityProvidersResponse
	(*CreateIdentityProviderRequest)(nil),            // 5: bytebase.api.v1alpha.CreateIdentityProviderRequest
	(*UpdateIdentityProviderRequest)(nil),            // 6: bytebase.api.v1alpha.UpdateIdentityProviderRequest
	(*DeleteIdentityProviderRequest)(nil),            // 7: bytebase.api.v1alpha.DeleteIdentityProviderRequest
	(*TestIdentityProviderRequest)(nil),              // 8: bytebase.api.v1alpha.TestIdentityProviderRequest
	(*OAuth2IdentityProviderTestRequestContext)(nil), // 9: bytebase.api.v1alpha.OAuth2IdentityProviderTestRequestContext
	(*TestIdentityProviderResponse)(nil),             // 10: bytebase.api.v1alpha.TestIdentityProviderResponse
	(*IdentityProvider)(nil),                         // 11: bytebase.api.v1alpha.IdentityProvider
	(*IdentityProviderConfig)(nil),                   // 12: bytebase.api.v1alpha.IdentityProviderConfig
	(*OAuth2IdentityProviderConfig)(nil),             // 13: bytebase.api.v1alpha.OAuth2IdentityProviderConfig
	(*OIDCIdentityProviderConfig)(nil),               // 14: bytebase.api.v1alpha.OIDCIdentityProviderConfig
	(*LDAPIdentityProviderConfig)(nil),               // 15: bytebase.api.v1alpha.LDAPIdentityProviderConfig
	(*FieldMapping)(nil),                             // 16: bytebase.api.v1alpha.FieldMapping
	(*fieldmaskpb.FieldMask)(nil),                    // 17: google.protobuf.FieldMask
	(*emptypb.Empty)(nil),                            // 18: google.protobuf.Empty
}
var file_api_v1alpha_idp_service_proto_depIdxs = []int32{
	11, // 0: bytebase.api.v1alpha.ListIdentityProvidersResponse.identity_providers:type_name -> bytebase.api.v1alpha.IdentityProvider
	11, // 1: bytebase.api.v1alpha.CreateIdentityProviderRequest.identity_provider:type_name -> bytebase.api.v1alpha.IdentityProvider
	11, // 2: bytebase.api.v1alpha.UpdateIdentityProviderRequest.identity_provider:type_name -> bytebase.api.v1alpha.IdentityProvider
	17, // 3: bytebase.api.v1alpha.UpdateIdentityProviderRequest.update_mask:type_name -> google.protobuf.FieldMask
	11, // 4: bytebase.api.v1alpha.TestIdentityProviderRequest.identity_provider:type_name -> bytebase.api.v1alpha.IdentityProvider
	9,  // 5: bytebase.api.v1alpha.TestIdentityProviderRequest.oauth2_context:type_name -> bytebase.api.v1alpha.OAuth2IdentityProviderTestRequestContext
	0,  // 6: bytebase.api.v1alpha.IdentityProvider.type:type_name -> bytebase.api.v1alpha.IdentityProviderType
	12, // 7: bytebase.api.v1alpha.IdentityProvider.config:type_name -> bytebase.api.v1alpha.IdentityProviderConfig
	13, // 8: bytebase.api.v1alpha.IdentityProviderConfig.oauth2_config:type_name -> bytebase.api.v1alpha.OAuth2IdentityProviderConfig
	14, // 9: bytebase.api.v1alpha.IdentityProviderConfig.oidc_config:type_name -> bytebase.api.v1alpha.OIDCIdentityProviderConfig
	15, // 10: bytebase.api.v1alpha.IdentityProviderConfig.ldap_config:type_name -> bytebase.api.v1alpha.LDAPIdentityProviderConfig
	16, // 11: bytebase.api.v1alpha.OAuth2IdentityProviderConfig.field_mapping:type_name -> bytebase.api.v1alpha.FieldMapping
	1,  // 12: bytebase.api.v1alpha.OAuth2IdentityProviderConfig.auth_style:type_name -> bytebase.api.v1alpha.OAuth2AuthStyle
	16, // 13: bytebase.api.v1alpha.OIDCIdentityProviderConfig.field_mapping:type_name -> bytebase.api.v1alpha.FieldMapping
	1,  // 14: bytebase.api.v1alpha.OIDCIdentityProviderConfig.auth_style:type_name -> bytebase.api.v1alpha.OAuth2AuthStyle
	16, // 15: bytebase.api.v1alpha.LDAPIdentityProviderConfig.field_mapping:type_name -> bytebase.api.v1alpha.FieldMapping
	2,  // 16: bytebase.api.v1alpha.IdentityProviderService.GetIdentityProvider:input_type -> bytebase.api.v1alpha.GetIdentityProviderRequest
	3,  // 17: bytebase.api.v1alpha.IdentityProviderService.ListIdentityProviders:input_type -> bytebase.api.v1alpha.ListIdentityProvidersRequest
	5,  // 18: bytebase.api.v1alpha.IdentityProviderService.CreateIdentityProvider:input_type -> bytebase.api.v1alpha.CreateIdentityProviderRequest
	6,  // 19: bytebase.api.v1alpha.IdentityProviderService.UpdateIdentityProvider:input_type -> bytebase.api.v1alpha.UpdateIdentityProviderRequest
	7,  // 20: bytebase.api.v1alpha.IdentityProviderService.DeleteIdentityProvider:input_type -> bytebase.api.v1alpha.DeleteIdentityProviderRequest
	8,  // 21: bytebase.api.v1alpha.IdentityProviderService.TestIdentityProvider:input_type -> bytebase.api.v1alpha.TestIdentityProviderRequest
	11, // 22: bytebase.api.v1alpha.IdentityProviderService.GetIdentityProvider:output_type -> bytebase.api.v1alpha.IdentityProvider
	4,  // 23: bytebase.api.v1alpha.IdentityProviderService.ListIdentityProviders:output_type -> bytebase.api.v1alpha.ListIdentityProvidersResponse
	11, // 24: bytebase.api.v1alpha.IdentityProviderService.CreateIdentityProvider:output_type -> bytebase.api.v1alpha.IdentityProvider
	11, // 25: bytebase.api.v1alpha.IdentityProviderService.UpdateIdentityProvider:output_type -> bytebase.api.v1alpha.IdentityProvider
	18, // 26: bytebase.api.v1alpha.IdentityProviderService.DeleteIdentityProvider:output_type -> google.protobuf.Empty
	10, // 27: bytebase.api.v1alpha.IdentityProviderService.TestIdentityProvider:output_type -> bytebase.api.v1alpha.TestIdentityProviderResponse
...
func init() { file_api_v1alpha_idp_service_proto_init() }
func file_api_v1alpha_idp_service_proto_init() {
	if File_api_v1alpha_idp_service_proto != nil {
		return
	}
	file_api_v1alpha_annotation_proto_init()
	file_api_v1alpha_idp_service_proto_msgTypes[6].OneofWrappers = []any{
		(*TestIdentityProviderRequest_Oauth2Context)(nil),
	}
	file_api_v1alpha_idp_service_proto_msgTypes[10].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_api_v1alpha_idp_service_proto_rawDesc), len(file_api_v1alpha_idp_service_proto_rawDesc)),
			NumEnums:      2,
			NumMessages:   15,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_api_v1alpha_idp_service_proto_goTypes,
		DependencyIndexes: file_api_v1alpha_idp_service_proto_depIdxs,
		EnumInfos:         file_api_v1alpha_idp_service_proto_enumTypes,
		MessageInfos:      file_api_v1alpha_idp_service_proto_msgTypes,
	}.Build()
	File_api_v1alpha_idp_service_proto = out.File
	file_api_v1alpha_idp_service_proto_goTypes = nil
	file_api_v1alpha_idp_service_proto_depIdxs = nil
}
