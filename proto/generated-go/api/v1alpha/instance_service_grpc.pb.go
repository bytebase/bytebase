...
const (
	InstanceService_GetInstance_FullMethodName          = "/bytebase.api.v1alpha.InstanceService/GetInstance"
	InstanceService_ListInstances_FullMethodName        = "/bytebase.api.v1alpha.InstanceService/ListInstances"
	InstanceService_CreateInstance_FullMethodName       = "/bytebase.api.v1alpha.InstanceService/CreateInstance"
	InstanceService_UpdateInstance_FullMethodName       = "/bytebase.api.v1alpha.InstanceService/UpdateInstance"
	InstanceService_DeleteInstance_FullMethodName       = "/bytebase.api.v1alpha.InstanceService/DeleteInstance"
	InstanceService_UndeleteInstance_FullMethodName     = "/bytebase.api.v1alpha.InstanceService/UndeleteInstance"
	InstanceService_SyncInstance_FullMethodName         = "/bytebase.api.v1alpha.InstanceService/SyncInstance"
	InstanceService_ListInstanceDatabase_FullMethodName = "/bytebase.api.v1alpha.InstanceService/ListInstanceDatabase"
	InstanceService_BatchSyncInstances_FullMethodName   = "/bytebase.api.v1alpha.InstanceService/BatchSyncInstances"
	InstanceService_AddDataSource_FullMethodName        = "/bytebase.api.v1alpha.InstanceService/AddDataSource"
	InstanceService_RemoveDataSource_FullMethodName     = "/bytebase.api.v1alpha.InstanceService/RemoveDataSource"
	InstanceService_UpdateDataSource_FullMethodName     = "/bytebase.api.v1alpha.InstanceService/UpdateDataSource"
)
...
var InstanceService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "bytebase.api.v1alpha.InstanceService",
	...
	Metadata: "api/v1alpha/instance_service.proto",
}
