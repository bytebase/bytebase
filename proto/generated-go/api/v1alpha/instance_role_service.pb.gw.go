...
func RegisterInstanceRoleServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server InstanceRoleServiceServer) error {
	mux.Handle(http.MethodGet, pattern_InstanceRoleService_GetInstanceRole_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/bytebase.api.v1alpha.InstanceRoleService/GetInstanceRole", runtime.WithHTTPPathPattern("/v1/{name=instances/*/roles/*}"))
		if err != nil {
	...
	mux.Handle(http.MethodGet, pattern_InstanceRoleService_ListInstanceRoles_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		annotatedContext, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/bytebase.api.v1alpha.InstanceRoleService/ListInstanceRoles", runtime.WithHTTPPathPattern("/v1/{parent=instances/*}/roles"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
func RegisterInstanceRoleServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client InstanceRoleServiceClient) error {
	mux.Handle(http.MethodGet, pattern_InstanceRoleService_GetInstanceRole_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		annotatedContext, err := runtime.AnnotateContext(ctx, mux, req, "/bytebase.api.v1alpha.InstanceRoleService/GetInstanceRole", runtime.WithHTTPPathPattern("/v1/{name=instances/*/roles/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle(http.MethodGet, pattern_InstanceRoleService_ListInstanceRoles_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		annotatedContext, err := runtime.AnnotateContext(ctx, mux, req, "/bytebase.api.v1alpha.InstanceRoleService/ListInstanceRoles", runtime.WithHTTPPathPattern("/v1/{parent=instances/*}/roles"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
