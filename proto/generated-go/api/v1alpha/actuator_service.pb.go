...
// 	protoc        (unknown)
// source: api/v1alpha/actuator_service.proto
...
func (x *GetResourcePackageRequest) Reset() {
	*x = GetResourcePackageRequest{}
	mi := &file_api_v1alpha_actuator_service_proto_msgTypes[0]
...
func (*GetResourcePackageRequest) Descriptor() ([]byte, []int) {
	return file_api_v1alpha_actuator_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *ResourcePackage) Reset() {
	*x = ResourcePackage{}
	mi := &file_api_v1alpha_actuator_service_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ResourcePackage) Descriptor() ([]byte, []int) {
	return file_api_v1alpha_actuator_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *GetActuatorInfoRequest) Reset() {
	*x = GetActuatorInfoRequest{}
	mi := &file_api_v1alpha_actuator_service_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GetActuatorInfoRequest) Descriptor() ([]byte, []int) {
	return file_api_v1alpha_actuator_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *UpdateActuatorInfoRequest) Reset() {
	*x = UpdateActuatorInfoRequest{}
	mi := &file_api_v1alpha_actuator_service_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*UpdateActuatorInfoRequest) Descriptor() ([]byte, []int) {
	return file_api_v1alpha_actuator_service_proto_rawDescGZIP(), []int{3}
}
...
func (x *DeleteCacheRequest) Reset() {
	*x = DeleteCacheRequest{}
	mi := &file_api_v1alpha_actuator_service_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*DeleteCacheRequest) Descriptor() ([]byte, []int) {
	return file_api_v1alpha_actuator_service_proto_rawDescGZIP(), []int{4}
}
...
func (x *ActuatorInfo) Reset() {
	*x = ActuatorInfo{}
	mi := &file_api_v1alpha_actuator_service_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ActuatorInfo) Descriptor() ([]byte, []int) {
	return file_api_v1alpha_actuator_service_proto_rawDescGZIP(), []int{5}
}
...
type ActuatorInfo_StatUser struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	UserType      UserType               `protobuf:"varint,1,opt,name=user_type,json=userType,proto3,enum=bytebase.api.v1alpha.UserType" json:"user_type,omitempty"`
	State         State                  `protobuf:"varint,2,opt,name=state,proto3,enum=bytebase.api.v1alpha.State" json:"state,omitempty"`
...
func (x *ActuatorInfo_StatUser) Reset() {
	*x = ActuatorInfo_StatUser{}
	mi := &file_api_v1alpha_actuator_service_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ActuatorInfo_StatUser) Descriptor() ([]byte, []int) {
	return file_api_v1alpha_actuator_service_proto_rawDescGZIP(), []int{5, 0}
}
...
var File_api_v1alpha_actuator_service_proto protoreflect.FileDescriptor

const file_api_v1alpha_actuator_service_proto_rawDesc = "" +
	"\n" +
	"\"api/v1alpha/actuator_service.proto\x12\x14bytebase.api.v1alpha\x1a\x1cgoogle/api/annotations.proto\x1a\x17google/api/client.proto\x1a\x1fgoogle/api/field_behavior.proto\x1a\x1bgoogle/protobuf/empty.proto\x1a google/protobuf/field_mask.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1capi/v1alpha/annotation.proto\x1a\x18api/v1alpha/common.proto\x1a!api/v1alpha/setting_service.proto\x1a\x1eapi/v1alpha/user_service.proto\"\x1b\n" +
	"\x19GetResourcePackageRequest\"%\n" +
	"\x0fResourcePackage\x12\x12\n" +
	"\x04logo\x18\x01 \x01(\fR\x04logo\"\x18\n" +
	"\x16GetActuatorInfoRequest\"\xa4\x01\n" +
	"\x19UpdateActuatorInfoRequest\x12D\n" +
	"\bactuator\x18\x01 \x01(\v2\".bytebase.api.v1alpha.ActuatorInfoB\x04\xe2A\x01\x02R\bactuator\x12A\n" +
	"\vupdate_mask\x18\x02 \x01(\v2\x1a.google.protobuf.FieldMaskB\x04\xe2A\x01\x02R\n" +
	"updateMask\"\x14\n" +
	"\x12DeleteCacheRequest\"\xca\b\n" +
	...
	"\x18disallow_password_signin\x18\x14 \x01(\bR\x16disallowPasswordSignin\x12c\n" +
	"\x14password_restriction\x18\x15 \x01(\v20.bytebase.api.v1alpha.PasswordRestrictionSettingR\x13passwordRestriction\x12\x16\n" +
	"\x06docker\x18\x16 \x01(\bR\x06docker\x12J\n" +
	"\n" +
	"user_stats\x18\x17 \x03(\v2+.bytebase.api.v1alpha.ActuatorInfo.StatUserR\tuserStats\x128\n" +
	"\x18activated_instance_count\x18\x18 \x01(\x05R\x16activatedInstanceCount\x120\n" +
	"\x14total_instance_count\x18\x19 \x01(\x05R\x12totalInstanceCount\x1a\x90\x01\n" +
	"\bStatUser\x12;\n" +
	"\tuser_type\x18\x01 \x01(\x0e2\x1e.bytebase.api.v1alpha.UserTypeR\buserType\x121\n" +
	"\x05state\x18\x02 \x01(\x0e2\x1b.bytebase.api.v1alpha.StateR\x05state\x12\x14\n" +
	"\x05count\x18\x03 \x01(\x05R\x05count2\xdf\x04\n" +
	"\x0fActuatorService\x12\x85\x01\n" +
	"\x0fGetActuatorInfo\x12,.bytebase.api.v1alpha.GetActuatorInfoRequest\x1a\".bytebase.api.v1alpha.ActuatorInfo\" \xdaA\x00\x80\xea0\x01\x82\xd3\xe4\x93\x02\x13\x12\x11/v1/actuator/info\x12\xbc\x01\n" +
	"\x12UpdateActuatorInfo\x12/.bytebase.api.v1alpha.UpdateActuatorInfoRequest\x1a\".bytebase.api.v1alpha.ActuatorInfo\"Q\xdaA\x14actuator,update_mask\x8a\xea0\x0fbb.settings.set\x90\xea0\x01\x82\xd3\xe4\x93\x02\x1d:\bactuator2\x11/v1/actuator/info\x12o\n" +
	"\vDeleteCache\x12(.bytebase.api.v1alpha.DeleteCacheRequest\x1a\x16.google.protobuf.Empty\"\x1e\x80\xea0\x01\x82\xd3\xe4\x93\x02\x14*\x12/v1/actuator/cache\x12\x93\x01\n" +
	"\x12GetResourcePackage\x12/.bytebase.api.v1alpha.GetResourcePackageRequest\x1a%.bytebase.api.v1alpha.ResourcePackage\"%\xdaA\x00\x80\xea0\x01\x82\xd3\xe4\x93\x02\x18\x12\x16/v1/actuator/resourcesB\x11Z\x0fgenerated-go/v1b\x06proto3"

var (
	file_api_v1alpha_actuator_service_proto_rawDescOnce sync.Once
	file_api_v1alpha_actuator_service_proto_rawDescData []byte
)

func file_api_v1alpha_actuator_service_proto_rawDescGZIP() []byte {
	file_api_v1alpha_actuator_service_proto_rawDescOnce.Do(func() {
		file_api_v1alpha_actuator_service_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_api_v1alpha_actuator_service_proto_rawDesc), len(file_api_v1alpha_actuator_service_proto_rawDesc)))
	})
	return file_api_v1alpha_actuator_service_proto_rawDescData
}

var file_api_v1alpha_actuator_service_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_api_v1alpha_actuator_service_proto_goTypes = []any{
	(*GetResourcePackageRequest)(nil),  // 0: bytebase.api.v1alpha.GetResourcePackageRequest
	(*ResourcePackage)(nil),            // 1: bytebase.api.v1alpha.ResourcePackage
	(*GetActuatorInfoRequest)(nil),     // 2: bytebase.api.v1alpha.GetActuatorInfoRequest
	(*UpdateActuatorInfoRequest)(nil),  // 3: bytebase.api.v1alpha.UpdateActuatorInfoRequest
	(*DeleteCacheRequest)(nil),         // 4: bytebase.api.v1alpha.DeleteCacheRequest
	(*ActuatorInfo)(nil),               // 5: bytebase.api.v1alpha.ActuatorInfo
	(*ActuatorInfo_StatUser)(nil),      // 6: bytebase.api.v1alpha.ActuatorInfo.StatUser
	(*fieldmaskpb.FieldMask)(nil),      // 7: google.protobuf.FieldMask
	(*timestamppb.Timestamp)(nil),      // 8: google.protobuf.Timestamp
	(*PasswordRestrictionSetting)(nil), // 9: bytebase.api.v1alpha.PasswordRestrictionSetting
	(UserType)(0),                      // 10: bytebase.api.v1alpha.UserType
	(State)(0),                         // 11: bytebase.api.v1alpha.State
	(*emptypb.Empty)(nil),              // 12: google.protobuf.Empty
}
var file_api_v1alpha_actuator_service_proto_depIdxs = []int32{
	5,  // 0: bytebase.api.v1alpha.UpdateActuatorInfoRequest.actuator:type_name -> bytebase.api.v1alpha.ActuatorInfo
	7,  // 1: bytebase.api.v1alpha.UpdateActuatorInfoRequest.update_mask:type_name -> google.protobuf.FieldMask
	8,  // 2: bytebase.api.v1alpha.ActuatorInfo.last_active_time:type_name -> google.protobuf.Timestamp
	9,  // 3: bytebase.api.v1alpha.ActuatorInfo.password_restriction:type_name -> bytebase.api.v1alpha.PasswordRestrictionSetting
	6,  // 4: bytebase.api.v1alpha.ActuatorInfo.user_stats:type_name -> bytebase.api.v1alpha.ActuatorInfo.StatUser
	10, // 5: bytebase.api.v1alpha.ActuatorInfo.StatUser.user_type:type_name -> bytebase.api.v1alpha.UserType
	11, // 6: bytebase.api.v1alpha.ActuatorInfo.StatUser.state:type_name -> bytebase.api.v1alpha.State
	2,  // 7: bytebase.api.v1alpha.ActuatorService.GetActuatorInfo:input_type -> bytebase.api.v1alpha.GetActuatorInfoRequest
	3,  // 8: bytebase.api.v1alpha.ActuatorService.UpdateActuatorInfo:input_type -> bytebase.api.v1alpha.UpdateActuatorInfoRequest
	4,  // 9: bytebase.api.v1alpha.ActuatorService.DeleteCache:input_type -> bytebase.api.v1alpha.DeleteCacheRequest
	0,  // 10: bytebase.api.v1alpha.ActuatorService.GetResourcePackage:input_type -> bytebase.api.v1alpha.GetResourcePackageRequest
	5,  // 11: bytebase.api.v1alpha.ActuatorService.GetActuatorInfo:output_type -> bytebase.api.v1alpha.ActuatorInfo
	5,  // 12: bytebase.api.v1alpha.ActuatorService.UpdateActuatorInfo:output_type -> bytebase.api.v1alpha.ActuatorInfo
	12, // 13: bytebase.api.v1alpha.ActuatorService.DeleteCache:output_type -> google.protobuf.Empty
	1,  // 14: bytebase.api.v1alpha.ActuatorService.GetResourcePackage:output_type -> bytebase.api.v1alpha.ResourcePackage
...
func init() { file_api_v1alpha_actuator_service_proto_init() }
func file_api_v1alpha_actuator_service_proto_init() {
	if File_api_v1alpha_actuator_service_proto != nil {
		return
	}
	file_api_v1alpha_annotation_proto_init()
	file_api_v1alpha_common_proto_init()
	file_api_v1alpha_setting_service_proto_init()
	file_api_v1alpha_user_service_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_api_v1alpha_actuator_service_proto_rawDesc), len(file_api_v1alpha_actuator_service_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   7,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_api_v1alpha_actuator_service_proto_goTypes,
		DependencyIndexes: file_api_v1alpha_actuator_service_proto_depIdxs,
		MessageInfos:      file_api_v1alpha_actuator_service_proto_msgTypes,
	}.Build()
	File_api_v1alpha_actuator_service_proto = out.File
	file_api_v1alpha_actuator_service_proto_goTypes = nil
	file_api_v1alpha_actuator_service_proto_depIdxs = nil
}
