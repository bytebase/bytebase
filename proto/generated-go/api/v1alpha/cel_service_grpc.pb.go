...
const (
	CelService_BatchParse_FullMethodName   = "/bytebase.api.v1alpha.CelService/BatchParse"
	CelService_BatchDeparse_FullMethodName = "/bytebase.api.v1alpha.CelService/BatchDeparse"
)
...
var CelService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "bytebase.api.v1alpha.CelService",
	...
	Metadata: "api/v1alpha/cel_service.proto",
}
