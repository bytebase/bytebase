...
const (
	PlanService_GetPlan_FullMethodName                  = "/bytebase.api.v1alpha.PlanService/GetPlan"
	PlanService_ListPlans_FullMethodName                = "/bytebase.api.v1alpha.PlanService/ListPlans"
	PlanService_SearchPlans_FullMethodName              = "/bytebase.api.v1alpha.PlanService/SearchPlans"
	PlanService_CreatePlan_FullMethodName               = "/bytebase.api.v1alpha.PlanService/CreatePlan"
	PlanService_UpdatePlan_FullMethodName               = "/bytebase.api.v1alpha.PlanService/UpdatePlan"
	PlanService_ListPlanCheckRuns_FullMethodName        = "/bytebase.api.v1alpha.PlanService/ListPlanCheckRuns"
	PlanService_RunPlanChecks_FullMethodName            = "/bytebase.api.v1alpha.PlanService/RunPlanChecks"
	PlanService_BatchCancelPlanCheckRuns_FullMethodName = "/bytebase.api.v1alpha.PlanService/BatchCancelPlanCheckRuns"
	PlanService_PreviewPlan_FullMethodName              = "/bytebase.api.v1alpha.PlanService/PreviewPlan"
)
...
var PlanService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "bytebase.api.v1alpha.PlanService",
	...
	Metadata: "api/v1alpha/plan_service.proto",
}
