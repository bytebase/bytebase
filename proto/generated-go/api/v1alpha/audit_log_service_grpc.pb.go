...
const (
	AuditLogService_SearchAuditLogs_FullMethodName = "/bytebase.api.v1alpha.AuditLogService/SearchAuditLogs"
	AuditLogService_ExportAuditLogs_FullMethodName = "/bytebase.api.v1alpha.AuditLogService/ExportAuditLogs"
)
...
var AuditLogService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "bytebase.api.v1alpha.AuditLogService",
	...
	Metadata: "api/v1alpha/audit_log_service.proto",
}
