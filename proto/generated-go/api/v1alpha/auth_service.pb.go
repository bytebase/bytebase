...
// 	protoc        (unknown)
// source: api/v1alpha/auth_service.proto
...
func (x *LoginRequest) Reset() {
	*x = LoginRequest{}
	mi := &file_api_v1alpha_auth_service_proto_msgTypes[0]
...
func (*LoginRequest) Descriptor() ([]byte, []int) {
	return file_api_v1alpha_auth_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *IdentityProviderContext) Reset() {
	*x = IdentityProviderContext{}
	mi := &file_api_v1alpha_auth_service_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*IdentityProviderContext) Descriptor() ([]byte, []int) {
	return file_api_v1alpha_auth_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *OAuth2IdentityProviderContext) Reset() {
	*x = OAuth2IdentityProviderContext{}
	mi := &file_api_v1alpha_auth_service_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*OAuth2IdentityProviderContext) Descriptor() ([]byte, []int) {
	return file_api_v1alpha_auth_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *OIDCIdentityProviderContext) Reset() {
	*x = OIDCIdentityProviderContext{}
	mi := &file_api_v1alpha_auth_service_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*OIDCIdentityProviderContext) Descriptor() ([]byte, []int) {
	return file_api_v1alpha_auth_service_proto_rawDescGZIP(), []int{3}
}
...
func (x *LoginResponse) Reset() {
	*x = LoginResponse{}
	mi := &file_api_v1alpha_auth_service_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*LoginResponse) Descriptor() ([]byte, []int) {
	return file_api_v1alpha_auth_service_proto_rawDescGZIP(), []int{4}
}
...
func (x *LogoutRequest) Reset() {
	*x = LogoutRequest{}
	mi := &file_api_v1alpha_auth_service_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*LogoutRequest) Descriptor() ([]byte, []int) {
	return file_api_v1alpha_auth_service_proto_rawDescGZIP(), []int{5}
}

var File_api_v1alpha_auth_service_proto protoreflect.FileDescriptor

const file_api_v1alpha_auth_service_proto_rawDesc = "" +
	"\n" +
	"\x1eapi/v1alpha/auth_service.proto\x12\x14bytebase.api.v1alpha\x1a\x1cgoogle/api/annotations.proto\x1a\x1bgoogle/protobuf/empty.proto\x1a\x1capi/v1alpha/annotation.proto\x1a\x1eapi/v1alpha/user_service.proto\"\xe4\x02\n" +
	"\fLoginRequest\x12\x14\n" +
	"\x05email\x18\x01 \x01(\tR\x05email\x12\x1a\n" +
	"\bpassword\x18\x02 \x01(\tR\bpassword\x12\x10\n" +
	"\x03web\x18\x03 \x01(\bR\x03web\x12\x19\n" +
	"\bidp_name\x18\x04 \x01(\tR\aidpName\x12N\n" +
	"\vidp_context\x18\x05 \x01(\v2-.bytebase.api.v1alpha.IdentityProviderContextR\n" +
	"idpContext\x12\x1e\n" +
	...
	"\x0f_mfa_temp_token\"\xda\x01\n" +
	"\x17IdentityProviderContext\x12\\\n" +
	"\x0eoauth2_context\x18\x01 \x01(\v23.bytebase.api.v1alpha.OAuth2IdentityProviderContextH\x00R\roauth2Context\x12V\n" +
	"\foidc_context\x18\x02 \x01(\v21.bytebase.api.v1alpha.OIDCIdentityProviderContextH\x00R\voidcContextB\t\n" +
	"\acontext\"3\n" +
	"\x1dOAuth2IdentityProviderContext\x12\x12\n" +
	"\x04code\x18\x01 \x01(\tR\x04code\"\x1d\n" +
	"\x1bOIDCIdentityProviderContext\"\xc9\x01\n" +
	...
	"\x04user\x18\x04 \x01(\v2\x1a.bytebase.api.v1alpha.UserR\x04userB\x11\n" +
	"\x0f_mfa_temp_token\"\x0f\n" +
	"\rLogoutRequest2\xed\x01\n" +
	"\vAuthService\x12s\n" +
	"\x05Login\x12\".bytebase.api.v1alpha.LoginRequest\x1a#.bytebase.api.v1alpha.LoginResponse\"!\x80\xea0\x01\x98\xea0\x01\x82\xd3\xe4\x93\x02\x13:\x01*\"\x0e/v1/auth/login\x12i\n" +
	"\x06Logout\x12#.bytebase.api.v1alpha.LogoutRequest\x1a\x16.google.protobuf.Empty\"\"\x80\xea0\x01\x98\xea0\x01\x82\xd3\xe4\x93\x02\x14:\x01*\"\x0f/v1/auth/logoutB\x11Z\x0fgenerated-go/v1b\x06proto3"

var (
	file_api_v1alpha_auth_service_proto_rawDescOnce sync.Once
	file_api_v1alpha_auth_service_proto_rawDescData []byte
)

func file_api_v1alpha_auth_service_proto_rawDescGZIP() []byte {
	file_api_v1alpha_auth_service_proto_rawDescOnce.Do(func() {
		file_api_v1alpha_auth_service_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_api_v1alpha_auth_service_proto_rawDesc), len(file_api_v1alpha_auth_service_proto_rawDesc)))
	})
	return file_api_v1alpha_auth_service_proto_rawDescData
}

var file_api_v1alpha_auth_service_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_api_v1alpha_auth_service_proto_goTypes = []any{
	(*LoginRequest)(nil),                  // 0: bytebase.api.v1alpha.LoginRequest
	(*IdentityProviderContext)(nil),       // 1: bytebase.api.v1alpha.IdentityProviderContext
	(*OAuth2IdentityProviderContext)(nil), // 2: bytebase.api.v1alpha.OAuth2IdentityProviderContext
	(*OIDCIdentityProviderContext)(nil),   // 3: bytebase.api.v1alpha.OIDCIdentityProviderContext
	(*LoginResponse)(nil),                 // 4: bytebase.api.v1alpha.LoginResponse
	(*LogoutRequest)(nil),                 // 5: bytebase.api.v1alpha.LogoutRequest
	(*User)(nil),                          // 6: bytebase.api.v1alpha.User
	(*emptypb.Empty)(nil),                 // 7: google.protobuf.Empty
}
var file_api_v1alpha_auth_service_proto_depIdxs = []int32{
	1, // 0: bytebase.api.v1alpha.LoginRequest.idp_context:type_name -> bytebase.api.v1alpha.IdentityProviderContext
	2, // 1: bytebase.api.v1alpha.IdentityProviderContext.oauth2_context:type_name -> bytebase.api.v1alpha.OAuth2IdentityProviderContext
	3, // 2: bytebase.api.v1alpha.IdentityProviderContext.oidc_context:type_name -> bytebase.api.v1alpha.OIDCIdentityProviderContext
	6, // 3: bytebase.api.v1alpha.LoginResponse.user:type_name -> bytebase.api.v1alpha.User
	0, // 4: bytebase.api.v1alpha.AuthService.Login:input_type -> bytebase.api.v1alpha.LoginRequest
	5, // 5: bytebase.api.v1alpha.AuthService.Logout:input_type -> bytebase.api.v1alpha.LogoutRequest
	4, // 6: bytebase.api.v1alpha.AuthService.Login:output_type -> bytebase.api.v1alpha.LoginResponse
	7, // 7: bytebase.api.v1alpha.AuthService.Logout:output_type -> google.protobuf.Empty
...
func init() { file_api_v1alpha_auth_service_proto_init() }
func file_api_v1alpha_auth_service_proto_init() {
	if File_api_v1alpha_auth_service_proto != nil {
		return
	}
	file_api_v1alpha_annotation_proto_init()
	file_api_v1alpha_user_service_proto_init()
	file_api_v1alpha_auth_service_proto_msgTypes[0].OneofWrappers = []any{}
	file_api_v1alpha_auth_service_proto_msgTypes[1].OneofWrappers = []any{
		(*IdentityProviderContext_Oauth2Context)(nil),
		(*IdentityProviderContext_OidcContext)(nil),
	}
	file_api_v1alpha_auth_service_proto_msgTypes[4].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_api_v1alpha_auth_service_proto_rawDesc), len(file_api_v1alpha_auth_service_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_api_v1alpha_auth_service_proto_goTypes,
		DependencyIndexes: file_api_v1alpha_auth_service_proto_depIdxs,
		MessageInfos:      file_api_v1alpha_auth_service_proto_msgTypes,
	}.Build()
	File_api_v1alpha_auth_service_proto = out.File
	file_api_v1alpha_auth_service_proto_goTypes = nil
	file_api_v1alpha_auth_service_proto_depIdxs = nil
}
