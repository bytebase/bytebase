...
type IamPolicy struct {
	...
	BindingDeltas []*BindingDelta `protobuf:"bytes,3,rep,name=binding_deltas,json=bindingDeltas,proto3" json:"binding_deltas,omitempty"`
}
...
func (x *IamPolicy) GetBindingDeltas() []*BindingDelta {
	if x != nil {
...
var file_v1_iam_policy_proto_rawDesc = []byte{
	...
	0x74, 0x61, 0x67, 0x12, 0x40, 0x0a, 0x0e, 0x62, 0x69, 0x6e, 0x64, 0x69, 0x6e, 0x67, 0x5f, 0x64,
	0x65, 0x6c, 0x74, 0x61, 0x73, 0x18, 0x03, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x19, 0x2e, 0x62, 0x79,
	0x74, 0x65, 0x62, 0x61, 0x73, 0x65, 0x2e, 0x76, 0x31, 0x2e, 0x42, 0x69, 0x6e, 0x64, 0x69, 0x6e,
	0x67, 0x44, 0x65, 0x6c, 0x74, 0x61, 0x52, 0x0d, 0x62, 0x69, 0x6e, 0x64, 0x69, 0x6e, 0x67, 0x44,
	...
	0x03, 0x52, 0x0a, 0x70, 0x61, 0x72, 0x73, 0x65, 0x64, 0x45, 0x78, 0x70, 0x72, 0x22, 0x83, 0x01,
	...
	0x69, 0x6f, 0x6e, 0x42, 0x11, 0x5a, 0x0f, 0x67, 0x65, 0x6e, 0x65, 0x72, 0x61, 0x74, 0x65, 0x64,
...
var file_v1_iam_policy_proto_goTypes = []any{
	...
	(*BindingDelta)(nil),        // 4: bytebase.v1.BindingDelta
...
var file_v1_iam_policy_proto_depIdxs = []int32{
	...
	4, // 2: bytebase.v1.IamPolicy.binding_deltas:type_name -> bytebase.v1.BindingDelta
	...
	5, // 5: bytebase.v1.BindingDelta.condition:type_name -> google.type.Expr
