...
type ColumnMetadata struct {
	...
	DefaultName   string `protobuf:"bytes,22,opt,name=default_name,json=defaultName,proto3" json:"default_name,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_v1_database_service_proto_rawDesc = "" +
	...
	"\x12identity_increment\x18\x15 \x01(\x03R\x11identityIncrement\x12!\n" +
	"\fdefault_name\x18\x16 \x01(\tR\vdefaultName\"U\n" +
