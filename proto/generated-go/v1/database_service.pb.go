...
var file_v1_database_service_proto_rawDesc = []byte{
	...
	0x6f, 0x67, 0x7d, 0x2a, 0x81, 0x01, 0x0a, 0x14, 0x44, 0x61, 0x74, 0x61, 0x62, 0x61, 0x73, 0x65,
...
var file_v1_database_service_proto_depIdxs = []int32{
	...
	41,  // 43: bytebase.v1.MaterializedViewMetadata.dependent_columns:type_name -> bytebase.v1.DependentColumn
	...
	52,  // 47: bytebase.v1.DatabaseConfig.schema_configs:type_name -> bytebase.v1.SchemaConfig
	53,  // 48: bytebase.v1.SchemaConfig.table_configs:type_name -> bytebase.v1.TableConfig
	54,  // 49: bytebase.v1.SchemaConfig.function_configs:type_name -> bytebase.v1.FunctionConfig
	55,  // 50: bytebase.v1.SchemaConfig.procedure_configs:type_name -> bytebase.v1.ProcedureConfig
	56,  // 51: bytebase.v1.SchemaConfig.view_configs:type_name -> bytebase.v1.ViewConfig
	57,  // 52: bytebase.v1.TableConfig.column_configs:type_name -> bytebase.v1.ColumnConfig
	96,  // 53: bytebase.v1.TableConfig.update_time:type_name -> google.protobuf.Timestamp
	96,  // 54: bytebase.v1.FunctionConfig.update_time:type_name -> google.protobuf.Timestamp
	96,  // 55: bytebase.v1.ProcedureConfig.update_time:type_name -> google.protobuf.Timestamp
	96,  // 56: bytebase.v1.ViewConfig.update_time:type_name -> google.protobuf.Timestamp
	93,  // 57: bytebase.v1.ColumnConfig.labels:type_name -> bytebase.v1.ColumnConfig.LabelsEntry
	98,  // 58: bytebase.v1.ColumnConfig.masking_level:type_name -> bytebase.v1.MaskingLevel
	61,  // 59: bytebase.v1.ListSlowQueriesResponse.slow_query_logs:type_name -> bytebase.v1.SlowQueryLog
	62,  // 60: bytebase.v1.SlowQueryLog.statistics:type_name -> bytebase.v1.SlowQueryStatistics
	96,  // 61: bytebase.v1.SlowQueryStatistics.latest_log_time:type_name -> google.protobuf.Timestamp
	99,  // 62: bytebase.v1.SlowQueryStatistics.average_query_time:type_name -> google.protobuf.Duration
	99,  // 63: bytebase.v1.SlowQueryStatistics.maximum_query_time:type_name -> google.protobuf.Duration
	63,  // 64: bytebase.v1.SlowQueryStatistics.samples:type_name -> bytebase.v1.SlowQueryDetails
	96,  // 65: bytebase.v1.SlowQueryDetails.start_time:type_name -> google.protobuf.Timestamp
	99,  // 66: bytebase.v1.SlowQueryDetails.query_time:type_name -> google.protobuf.Duration
	99,  // 67: bytebase.v1.SlowQueryDetails.lock_time:type_name -> google.protobuf.Duration
	68,  // 68: bytebase.v1.ListSecretsResponse.secrets:type_name -> bytebase.v1.Secret
	68,  // 69: bytebase.v1.UpdateSecretRequest.secret:type_name -> bytebase.v1.Secret
	94,  // 70: bytebase.v1.UpdateSecretRequest.update_mask:type_name -> google.protobuf.FieldMask
	96,  // 71: bytebase.v1.Secret.created_time:type_name -> google.protobuf.Timestamp
	96,  // 72: bytebase.v1.Secret.updated_time:type_name -> google.protobuf.Timestamp
	96,  // 73: bytebase.v1.ChangeHistory.create_time:type_name -> google.protobuf.Timestamp
	96,  // 74: bytebase.v1.ChangeHistory.update_time:type_name -> google.protobuf.Timestamp
	...
	99,  // 78: bytebase.v1.ChangeHistory.execution_duration:type_name -> google.protobuf.Duration
	72,  // 79: bytebase.v1.ChangeHistory.changed_resources:type_name -> bytebase.v1.ChangedResources
	73,  // 80: bytebase.v1.ChangedResources.databases:type_name -> bytebase.v1.ChangedResourceDatabase
	74,  // 81: bytebase.v1.ChangedResourceDatabase.schemas:type_name -> bytebase.v1.ChangedResourceSchema
	75,  // 82: bytebase.v1.ChangedResourceSchema.tables:type_name -> bytebase.v1.ChangedResourceTable
	76,  // 83: bytebase.v1.ChangedResourceSchema.views:type_name -> bytebase.v1.ChangedResourceView
	77,  // 84: bytebase.v1.ChangedResourceSchema.functions:type_name -> bytebase.v1.ChangedResourceFunction
	78,  // 85: bytebase.v1.ChangedResourceSchema.procedures:type_name -> bytebase.v1.ChangedResourceProcedure
	100, // 86: bytebase.v1.ChangedResourceTable.ranges:type_name -> bytebase.v1.Range
	100, // 87: bytebase.v1.ChangedResourceView.ranges:type_name -> bytebase.v1.Range
	100, // 88: bytebase.v1.ChangedResourceFunction.ranges:type_name -> bytebase.v1.Range
	100, // 89: bytebase.v1.ChangedResourceProcedure.ranges:type_name -> bytebase.v1.Range
	1,   // 90: bytebase.v1.ListChangeHistoriesRequest.view:type_name -> bytebase.v1.ChangeHistoryView
	71,  // 91: bytebase.v1.ListChangeHistoriesResponse.change_histories:type_name -> bytebase.v1.ChangeHistory
	1,   // 92: bytebase.v1.GetChangeHistoryRequest.view:type_name -> bytebase.v1.ChangeHistoryView
	87,  // 93: bytebase.v1.ListRevisionsResponse.revisions:type_name -> bytebase.v1.Revision
	87,  // 94: bytebase.v1.CreateRevisionRequest.revision:type_name -> bytebase.v1.Revision
	96,  // 95: bytebase.v1.Revision.create_time:type_name -> google.protobuf.Timestamp
	96,  // 96: bytebase.v1.Revision.delete_time:type_name -> google.protobuf.Timestamp
	2,   // 97: bytebase.v1.ListChangelogsRequest.view:type_name -> bytebase.v1.ChangelogView
	91,  // 98: bytebase.v1.ListChangelogsResponse.changelogs:type_name -> bytebase.v1.Changelog
	2,   // 99: bytebase.v1.GetChangelogRequest.view:type_name -> bytebase.v1.ChangelogView
	96,  // 100: bytebase.v1.Changelog.create_time:type_name -> google.protobuf.Timestamp
	11,  // 101: bytebase.v1.Changelog.status:type_name -> bytebase.v1.Changelog.Status
	72,  // 102: bytebase.v1.Changelog.changed_resources:type_name -> bytebase.v1.ChangedResources
	...
	23,  // 110: bytebase.v1.DatabaseService.UpdateDatabaseMetadata:input_type -> bytebase.v1.UpdateDatabaseMetadataRequest
	24,  // 111: bytebase.v1.DatabaseService.GetDatabaseSchema:input_type -> bytebase.v1.GetDatabaseSchemaRequest
	25,  // 112: bytebase.v1.DatabaseService.DiffSchema:input_type -> bytebase.v1.DiffSchemaRequest
	59,  // 113: bytebase.v1.DatabaseService.ListSlowQueries:input_type -> bytebase.v1.ListSlowQueriesRequest
	64,  // 114: bytebase.v1.DatabaseService.ListSecrets:input_type -> bytebase.v1.ListSecretsRequest
	66,  // 115: bytebase.v1.DatabaseService.UpdateSecret:input_type -> bytebase.v1.UpdateSecretRequest
	67,  // 116: bytebase.v1.DatabaseService.DeleteSecret:input_type -> bytebase.v1.DeleteSecretRequest
	69,  // 117: bytebase.v1.DatabaseService.AdviseIndex:input_type -> bytebase.v1.AdviseIndexRequest
	79,  // 118: bytebase.v1.DatabaseService.ListChangeHistories:input_type -> bytebase.v1.ListChangeHistoriesRequest
	81,  // 119: bytebase.v1.DatabaseService.GetChangeHistory:input_type -> bytebase.v1.GetChangeHistoryRequest
	82,  // 120: bytebase.v1.DatabaseService.ListRevisions:input_type -> bytebase.v1.ListRevisionsRequest
	85,  // 121: bytebase.v1.DatabaseService.GetRevision:input_type -> bytebase.v1.GetRevisionRequest
	84,  // 122: bytebase.v1.DatabaseService.CreateRevision:input_type -> bytebase.v1.CreateRevisionRequest
	86,  // 123: bytebase.v1.DatabaseService.DeleteRevision:input_type -> bytebase.v1.DeleteRevisionRequest
	88,  // 124: bytebase.v1.DatabaseService.ListChangelogs:input_type -> bytebase.v1.ListChangelogsRequest
	90,  // 125: bytebase.v1.DatabaseService.GetChangelog:input_type -> bytebase.v1.GetChangelogRequest
	27,  // 126: bytebase.v1.DatabaseService.GetDatabase:output_type -> bytebase.v1.Database
	14,  // 127: bytebase.v1.DatabaseService.ListInstanceDatabases:output_type -> bytebase.v1.ListInstanceDatabasesResponse
	16,  // 128: bytebase.v1.DatabaseService.ListDatabases:output_type -> bytebase.v1.ListDatabasesResponse
	27,  // 129: bytebase.v1.DatabaseService.UpdateDatabase:output_type -> bytebase.v1.Database
	19,  // 130: bytebase.v1.DatabaseService.BatchUpdateDatabases:output_type -> bytebase.v1.BatchUpdateDatabasesResponse
	21,  // 131: bytebase.v1.DatabaseService.SyncDatabase:output_type -> bytebase.v1.SyncDatabaseResponse
	28,  // 132: bytebase.v1.DatabaseService.GetDatabaseMetadata:output_type -> bytebase.v1.DatabaseMetadata
	28,  // 133: bytebase.v1.DatabaseService.UpdateDatabaseMetadata:output_type -> bytebase.v1.DatabaseMetadata
	58,  // 134: bytebase.v1.DatabaseService.GetDatabaseSchema:output_type -> bytebase.v1.DatabaseSchema
	26,  // 135: bytebase.v1.DatabaseService.DiffSchema:output_type -> bytebase.v1.DiffSchemaResponse
	60,  // 136: bytebase.v1.DatabaseService.ListSlowQueries:output_type -> bytebase.v1.ListSlowQueriesResponse
	65,  // 137: bytebase.v1.DatabaseService.ListSecrets:output_type -> bytebase.v1.ListSecretsResponse
	68,  // 138: bytebase.v1.DatabaseService.UpdateSecret:output_type -> bytebase.v1.Secret
	101, // 139: bytebase.v1.DatabaseService.DeleteSecret:output_type -> google.protobuf.Empty
	70,  // 140: bytebase.v1.DatabaseService.AdviseIndex:output_type -> bytebase.v1.AdviseIndexResponse
	80,  // 141: bytebase.v1.DatabaseService.ListChangeHistories:output_type -> bytebase.v1.ListChangeHistoriesResponse
	71,  // 142: bytebase.v1.DatabaseService.GetChangeHistory:output_type -> bytebase.v1.ChangeHistory
	83,  // 143: bytebase.v1.DatabaseService.ListRevisions:output_type -> bytebase.v1.ListRevisionsResponse
	87,  // 144: bytebase.v1.DatabaseService.GetRevision:output_type -> bytebase.v1.Revision
	87,  // 145: bytebase.v1.DatabaseService.CreateRevision:output_type -> bytebase.v1.Revision
	101, // 146: bytebase.v1.DatabaseService.DeleteRevision:output_type -> google.protobuf.Empty
	89,  // 147: bytebase.v1.DatabaseService.ListChangelogs:output_type -> bytebase.v1.ListChangelogsResponse
	91,  // 148: bytebase.v1.DatabaseService.GetChangelog:output_type -> bytebase.v1.Changelog
