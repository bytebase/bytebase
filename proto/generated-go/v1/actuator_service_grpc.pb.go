...
func (c *actuatorServiceClient) GetActuatorInfo(ctx context.Context, in *GetActuatorInfoRequest, opts ...grpc.CallOption) (*ActuatorInfo, error) {
	...
	err := c.cc.Invoke(ctx, "/bytebase.v1.ActuatorService/GetActuatorInfo", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *actuatorServiceClient) UpdateActuatorInfo(ctx context.Context, in *UpdateActuatorInfoRequest, opts ...grpc.CallOption) (*ActuatorInfo, error) {
	out := new(ActuatorInfo)
	err := c.cc.Invoke(ctx, "/bytebase.v1.ActuatorService/UpdateActuatorInfo", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _ActuatorService_GetActuatorInfo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/bytebase.v1.ActuatorService/GetActuatorInfo",
	}
...
func _ActuatorService_UpdateActuatorInfo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/bytebase.v1.ActuatorService/UpdateActuatorInfo",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
