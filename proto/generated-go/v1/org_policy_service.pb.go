...
const (
	...
	PolicyType_RESTRICT_PRECREATE_ISSUE PolicyType = 12
)
...
type RestrictPrecreateIssuePolicy struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *RestrictPrecreateIssuePolicy) Reset() {
	*x = RestrictPrecreateIssuePolicy{}
	if protoimpl.UnsafeEnabled {
...
func (x *RestrictPrecreateIssuePolicy) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RestrictPrecreateIssuePolicy) ProtoMessage() {}

func (x *RestrictPrecreateIssuePolicy) ProtoReflect() protoreflect.Message {
	mi := &file_v1_org_policy_service_proto_msgTypes[19]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RestrictPrecreateIssuePolicy.ProtoReflect.Descriptor instead.
func (*RestrictPrecreateIssuePolicy) Descriptor() ([]byte, []int) {
	return file_v1_org_policy_service_proto_rawDescGZIP(), []int{19}
}

func (x *RestrictPrecreateIssuePolicy) GetBypassSqlReview() bool {
	if x != nil {
...
var file_v1_org_policy_service_proto_rawDesc = []byte{
	...
	0x6d, 0x61, 0x73, 0x6b, 0x69, 0x6e, 0x67, 0x4c, 0x65, 0x76, 0x65, 0x6c, 0x22, 0x4a, 0x0a, 0x1c,
	0x52, 0x65, 0x73, 0x74, 0x72, 0x69, 0x63, 0x74, 0x50, 0x72, 0x65, 0x63, 0x72, 0x65, 0x61, 0x74,
	0x65, 0x49, 0x73, 0x73, 0x75, 0x65, 0x50, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x12, 0x2a, 0x0a, 0x11,
	0x62, 0x79, 0x70, 0x61, 0x73, 0x73, 0x5f, 0x73, 0x71, 0x6c, 0x5f, 0x72, 0x65, 0x76, 0x69, 0x65,
	0x77, 0x18, 0x01, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0f, 0x62, 0x79, 0x70, 0x61, 0x73, 0x73, 0x53,
	0x71, 0x6c, 0x52, 0x65, 0x76, 0x69, 0x65, 0x77, 0x2a, 0x8b, 0x02, 0x0a, 0x0a, 0x50, 0x6f, 0x6c,
	...
	0x45, 0x44, 0x10, 0x00, 0x12, 0x11, 0x0a, 0x0d, 0x57, 0x4f, 0x52, 0x4b, 0x53, 0x50, 0x41, 0x43,
	0x45, 0x5f, 0x49, 0x41, 0x4d, 0x10, 0x01, 0x12, 0x17, 0x0a, 0x13, 0x44, 0x45, 0x50, 0x4c, 0x4f,
	0x59, 0x4d, 0x45, 0x4e, 0x54, 0x5f, 0x41, 0x50, 0x50, 0x52, 0x4f, 0x56, 0x41, 0x4c, 0x10, 0x02,
	0x12, 0x12, 0x0a, 0x0e, 0x52, 0x4f, 0x4c, 0x4c, 0x4f, 0x55, 0x54, 0x5f, 0x50, 0x4f, 0x4c, 0x49,
	0x43, 0x59, 0x10, 0x0b, 0x12, 0x0f, 0x0a, 0x0b, 0x42, 0x41, 0x43, 0x4b, 0x55, 0x50, 0x5f, 0x50,
	...
	0x10, 0x0a, 0x12, 0x1c, 0x0a, 0x18, 0x52, 0x45, 0x53, 0x54, 0x52, 0x49, 0x43, 0x54, 0x5f, 0x50,
	0x52, 0x45, 0x43, 0x52, 0x45, 0x41, 0x54, 0x45, 0x5f, 0x49, 0x53, 0x53, 0x55, 0x45, 0x10, 0x0c,
...
var file_v1_org_policy_service_proto_goTypes = []interface{}{
	...
	(*RestrictPrecreateIssuePolicy)(nil),                // 26: bytebase.v1.RestrictPrecreateIssuePolicy
...
func file_v1_org_policy_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_v1_org_policy_service_proto_msgTypes[19].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*RestrictPrecreateIssuePolicy); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
