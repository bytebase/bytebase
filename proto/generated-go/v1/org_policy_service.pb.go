...
const (
	...
	PolicyType_PRECREATE_ISSUE         PolicyType = 12
)
...
type PrecreateIssuePolicy struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	BypassSqlReview bool `protobuf:"varint,1,opt,name=bypass_sql_review,json=bypassSqlReview,proto3" json:"bypass_sql_review,omitempty"`
}

func (x *PrecreateIssuePolicy) Reset() {
	*x = PrecreateIssuePolicy{}
	if protoimpl.UnsafeEnabled {
...
func (x *PrecreateIssuePolicy) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PrecreateIssuePolicy) ProtoMessage() {}

func (x *PrecreateIssuePolicy) ProtoReflect() protoreflect.Message {
	mi := &file_v1_org_policy_service_proto_msgTypes[19]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PrecreateIssuePolicy.ProtoReflect.Descriptor instead.
func (*PrecreateIssuePolicy) Descriptor() ([]byte, []int) {
	return file_v1_org_policy_service_proto_rawDescGZIP(), []int{19}
}

func (x *PrecreateIssuePolicy) GetBypassSqlReview() bool {
	if x != nil {
		return x.BypassSqlReview
	}
	return false
}
...
var file_v1_org_policy_service_proto_rawDesc = []byte{
	...
	0x6d, 0x61, 0x73, 0x6b, 0x69, 0x6e, 0x67, 0x4c, 0x65, 0x76, 0x65, 0x6c, 0x22, 0x42, 0x0a, 0x14,
	0x50, 0x72, 0x65, 0x63, 0x72, 0x65, 0x61, 0x74, 0x65, 0x49, 0x73, 0x73, 0x75, 0x65, 0x50, 0x6f,
	0x6c, 0x69, 0x63, 0x79, 0x12, 0x2a, 0x0a, 0x11, 0x62, 0x79, 0x70, 0x61, 0x73, 0x73, 0x5f, 0x73,
	0x71, 0x6c, 0x5f, 0x72, 0x65, 0x76, 0x69, 0x65, 0x77, 0x18, 0x01, 0x20, 0x01, 0x28, 0x08, 0x52,
	0x0f, 0x62, 0x79, 0x70, 0x61, 0x73, 0x73, 0x53, 0x71, 0x6c, 0x52, 0x65, 0x76, 0x69, 0x65, 0x77,
	0x2a, 0x82, 0x02, 0x0a, 0x0a, 0x50, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x54, 0x79, 0x70, 0x65, 0x12,
	...
	0x50, 0x52, 0x4f, 0x56, 0x41, 0x4c, 0x10, 0x02, 0x12, 0x12, 0x0a, 0x0e, 0x52, 0x4f, 0x4c, 0x4c,
	0x4f, 0x55, 0x54, 0x5f, 0x50, 0x4f, 0x4c, 0x49, 0x43, 0x59, 0x10, 0x0b, 0x12, 0x0f, 0x0a, 0x0b,
	0x42, 0x41, 0x43, 0x4b, 0x55, 0x50, 0x5f, 0x50, 0x4c, 0x41, 0x4e, 0x10, 0x03, 0x12, 0x0e, 0x0a,
	0x0a, 0x53, 0x51, 0x4c, 0x5f, 0x52, 0x45, 0x56, 0x49, 0x45, 0x57, 0x10, 0x04, 0x12, 0x0b, 0x0a,
	...
	0x58, 0x43, 0x45, 0x50, 0x54, 0x49, 0x4f, 0x4e, 0x10, 0x0a, 0x12, 0x13, 0x0a, 0x0f, 0x50, 0x52,
	0x45, 0x43, 0x52, 0x45, 0x41, 0x54, 0x45, 0x5f, 0x49, 0x53, 0x53, 0x55, 0x45, 0x10, 0x0c, 0x22,
	...
	0x10, 0x03, 0x2a, 0x51, 0x0a, 0x12, 0x53, 0x51, 0x4c, 0x52, 0x65, 0x76, 0x69, 0x65, 0x77, 0x52,
...
var file_v1_org_policy_service_proto_goTypes = []interface{}{
	...
	(*PrecreateIssuePolicy)(nil),                        // 26: bytebase.v1.PrecreateIssuePolicy
...
var file_v1_org_policy_service_proto_depIdxs = []int32{
	...
	31, // 20: bytebase.v1.DeploymentApprovalStrategy.deployment_type:type_name -> bytebase.v1.DeploymentType
	...
	32, // 24: bytebase.v1.BackupPlanPolicy.retention_duration:type_name -> google.protobuf.Duration
	21, // 25: bytebase.v1.MaskingPolicy.mask_data:type_name -> bytebase.v1.MaskData
	33, // 26: bytebase.v1.MaskData.masking_level:type_name -> bytebase.v1.MaskingLevel
	...
	34, // 29: bytebase.v1.SQLReviewRule.engine:type_name -> bytebase.v1.Engine
	27, // 30: bytebase.v1.MaskingExceptionPolicy.masking_exceptions:type_name -> bytebase.v1.MaskingExceptionPolicy.MaskingException
	28, // 31: bytebase.v1.MaskingRulePolicy.rules:type_name -> bytebase.v1.MaskingRulePolicy.MaskingRule
	...
	33, // 33: bytebase.v1.MaskingExceptionPolicy.MaskingException.masking_level:type_name -> bytebase.v1.MaskingLevel
	35, // 34: bytebase.v1.MaskingExceptionPolicy.MaskingException.condition:type_name -> google.type.Expr
	35, // 35: bytebase.v1.MaskingRulePolicy.MaskingRule.condition:type_name -> google.type.Expr
	33, // 36: bytebase.v1.MaskingRulePolicy.MaskingRule.masking_level:type_name -> bytebase.v1.MaskingLevel
	...
	36, // 46: bytebase.v1.OrgPolicyService.DeletePolicy:output_type -> google.protobuf.Empty
...
func file_v1_org_policy_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_v1_org_policy_service_proto_msgTypes[19].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*PrecreateIssuePolicy); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
