...
type DataCategorySetting_DataCategoryConfig struct {
	...
	Title string `protobuf:"bytes,2,opt,name=title,proto3" json:"title,omitempty"` // TODO(ed): store the actual config.
}
...
var file_v1_setting_service_proto_rawDesc = []byte{
	...
	0x6c, 0x61, 0x6e, 0x54, 0x79, 0x70, 0x65, 0x52, 0x04, 0x70, 0x6c, 0x61, 0x6e, 0x22, 0xa2, 0x01,
	...
	0x66, 0x69, 0x67, 0x73, 0x1a, 0x3c, 0x0a, 0x12, 0x44, 0x61, 0x74, 0x61, 0x43, 0x61, 0x74, 0x65,
	0x67, 0x6f, 0x72, 0x79, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x12, 0x10, 0x0a, 0x03, 0x75, 0x69,
	0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x75, 0x69, 0x64, 0x12, 0x14, 0x0a, 0x05,
	0x74, 0x69, 0x74, 0x6c, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x74, 0x69, 0x74,
	0x6c, 0x65, 0x32, 0xdc, 0x02, 0x0a, 0x0e, 0x53, 0x65, 0x74, 0x74, 0x69, 0x6e, 0x67, 0x53, 0x65,
...
var file_v1_setting_service_proto_msgTypes = make([]protoimpl.MessageInfo, 21)
var file_v1_setting_service_proto_goTypes = []interface{}{
	...
	(*ColumnMetadata)(nil),                           // 29: bytebase.v1.ColumnMetadata
}
var file_v1_setting_service_proto_depIdxs = []int32{
	...
	26, // 23: bytebase.v1.WorkspaceApprovalSetting.Rule.template:type_name -> bytebase.v1.ApprovalTemplate
	27, // 24: bytebase.v1.WorkspaceApprovalSetting.Rule.condition:type_name -> google.type.Expr
	28, // 25: bytebase.v1.SchemaTemplateSetting.FieldTemplate.engine:type_name -> bytebase.v1.Engine
	29, // 26: bytebase.v1.SchemaTemplateSetting.FieldTemplate.column:type_name -> bytebase.v1.ColumnMetadata
	3,  // 27: bytebase.v1.SettingService.ListSettings:input_type -> bytebase.v1.ListSettingsRequest
	5,  // 28: bytebase.v1.SettingService.GetSetting:input_type -> bytebase.v1.GetSettingRequest
	7,  // 29: bytebase.v1.SettingService.SetSetting:input_type -> bytebase.v1.SetSettingRequest
	4,  // 30: bytebase.v1.SettingService.ListSettings:output_type -> bytebase.v1.ListSettingsResponse
	8,  // 31: bytebase.v1.SettingService.GetSetting:output_type -> bytebase.v1.Setting
	8,  // 32: bytebase.v1.SettingService.SetSetting:output_type -> bytebase.v1.Setting
