...
type DataCategorySetting struct {
	...
	Configs []*DataCategorySetting_DataCategoryConfig `protobuf:"bytes,1,rep,name=configs,proto3" json:"configs,omitempty"`
}
...
func (x *DataCategorySetting) GetConfigs() []*DataCategorySetting_DataCategoryConfig {
	if x != nil {
		return x.Configs
	}
	return nil
...
type DataCategorySetting_DataCategoryConfig struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	CategoryLevel map[string]string `protobuf:"bytes,3,rep,name=category_level,json=categoryLevel,proto3" json:"category_level,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"` // TODO(ed): store the actual config.
}

func (x *DataCategorySetting_DataCategoryConfig) Reset() {
	*x = DataCategorySetting_DataCategoryConfig{}
	if protoimpl.UnsafeEnabled {
...
func (x *DataCategorySetting_DataCategoryConfig) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DataCategorySetting_DataCategoryConfig) ProtoMessage() {}

func (x *DataCategorySetting_DataCategoryConfig) ProtoReflect() protoreflect.Message {
	mi := &file_v1_setting_service_proto_msgTypes[20]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DataCategorySetting_DataCategoryConfig.ProtoReflect.Descriptor instead.
func (*DataCategorySetting_DataCategoryConfig) Descriptor() ([]byte, []int) {
	return file_v1_setting_service_proto_rawDescGZIP(), []int{15, 0}
}

func (x *DataCategorySetting_DataCategoryConfig) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
func (x *DataCategorySetting_DataCategoryConfig) GetTitle() string {
	if x != nil {
		return x.Title
	}
	return ""
...
func (x *DataCategorySetting_DataCategoryConfig) GetCategoryLevel() map[string]string {
	if x != nil {
...
var file_v1_setting_service_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x09, 0x52, 0x08, 0x65, 0x6e, 0x64, 0x70, 0x6f, 0x69, 0x6e, 0x74, 0x22, 0x92, 0x02,
	...
	0x6d, 0x6e, 0x22, 0x98, 0x02, 0x0a, 0x15, 0x57, 0x6f, 0x72, 0x6b, 0x73, 0x70, 0x61, 0x63, 0x65,
	...
	,
...
var file_v1_setting_service_proto_msgTypes = make([]protoimpl.MessageInfo, 22)
var file_v1_setting_service_proto_goTypes = []interface{}{
	...
	(*DataCategorySetting_DataCategoryConfig)(nil),   // 23: bytebase.v1.DataCategorySetting.DataCategoryConfig
	nil,                           // 24: bytebase.v1.DataCategorySetting.DataCategoryConfig.CategoryLevelEntry
	(*timestamppb.Timestamp)(nil), // 25: google.protobuf.Timestamp
	(PlanType)(0),                 // 26: bytebase.v1.PlanType
	(*ApprovalTemplate)(nil),      // 27: bytebase.v1.ApprovalTemplate
...
var file_v1_setting_service_proto_depIdxs = []int32{
	...
	25, // 19: bytebase.v1.WorkspaceTrialSetting.expire_time:type_name -> google.protobuf.Timestamp
	25, // 20: bytebase.v1.WorkspaceTrialSetting.issued_time:type_name -> google.protobuf.Timestamp
	26, // 21: bytebase.v1.WorkspaceTrialSetting.plan:type_name -> bytebase.v1.PlanType
	23, // 22: bytebase.v1.DataCategorySetting.configs:type_name -> bytebase.v1.DataCategorySetting.DataCategoryConfig
	27, // 23: bytebase.v1.WorkspaceApprovalSetting.Rule.template:type_name -> bytebase.v1.ApprovalTemplate
	28, // 24: bytebase.v1.WorkspaceApprovalSetting.Rule.condition:type_name -> google.type.Expr
	29, // 25: bytebase.v1.SchemaTemplateSetting.FieldTemplate.engine:type_name -> bytebase.v1.Engine
	30, // 26: bytebase.v1.SchemaTemplateSetting.FieldTemplate.column:type_name -> bytebase.v1.ColumnMetadata
	24, // 27: bytebase.v1.DataCategorySetting.DataCategoryConfig.category_level:type_name -> bytebase.v1.DataCategorySetting.DataCategoryConfig.CategoryLevelEntry
	3,  // 28: bytebase.v1.SettingService.ListSettings:input_type -> bytebase.v1.ListSettingsRequest
	5,  // 29: bytebase.v1.SettingService.GetSetting:input_type -> bytebase.v1.GetSettingRequest
	7,  // 30: bytebase.v1.SettingService.SetSetting:input_type -> bytebase.v1.SetSettingRequest
	4,  // 31: bytebase.v1.SettingService.ListSettings:output_type -> bytebase.v1.ListSettingsResponse
	8,  // 32: bytebase.v1.SettingService.GetSetting:output_type -> bytebase.v1.Setting
	8,  // 33: bytebase.v1.SettingService.SetSetting:output_type -> bytebase.v1.Setting
...
func file_v1_setting_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_v1_setting_service_proto_msgTypes[20].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*DataCategorySetting_DataCategoryConfig); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
