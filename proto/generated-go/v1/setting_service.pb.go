...
type DataClassificationSetting_DataClassificationConfig struct {
	...
	ClassificationLevel map[string]string `protobuf:"bytes,3,rep,name=classification_level,json=classificationLevel,proto3" json:"classification_level,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"` // TODO(ed): store the actual config.
}
...
func (x *DataClassificationSetting_DataClassificationConfig) GetClassificationLevel() map[string]string {
	if x != nil {
...
var file_v1_setting_service_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x09, 0x52, 0x08, 0x65, 0x6e, 0x64, 0x70, 0x6f, 0x69, 0x6e, 0x74, 0x22, 0xb5, 0x03,
	...
	0x79, 0x70, 0x65, 0x73, 0x1a, 0x9d, 0x01, 0x0a, 0x0d, 0x46, 0x69, 0x65, 0x6c, 0x64, 0x54, 0x65,
	...
	0x6c, 0x75, 0x6d, 0x6e, 0x1a, 0x4f, 0x0a, 0x0a, 0x43, 0x6f, 0x6c, 0x75, 0x6d, 0x6e, 0x54, 0x79,
	...
	0x22, 0x8f, 0x03, 0x0a, 0x19, 0x44, 0x61, 0x74, 0x61, 0x43, 0x6c, 0x61, 0x73, 0x73, 0x69, 0x66,
	...
	0x52, 0x07, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x73, 0x1a, 0x96, 0x02, 0x0a, 0x18, 0x44, 0x61,
	0x74, 0x61, 0x43, 0x6c, 0x61, 0x73, 0x73, 0x69, 0x66, 0x69, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e,
	...
	0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x74, 0x69, 0x74, 0x6c, 0x65, 0x12, 0x8b, 0x01, 0x0a,
	0x14, 0x63, 0x6c, 0x61, 0x73, 0x73, 0x69, 0x66, 0x69, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x5f,
	0x6c, 0x65, 0x76, 0x65, 0x6c, 0x18, 0x03, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x58, 0x2e, 0x62, 0x79,
	...
	,
...
var file_v1_setting_service_proto_msgTypes = make([]protoimpl.MessageInfo, 23)
var file_v1_setting_service_proto_goTypes = []interface{}{
	...
	nil,                           // 25: bytebase.v1.DataClassificationSetting.DataClassificationConfig.ClassificationLevelEntry
	(*timestamppb.Timestamp)(nil), // 26: google.protobuf.Timestamp
	(PlanType)(0),                 // 27: bytebase.v1.PlanType
	(*ApprovalTemplate)(nil),      // 28: bytebase.v1.ApprovalTemplate
...
var file_v1_setting_service_proto_depIdxs = []int32{
	...
	23, // 19: bytebase.v1.SchemaTemplateSetting.column_types:type_name -> bytebase.v1.SchemaTemplateSetting.ColumnType
	26, // 20: bytebase.v1.WorkspaceTrialSetting.expire_time:type_name -> google.protobuf.Timestamp
	26, // 21: bytebase.v1.WorkspaceTrialSetting.issued_time:type_name -> google.protobuf.Timestamp
	27, // 22: bytebase.v1.WorkspaceTrialSetting.plan:type_name -> bytebase.v1.PlanType
	24, // 23: bytebase.v1.DataClassificationSetting.configs:type_name -> bytebase.v1.DataClassificationSetting.DataClassificationConfig
	28, // 24: bytebase.v1.WorkspaceApprovalSetting.Rule.template:type_name -> bytebase.v1.ApprovalTemplate
	29, // 25: bytebase.v1.WorkspaceApprovalSetting.Rule.condition:type_name -> google.type.Expr
	30, // 26: bytebase.v1.SchemaTemplateSetting.FieldTemplate.engine:type_name -> bytebase.v1.Engine
	31, // 27: bytebase.v1.SchemaTemplateSetting.FieldTemplate.column:type_name -> bytebase.v1.ColumnMetadata
	30, // 28: bytebase.v1.SchemaTemplateSetting.ColumnType.engine:type_name -> bytebase.v1.Engine
	25, // 29: bytebase.v1.DataClassificationSetting.DataClassificationConfig.classification_level:type_name -> bytebase.v1.DataClassificationSetting.DataClassificationConfig.ClassificationLevelEntry
	3,  // 30: bytebase.v1.SettingService.ListSettings:input_type -> bytebase.v1.ListSettingsRequest
	5,  // 31: bytebase.v1.SettingService.GetSetting:input_type -> bytebase.v1.GetSettingRequest
	7,  // 32: bytebase.v1.SettingService.SetSetting:input_type -> bytebase.v1.SetSettingRequest
	4,  // 33: bytebase.v1.SettingService.ListSettings:output_type -> bytebase.v1.ListSettingsResponse
	8,  // 34: bytebase.v1.SettingService.GetSetting:output_type -> bytebase.v1.Setting
	8,  // 35: bytebase.v1.SettingService.SetSetting:output_type -> bytebase.v1.Setting
