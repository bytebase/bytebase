...
func (x *TaskRun_ExecutionStatus_TextPosition) GetLine() int32 {
	if x != nil {
		return x.Line
	}
	return 0
...
func (x *TaskRun_ExecutionStatus_TextPosition) GetColumn() int32 {
	if x != nil {
		return x.Column
	}
	return 0
...
var file_v1_rollout_service_proto_rawDesc = []byte{
	...
	0x20, 0x01, 0x28, 0x05, 0x52, 0x06, 0x63, 0x6f, 0x6c, 0x75, 0x6d, 0x6e, 0x22, 0x56, 0x0a, 0x06,
