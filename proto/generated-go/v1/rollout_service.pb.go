...
const file_v1_rollout_service_proto_rawDesc = "" +
	...
	"\x17bytebase.com/TaskRunLog\x12Xprojects/{project}/rollouts/{rollout}/stages/{stage}/tasks/{task}/taskRuns/{taskRun}/log\"\xce\x10\n" +
	...
	"\fprior_backup\x18\b \x01(\v2(.bytebase.v1.TaskRunLogEntry.PriorBackupR\vpriorBackup\x1a\x94\x01\n" +
	"\n" +
	"SchemaDump\x129\n" +
	"\n" +
