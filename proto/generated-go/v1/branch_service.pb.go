...
func (x *RebaseBranchResponse) GetResult() isRebaseBranchResponse_Result {
	if x != nil {
		return x.Result
	}
	return nil
...
func (x *RebaseBranchResponse) GetBranch() *Branch {
	if x != nil {
		if x, ok := x.Result.(*RebaseBranchResponse_Branch); ok {
			return x.Branch
		}
	}
	return nil
...
func (x *RebaseBranchResponse) GetConflictSchema() string {
	if x != nil {
		if x, ok := x.Result.(*RebaseBranchResponse_ConflictSchema); ok {
...
func (x *DiffDatabaseResponse) GetResult() isDiffDatabaseResponse_Result {
	if x != nil {
		return x.Result
	}
	return nil
...
func (x *DiffDatabaseResponse) GetSchema() string {
	if x != nil {
		if x, ok := x.Result.(*DiffDatabaseResponse_Schema); ok {
			return x.Schema
		}
	}
	return ""
...
func (x *DiffDatabaseResponse) GetConflictSchema() string {
	if x != nil {
		if x, ok := x.Result.(*DiffDatabaseResponse_ConflictSchema); ok {
			return x.ConflictSchema
		}
	}
	return ""
