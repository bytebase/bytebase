...
func (Anomaly_AnomalyType) Descriptor() protoreflect.EnumDescriptor {
	return file_anomaly_service_proto_enumTypes[0].Descriptor()
}

func (Anomaly_AnomalyType) Type() protoreflect.EnumType {
	return &file_anomaly_service_proto_enumTypes[0]
}
...
func (Anomaly_AnomalyType) EnumDescriptor() ([]byte, []int) {
	return file_anomaly_service_proto_rawDescGZIP(), []int{2, 0}
}
...
func (Anomaly_AnomalySeverity) Descriptor() protoreflect.EnumDescriptor {
	return file_anomaly_service_proto_enumTypes[1].Descriptor()
}

func (Anomaly_AnomalySeverity) Type() protoreflect.EnumType {
	return &file_anomaly_service_proto_enumTypes[1]
}
...
func (Anomaly_AnomalySeverity) EnumDescriptor() ([]byte, []int) {
	return file_anomaly_service_proto_rawDescGZIP(), []int{2, 1}
}
...
func (x *SearchAnomaliesRequest) Reset() {
	*x = SearchAnomaliesRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_anomaly_service_proto_msgTypes[0]
...
func (*SearchAnomaliesRequest) Descriptor() ([]byte, []int) {
	return file_anomaly_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *SearchAnomaliesResponse) Reset() {
	*x = SearchAnomaliesResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_anomaly_service_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*SearchAnomaliesResponse) Descriptor() ([]byte, []int) {
	return file_anomaly_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *Anomaly) Reset() {
	*x = Anomaly{}
	if protoimpl.UnsafeEnabled {
		mi := &file_anomaly_service_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Anomaly) Descriptor() ([]byte, []int) {
	return file_anomaly_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *Anomaly_InstanceConnectionDetail) Reset() {
	*x = Anomaly_InstanceConnectionDetail{}
	if protoimpl.UnsafeEnabled {
		mi := &file_anomaly_service_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (x *Anomaly_DatabaseConnectionDetail) Reset() {
	*x = Anomaly_DatabaseConnectionDetail{}
	if protoimpl.UnsafeEnabled {
		mi := &file_anomaly_service_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (x *Anomaly_DatabaseSchemaDriftDetail) Reset() {
	*x = Anomaly_DatabaseSchemaDriftDetail{}
	if protoimpl.UnsafeEnabled {
		mi := &file_anomaly_service_proto_msgTypes[5]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Anomaly_DatabaseSchemaDriftDetail) Descriptor() ([]byte, []int) {
	return file_anomaly_service_proto_rawDescGZIP(), []int{2, 2}
}
...
var File_anomaly_service_proto protoreflect.FileDescriptor

var file_anomaly_service_proto_rawDesc = []byte{
	0x0a, 0x15, 0x61, 0x6e, 0x6f, 0x6d, 0x61, 0x6c, 0x79, 0x5f, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63,
	...
	0x50, 0x61, 0x67, 0x65, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0xe6, 0x08, 0x0a, 0x07, 0x41, 0x6e,
	...
	0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x44, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x12, 0x71, 0x0a, 0x1c,
	0x64, 0x61, 0x74, 0x61, 0x62, 0x61, 0x73, 0x65, 0x5f, 0x73, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x5f,
	0x64, 0x72, 0x69, 0x66, 0x74, 0x5f, 0x64, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x18, 0x08, 0x20, 0x01,
	0x28, 0x0b, 0x32, 0x2e, 0x2e, 0x62, 0x79, 0x74, 0x65, 0x62, 0x61, 0x73, 0x65, 0x2e, 0x76, 0x31,
	0x2e, 0x41, 0x6e, 0x6f, 0x6d, 0x61, 0x6c, 0x79, 0x2e, 0x44, 0x61, 0x74, 0x61, 0x62, 0x61, 0x73,
	0x65, 0x53, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x44, 0x72, 0x69, 0x66, 0x74, 0x44, 0x65, 0x74, 0x61,
	0x69, 0x6c, 0x48, 0x00, 0x52, 0x19, 0x64, 0x61, 0x74, 0x61, 0x62, 0x61, 0x73, 0x65, 0x53, 0x63,
	...
	0x69, 0x6d, 0x65, 0x1a, 0x32, 0x0a, 0x18, 0x49, 0x6e, 0x73, 0x74, 0x61, 0x6e, 0x63, 0x65, 0x43,
	...
	0x01, 0x28, 0x09, 0x52, 0x06, 0x64, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x1a, 0x90, 0x01, 0x0a, 0x19,
	...
	0x52, 0x0c, 0x61, 0x63, 0x74, 0x75, 0x61, 0x6c, 0x53, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x22, 0x8e,
	...
	,
	...
	0x2f, 0x61, 0x6e, 0x6f, 0x6d, 0x61, 0x6c, 0x69, 0x65, 0x73, 0x3a, 0x73, 0x65, 0x61, 0x72, 0x63,
...
var (
	file_anomaly_service_proto_rawDescOnce sync.Once
	file_anomaly_service_proto_rawDescData = file_anomaly_service_proto_rawDesc
)

func file_anomaly_service_proto_rawDescGZIP() []byte {
	file_anomaly_service_proto_rawDescOnce.Do(func() {
		file_anomaly_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_anomaly_service_proto_rawDescData)
	})
	return file_anomaly_service_proto_rawDescData
}

var file_anomaly_service_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
var file_anomaly_service_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_anomaly_service_proto_goTypes = []interface{}{
...
var file_anomaly_service_proto_depIdxs = []int32{
...
func init() { file_anomaly_service_proto_init() }
func file_anomaly_service_proto_init() {
	if File_anomaly_service_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_anomaly_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_anomaly_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_anomaly_service_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_anomaly_service_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_anomaly_service_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_anomaly_service_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
	...
	file_anomaly_service_proto_msgTypes[2].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_anomaly_service_proto_rawDesc,
			NumEnums:      2,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_anomaly_service_proto_goTypes,
		DependencyIndexes: file_anomaly_service_proto_depIdxs,
		EnumInfos:         file_anomaly_service_proto_enumTypes,
		MessageInfos:      file_anomaly_service_proto_msgTypes,
	}.Build()
	File_anomaly_service_proto = out.File
	file_anomaly_service_proto_rawDesc = nil
	file_anomaly_service_proto_goTypes = nil
	file_anomaly_service_proto_depIdxs = nil
}
