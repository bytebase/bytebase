...
const (
	EnvironmentService_GetEnvironment_FullMethodName      = "/bytebase.v1.EnvironmentService/GetEnvironment"
	EnvironmentService_ListEnvironments_FullMethodName    = "/bytebase.v1.EnvironmentService/ListEnvironments"
	EnvironmentService_CreateEnvironment_FullMethodName   = "/bytebase.v1.EnvironmentService/CreateEnvironment"
...
func (c *environmentServiceClient) CreateEnvironment(ctx context.Context, in *CreateEnvironmentRequest, opts ...grpc.CallOption) (*Environment, error) {
	out := new(Environment)
	err := c.cc.Invoke(ctx, EnvironmentService_CreateEnvironment_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *environmentServiceClient) UndeleteEnvironment(ctx context.Context, in *UndeleteEnvironmentRequest, opts ...grpc.CallOption) (*Environment, error) {
	out := new(Environment)
	err := c.cc.Invoke(ctx, EnvironmentService_UndeleteEnvironment_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
