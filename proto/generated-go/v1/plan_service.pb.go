...
var file_v1_plan_service_proto_rawDesc = []byte{
	...
	0x45, 0x4c, 0x45, 0x44, 0x10, 0x04, 0x4a, 0x04, 0x08, 0x02, 0x10, 0x03, 0x32, 0xce, 0x0b, 0x0a,
	...
	0x74, 0x63, 0x68, 0x43, 0x61, 0x6e, 0x63, 0x65, 0x6c, 0x12, 0x81, 0x01, 0x0a, 0x0b, 0x50, 0x72,
	0x65, 0x76, 0x69, 0x65, 0x77, 0x50, 0x6c, 0x61, 0x6e, 0x12, 0x1f, 0x2e, 0x62, 0x79, 0x74, 0x65,
	0x62, 0x61, 0x73, 0x65, 0x2e, 0x76, 0x31, 0x2e, 0x50, 0x72, 0x65, 0x76, 0x69, 0x65, 0x77, 0x50,
	0x6c, 0x61, 0x6e, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x20, 0x2e, 0x62, 0x79, 0x74,
	...
	0x7d, 0x3a, 0x70, 0x72, 0x65, 0x76, 0x69, 0x65, 0x77, 0x50, 0x6c, 0x61, 0x6e, 0x42, 0x11, 0x5a,
...
var file_v1_plan_service_proto_goTypes = []any{
	...
	(VCSType)(0),                                            // 40: bytebase.v1.VCSType
	(*ChangedResources)(nil),                                // 41: bytebase.v1.ChangedResources
	(*Position)(nil),                                        // 42: bytebase.v1.Position
}
var file_v1_plan_service_proto_depIdxs = []int32{
	...
	30, // 25: bytebase.v1.Plan.CreateDatabaseConfig.labels:type_name -> bytebase.v1.Plan.CreateDatabaseConfig.LabelsEntry
	0,  // 26: bytebase.v1.Plan.ChangeDatabaseConfig.type:type_name -> bytebase.v1.Plan.ChangeDatabaseConfig.Type
	31, // 27: bytebase.v1.Plan.ChangeDatabaseConfig.ghost_flags:type_name -> bytebase.v1.Plan.ChangeDatabaseConfig.GhostFlagsEntry
	32, // 28: bytebase.v1.Plan.ChangeDatabaseConfig.pre_update_backup_detail:type_name -> bytebase.v1.Plan.ChangeDatabaseConfig.PreUpdateBackupDetail
	39, // 29: bytebase.v1.Plan.ExportDataConfig.format:type_name -> bytebase.v1.ExportFormat
	40, // 30: bytebase.v1.Plan.VCSSource.vcs_type:type_name -> bytebase.v1.VCSType
	3,  // 31: bytebase.v1.PlanCheckRun.Result.status:type_name -> bytebase.v1.PlanCheckRun.Result.Status
	35, // 32: bytebase.v1.PlanCheckRun.Result.sql_summary_report:type_name -> bytebase.v1.PlanCheckRun.Result.SqlSummaryReport
	36, // 33: bytebase.v1.PlanCheckRun.Result.sql_review_report:type_name -> bytebase.v1.PlanCheckRun.Result.SqlReviewReport
	41, // 34: bytebase.v1.PlanCheckRun.Result.SqlSummaryReport.changed_resources:type_name -> bytebase.v1.ChangedResources
	42, // 35: bytebase.v1.PlanCheckRun.Result.SqlReviewReport.start_position:type_name -> bytebase.v1.Position
	42, // 36: bytebase.v1.PlanCheckRun.Result.SqlReviewReport.end_position:type_name -> bytebase.v1.Position
	4,  // 37: bytebase.v1.PlanService.GetPlan:input_type -> bytebase.v1.GetPlanRequest
	5,  // 38: bytebase.v1.PlanService.ListPlans:input_type -> bytebase.v1.ListPlansRequest
	7,  // 39: bytebase.v1.PlanService.SearchPlans:input_type -> bytebase.v1.SearchPlansRequest
	9,  // 40: bytebase.v1.PlanService.CreatePlan:input_type -> bytebase.v1.CreatePlanRequest
	10, // 41: bytebase.v1.PlanService.UpdatePlan:input_type -> bytebase.v1.UpdatePlanRequest
	12, // 42: bytebase.v1.PlanService.ListPlanCheckRuns:input_type -> bytebase.v1.ListPlanCheckRunsRequest
	14, // 43: bytebase.v1.PlanService.RunPlanChecks:input_type -> bytebase.v1.RunPlanChecksRequest
	16, // 44: bytebase.v1.PlanService.BatchCancelPlanCheckRuns:input_type -> bytebase.v1.BatchCancelPlanCheckRunsRequest
	18, // 45: bytebase.v1.PlanService.PreviewPlan:input_type -> bytebase.v1.PreviewPlanRequest
	11, // 46: bytebase.v1.PlanService.GetPlan:output_type -> bytebase.v1.Plan
	6,  // 47: bytebase.v1.PlanService.ListPlans:output_type -> bytebase.v1.ListPlansResponse
	8,  // 48: bytebase.v1.PlanService.SearchPlans:output_type -> bytebase.v1.SearchPlansResponse
	11, // 49: bytebase.v1.PlanService.CreatePlan:output_type -> bytebase.v1.Plan
	11, // 50: bytebase.v1.PlanService.UpdatePlan:output_type -> bytebase.v1.Plan
	13, // 51: bytebase.v1.PlanService.ListPlanCheckRuns:output_type -> bytebase.v1.ListPlanCheckRunsResponse
	15, // 52: bytebase.v1.PlanService.RunPlanChecks:output_type -> bytebase.v1.RunPlanChecksResponse
	17, // 53: bytebase.v1.PlanService.BatchCancelPlanCheckRuns:output_type -> bytebase.v1.BatchCancelPlanCheckRunsResponse
	19, // 54: bytebase.v1.PlanService.PreviewPlan:output_type -> bytebase.v1.PreviewPlanResponse
