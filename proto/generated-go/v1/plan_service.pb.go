...
var file_v1_plan_service_proto_rawDesc = []byte{
	...
	0x6c, 0x6c, 0x6f, 0x77, 0x4f, 0x75, 0x74, 0x4f, 0x66, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x22, 0xa6,
	0x01, 0x0a, 0x13, 0x50, 0x72, 0x65, 0x76, 0x69, 0x65, 0x77, 0x50, 0x6c, 0x61, 0x6e, 0x52, 0x65,
	...
	,
	...
	0x44, 0x10, 0x04, 0x4a, 0x04, 0x08, 0x02, 0x10, 0x03, 0x32, 0xce, 0x0b, 0x0a, 0x0b, 0x50, 0x6c,
	...
	0x43, 0x61, 0x6e, 0x63, 0x65, 0x6c, 0x12, 0x81, 0x01, 0x0a, 0x0b, 0x50, 0x72, 0x65, 0x76, 0x69,
	...
	0x72, 0x65, 0x76, 0x69, 0x65, 0x77, 0x50, 0x6c, 0x61, 0x6e, 0x42, 0x11, 0x5a, 0x0f, 0x67, 0x65,
...
var file_v1_plan_service_proto_goTypes = []any{
	...
	(VCSType)(0),                                            // 39: bytebase.v1.VCSType
...
var file_v1_plan_service_proto_depIdxs = []int32{
	...
	37, // 7: bytebase.v1.Plan.create_time:type_name -> google.protobuf.Timestamp
	37, // 8: bytebase.v1.Plan.update_time:type_name -> google.protobuf.Timestamp
	...
	33, // 15: bytebase.v1.PlanCheckRun.results:type_name -> bytebase.v1.PlanCheckRun.Result
	37, // 16: bytebase.v1.PlanCheckRun.create_time:type_name -> google.protobuf.Timestamp
	22, // 17: bytebase.v1.Plan.Step.specs:type_name -> bytebase.v1.Plan.Spec
	37, // 18: bytebase.v1.Plan.Spec.earliest_allowed_time:type_name -> google.protobuf.Timestamp
	29, // 19: bytebase.v1.Plan.Spec.spec_release_source:type_name -> bytebase.v1.Plan.SpecReleaseSource
	24, // 20: bytebase.v1.Plan.Spec.create_database_config:type_name -> bytebase.v1.Plan.CreateDatabaseConfig
	25, // 21: bytebase.v1.Plan.Spec.change_database_config:type_name -> bytebase.v1.Plan.ChangeDatabaseConfig
	26, // 22: bytebase.v1.Plan.Spec.export_data_config:type_name -> bytebase.v1.Plan.ExportDataConfig
	30, // 23: bytebase.v1.Plan.CreateDatabaseConfig.labels:type_name -> bytebase.v1.Plan.CreateDatabaseConfig.LabelsEntry
	0,  // 24: bytebase.v1.Plan.ChangeDatabaseConfig.type:type_name -> bytebase.v1.Plan.ChangeDatabaseConfig.Type
	31, // 25: bytebase.v1.Plan.ChangeDatabaseConfig.ghost_flags:type_name -> bytebase.v1.Plan.ChangeDatabaseConfig.GhostFlagsEntry
	32, // 26: bytebase.v1.Plan.ChangeDatabaseConfig.pre_update_backup_detail:type_name -> bytebase.v1.Plan.ChangeDatabaseConfig.PreUpdateBackupDetail
	38, // 27: bytebase.v1.Plan.ExportDataConfig.format:type_name -> bytebase.v1.ExportFormat
	39, // 28: bytebase.v1.Plan.VCSSource.vcs_type:type_name -> bytebase.v1.VCSType
	3,  // 29: bytebase.v1.PlanCheckRun.Result.status:type_name -> bytebase.v1.PlanCheckRun.Result.Status
	34, // 30: bytebase.v1.PlanCheckRun.Result.sql_summary_report:type_name -> bytebase.v1.PlanCheckRun.Result.SqlSummaryReport
	35, // 31: bytebase.v1.PlanCheckRun.Result.sql_review_report:type_name -> bytebase.v1.PlanCheckRun.Result.SqlReviewReport
