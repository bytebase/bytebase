...
const file_v1_user_service_proto_rawDesc = "" +
	...
	"\x10StatUsersRequest\"\xd2\x01\n" +
	"\x11StatUsersResponse\x12=\n" +
	"\x05stats\x18\x01 \x03(\v2'.bytebase.v1.StatUsersResponse.StatUserR\x05stats\x1a~\n" +
	"\bStatUser\x122\n" +
	...
	"\x0fSERVICE_ACCOUNT\x10\x032\xa6\x06\n" +
	"\vUserService\x12`\n" +
	...
	"\tListUsers\x12\x1d.bytebase.v1.ListUsersRequest\x1a\x1e.bytebase.v1.ListUsersResponse\"\x1e\xdaA\x06parent\x90\xea0\x02\x82\xd3\xe4\x93\x02\v\x12\t/v1/users\x12r\n" +
	"\tStatUsers\x12\x1d.bytebase.v1.StatUsersRequest\x1a\x1e.bytebase.v1.StatUsersResponse\"&\xdaA\x06parent\x90\xea0\x02\x82\xd3\xe4\x93\x02\x13:\x01*\"\x0e/v1/users:stat\x12k\n" +
	"\n" +
