...
type Project struct {
	...
	Workflow       Workflow      `protobuf:"varint,4,opt,name=workflow,proto3,enum=bytebase.v1.Workflow" json:"workflow,omitempty"`
	Visibility     Visibility    `protobuf:"varint,5,opt,name=visibility,proto3,enum=bytebase.v1.Visibility" json:"visibility,omitempty"`
	TenantMode     TenantMode    `protobuf:"varint,6,opt,name=tenant_mode,json=tenantMode,proto3,enum=bytebase.v1.TenantMode" json:"tenant_mode,omitempty"`
	DbNameTemplate string        `protobuf:"bytes,7,opt,name=db_name_template,json=dbNameTemplate,proto3" json:"db_name_template,omitempty"`
	RoleProvider   RoleProvider  `protobuf:"varint,8,opt,name=role_provider,json=roleProvider,proto3,enum=bytebase.v1.RoleProvider" json:"role_provider,omitempty"`
	SchemaVersion  SchemaVersion `protobuf:"varint,9,opt,name=schema_version,json=schemaVersion,proto3,enum=bytebase.v1.SchemaVersion" json:"schema_version,omitempty"`
	...
	LgtmCheck      LgtmCheck     `protobuf:"varint,11,opt,name=lgtm_check,json=lgtmCheck,proto3,enum=bytebase.v1.LgtmCheck" json:"lgtm_check,omitempty"`
}
...
var file_v1_project_service_proto_rawDesc = []byte{
	...
	0x6e, 0x61, 0x6d, 0x65, 0x22, 0x8f, 0x04, 0x0a, 0x07, 0x50, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74,
	...
	0x79, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x6b, 0x65, 0x79, 0x12, 0x31, 0x0a, 0x08,
	0x77, 0x6f, 0x72, 0x6b, 0x66, 0x6c, 0x6f, 0x77, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x15,
	...
	0x6e, 0x74, 0x5f, 0x6d, 0x6f, 0x64, 0x65, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x17, 0x2e,
	...
	0x6d, 0x70, 0x6c, 0x61, 0x74, 0x65, 0x18, 0x07, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0e, 0x64, 0x62,
	0x4e, 0x61, 0x6d, 0x65, 0x54, 0x65, 0x6d, 0x70, 0x6c, 0x61, 0x74, 0x65, 0x12, 0x3e, 0x0a, 0x0d,
	0x72, 0x6f, 0x6c, 0x65, 0x5f, 0x70, 0x72, 0x6f, 0x76, 0x69, 0x64, 0x65, 0x72, 0x18, 0x08, 0x20,
	0x01, 0x28, 0x0e, 0x32, 0x19, 0x2e, 0x62, 0x79, 0x74, 0x65, 0x62, 0x61, 0x73, 0x65, 0x2e, 0x76,
	0x31, 0x2e, 0x52, 0x6f, 0x6c, 0x65, 0x50, 0x72, 0x6f, 0x76, 0x69, 0x64, 0x65, 0x72, 0x52, 0x0c,
	0x72, 0x6f, 0x6c, 0x65, 0x50, 0x72, 0x6f, 0x76, 0x69, 0x64, 0x65, 0x72, 0x12, 0x41, 0x0a, 0x0e,
	...
	0x35, 0x0a, 0x0a, 0x6c, 0x67, 0x74, 0x6d, 0x5f, 0x63, 0x68, 0x65, 0x63, 0x6b, 0x18, 0x0b, 0x20,
	...
	0x6d, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x2a, 0x47, 0x0a, 0x08, 0x57, 0x6f, 0x72, 0x6b, 0x66, 0x6c,
	...
	0x57, 0x4f, 0x52, 0x4b, 0x46, 0x4c, 0x4f, 0x57, 0x5f, 0x55, 0x49, 0x10, 0x01, 0x12, 0x10, 0x0a,
	0x0c, 0x57, 0x4f, 0x52, 0x4b, 0x46, 0x4c, 0x4f, 0x57, 0x5f, 0x56, 0x43, 0x53, 0x10, 0x02, 0x2a,
	...
	0x42, 0x4c, 0x45, 0x44, 0x10, 0x02, 0x2a, 0x8b, 0x01, 0x0a, 0x0c, 0x52, 0x6f, 0x6c, 0x65, 0x50,
	...
	0x46, 0x49, 0x45, 0x44, 0x10, 0x00, 0x12, 0x1a, 0x0a, 0x16, 0x52, 0x4f, 0x4c, 0x45, 0x5f, 0x50,
	0x52, 0x4f, 0x56, 0x49, 0x44, 0x45, 0x52, 0x5f, 0x42, 0x59, 0x54, 0x45, 0x42, 0x41, 0x53, 0x45,
	0x10, 0x01, 0x12, 0x22, 0x0a, 0x1e, 0x52, 0x4f, 0x4c, 0x45, 0x5f, 0x50, 0x52, 0x4f, 0x56, 0x49,
	0x44, 0x45, 0x52, 0x5f, 0x47, 0x49, 0x54, 0x4c, 0x41, 0x42, 0x5f, 0x53, 0x45, 0x4c, 0x46, 0x5f,
	0x48, 0x4f, 0x53, 0x54, 0x10, 0x02, 0x12, 0x1c, 0x0a, 0x18, 0x52, 0x4f, 0x4c, 0x45, 0x5f, 0x50,
	0x52, 0x4f, 0x56, 0x49, 0x44, 0x45, 0x52, 0x5f, 0x47, 0x49, 0x54, 0x48, 0x55, 0x42, 0x5f, 0x43,
	0x4f, 0x4d, 0x10, 0x03, 0x2a, 0x6a, 0x0a, 0x0d, 0x53, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x56, 0x65,
	...
	,
	...
	0x45, 0x43, 0x54, 0x5f, 0x4d, 0x45, 0x4d, 0x42, 0x45, 0x52, 0x10, 0x03, 0x32, 0xd0, 0x05, 0x0a,
	...
	0x02, 0x17, 0x12, 0x15, 0x2f, 0x76, 0x32, 0x2f, 0x7b, 0x6e, 0x61, 0x6d, 0x65, 0x3d, 0x70, 0x72,
	...
	0xda, 0x41, 0x00, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x0e, 0x12, 0x0c, 0x2f, 0x76, 0x32, 0x2f, 0x70,
	0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x73, 0x12, 0x6a, 0x0a, 0x0d, 0x43, 0x72, 0x65, 0x61, 0x74,
	...
	0x6f, 0x6a, 0x65, 0x63, 0x74, 0x22, 0x0c, 0x2f, 0x76, 0x32, 0x2f, 0x70, 0x72, 0x6f, 0x6a, 0x65,
	...
	0x6f, 0x6a, 0x65, 0x63, 0x74, 0x32, 0x1d, 0x2f, 0x76, 0x32, 0x2f, 0x7b, 0x70, 0x72, 0x6f, 0x6a,
	...
	0x15, 0x2f, 0x76, 0x32, 0x2f, 0x7b, 0x6e, 0x61, 0x6d, 0x65, 0x3d, 0x70, 0x72, 0x6f, 0x6a, 0x65,
	...
	0x63, 0x74, 0x73, 0x2f, 0x2a, 0x7d, 0x3a, 0x75, 0x6e, 0x64, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x42,
...
var file_v1_project_service_proto_depIdxs = []int32{
	...
	0,  // 4: bytebase.v1.Project.workflow:type_name -> bytebase.v1.Workflow
	1,  // 5: bytebase.v1.Project.visibility:type_name -> bytebase.v1.Visibility
	2,  // 6: bytebase.v1.Project.tenant_mode:type_name -> bytebase.v1.TenantMode
	3,  // 7: bytebase.v1.Project.role_provider:type_name -> bytebase.v1.RoleProvider
	4,  // 8: bytebase.v1.Project.schema_version:type_name -> bytebase.v1.SchemaVersion
	5,  // 9: bytebase.v1.Project.schema_change:type_name -> bytebase.v1.SchemaChange
	6,  // 10: bytebase.v1.Project.lgtm_check:type_name -> bytebase.v1.LgtmCheck
	7,  // 11: bytebase.v1.ProjectService.GetProject:input_type -> bytebase.v1.GetProjectRequest
	8,  // 12: bytebase.v1.ProjectService.ListProjects:input_type -> bytebase.v1.ListProjectsRequest
	10, // 13: bytebase.v1.ProjectService.CreateProject:input_type -> bytebase.v1.CreateProjectRequest
	11, // 14: bytebase.v1.ProjectService.UpdateProject:input_type -> bytebase.v1.UpdateProjectRequest
	12, // 15: bytebase.v1.ProjectService.DeleteProject:input_type -> bytebase.v1.DeleteProjectRequest
	13, // 16: bytebase.v1.ProjectService.UndeleteProject:input_type -> bytebase.v1.UndeleteProjectRequest
	14, // 17: bytebase.v1.ProjectService.GetProject:output_type -> bytebase.v1.Project
	9,  // 18: bytebase.v1.ProjectService.ListProjects:output_type -> bytebase.v1.ListProjectsResponse
	14, // 19: bytebase.v1.ProjectService.CreateProject:output_type -> bytebase.v1.Project
	14, // 20: bytebase.v1.ProjectService.UpdateProject:output_type -> bytebase.v1.Project
	16, // 21: bytebase.v1.ProjectService.DeleteProject:output_type -> google.protobuf.Empty
	14, // 22: bytebase.v1.ProjectService.UndeleteProject:output_type -> bytebase.v1.Project
