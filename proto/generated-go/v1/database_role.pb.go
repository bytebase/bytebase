...
// DatabaseRoleList is the API message for role list.
type DatabaseRoleList struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	RoleList []*DatabaseRole `protobuf:"bytes,1,rep,name=role_list,json=roleList,proto3" json:"role_list,omitempty"`
}

func (x *DatabaseRoleList) Reset() {
	*x = DatabaseRoleList{}
	if protoimpl.UnsafeEnabled {
...
func (x *DatabaseRoleList) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DatabaseRoleList) ProtoMessage() {}

func (x *DatabaseRoleList) ProtoReflect() protoreflect.Message {
	mi := &file_v1_database_role_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DatabaseRoleList.ProtoReflect.Descriptor instead.
func (*DatabaseRoleList) Descriptor() ([]byte, []int) {
	return file_v1_database_role_proto_rawDescGZIP(), []int{2}
}

func (x *DatabaseRoleList) GetRoleList() []*DatabaseRole {
	if x != nil {
		return x.RoleList
	}
	return nil
...
func (x *DatabaseRoleUpsert) Reset() {
	*x = DatabaseRoleUpsert{}
	if protoimpl.UnsafeEnabled {
		mi := &file_v1_database_role_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*DatabaseRoleUpsert) Descriptor() ([]byte, []int) {
	return file_v1_database_role_proto_rawDescGZIP(), []int{3}
}
...
var file_v1_database_role_proto_rawDesc = []byte{
	...
	0x69, 0x6c, 0x22, 0x4a, 0x0a, 0x10, 0x44, 0x61, 0x74, 0x61, 0x62, 0x61, 0x73, 0x65, 0x52, 0x6f,
	0x6c, 0x65, 0x4c, 0x69, 0x73, 0x74, 0x12, 0x36, 0x0a, 0x09, 0x72, 0x6f, 0x6c, 0x65, 0x5f, 0x6c,
	0x69, 0x73, 0x74, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x19, 0x2e, 0x62, 0x79, 0x74, 0x65,
	0x62, 0x61, 0x73, 0x65, 0x2e, 0x76, 0x31, 0x2e, 0x44, 0x61, 0x74, 0x61, 0x62, 0x61, 0x73, 0x65,
	0x52, 0x6f, 0x6c, 0x65, 0x52, 0x08, 0x72, 0x6f, 0x6c, 0x65, 0x4c, 0x69, 0x73, 0x74, 0x22, 0xa6,
	0x02, 0x0a, 0x12, 0x44, 0x61, 0x74, 0x61, 0x62, 0x61, 0x73, 0x65, 0x52, 0x6f, 0x6c, 0x65, 0x55,
	...
	,
...
var file_v1_database_role_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_v1_database_role_proto_goTypes = []interface{}{
	...
	(*DatabaseRoleList)(nil),      // 2: bytebase.v1.DatabaseRoleList
	(*DatabaseRoleUpsert)(nil),    // 3: bytebase.v1.DatabaseRoleUpsert
}
var file_v1_database_role_proto_depIdxs = []int32{
	...
	1, // 1: bytebase.v1.DatabaseRoleList.role_list:type_name -> bytebase.v1.DatabaseRole
	0, // 2: bytebase.v1.DatabaseRoleUpsert.attribute:type_name -> bytebase.v1.DatabaseRoleAttribute
...
func file_v1_database_role_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_v1_database_role_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
	...
	file_v1_database_role_proto_msgTypes[3].OneofWrappers = []interface{}{}
	type x struct{}
