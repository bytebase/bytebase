...
func (Release_File_Type) EnumDescriptor() ([]byte, []int) {
	return file_v1_release_service_proto_rawDescGZIP(), []int{3, 0, 0}
}
...
func (x *Release_File) GetSheetHash() []byte {
	if x != nil {
		return x.SheetHash
	}
	return nil
...
func (*Release_VCSSource) Descriptor() ([]byte, []int) {
	return file_v1_release_service_proto_rawDescGZIP(), []int{3, 1}
}
...
var file_v1_release_service_proto_rawDesc = []byte{
	...
	0x22, 0xe3, 0x03, 0x0a, 0x07, 0x52, 0x65, 0x6c, 0x65, 0x61, 0x73, 0x65, 0x12, 0x12, 0x0a, 0x04,
	0x6e, 0x61, 0x6d, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65,
	0x12, 0x2f, 0x0a, 0x05, 0x66, 0x69, 0x6c, 0x65, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32,
	...
	0x1a, 0xeb, 0x01, 0x0a, 0x04, 0x46, 0x69, 0x6c, 0x65, 0x12, 0x1a, 0x0a, 0x08, 0x66, 0x69, 0x6c,
	0x65, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x66, 0x69, 0x6c,
	0x65, 0x6e, 0x61, 0x6d, 0x65, 0x12, 0x2d, 0x0a, 0x05, 0x73, 0x68, 0x65, 0x65, 0x74, 0x18, 0x02,
	...
	0x68, 0x65, 0x65, 0x74, 0x12, 0x1d, 0x0a, 0x0a, 0x73, 0x68, 0x65, 0x65, 0x74, 0x5f, 0x68, 0x61,
	0x73, 0x68, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x09, 0x73, 0x68, 0x65, 0x65, 0x74, 0x48,
	0x61, 0x73, 0x68, 0x12, 0x32, 0x0a, 0x04, 0x74, 0x79, 0x70, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28,
	...
	0x65, 0x73, 0x74, 0x55, 0x72, 0x6c, 0x32, 0x8e, 0x02, 0x0a, 0x0e, 0x52, 0x65, 0x6c, 0x65, 0x61,
	...
	0x65, 0x6c, 0x65, 0x61, 0x73, 0x65, 0x73, 0x42, 0x11, 0x5a, 0x0f, 0x67, 0x65, 0x6e, 0x65, 0x72,
...
var file_v1_release_service_proto_goTypes = []any{
	...
	(*Release_File)(nil),         // 5: bytebase.v1.Release.File
	(*Release_VCSSource)(nil),    // 6: bytebase.v1.Release.VCSSource
	(VCSType)(0),                 // 7: bytebase.v1.VCSType
}
var file_v1_release_service_proto_depIdxs = []int32{
	...
	5, // 1: bytebase.v1.Release.files:type_name -> bytebase.v1.Release.File
	6, // 2: bytebase.v1.Release.vcs_source:type_name -> bytebase.v1.Release.VCSSource
	0, // 3: bytebase.v1.Release.File.type:type_name -> bytebase.v1.Release.File.Type
	7, // 4: bytebase.v1.Release.VCSSource.vcs_type:type_name -> bytebase.v1.VCSType
	1, // 5: bytebase.v1.ReleaseService.GetRelease:input_type -> bytebase.v1.GetReleaseRequest
	2, // 6: bytebase.v1.ReleaseService.ListReleases:input_type -> bytebase.v1.ListReleasesRequest
	4, // 7: bytebase.v1.ReleaseService.GetRelease:output_type -> bytebase.v1.Release
	3, // 8: bytebase.v1.ReleaseService.ListReleases:output_type -> bytebase.v1.ListReleasesResponse
