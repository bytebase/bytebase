...
type CheckRequest_ChangeDatabaseType int32

const (
	CheckRequest_CHANGE_DATABASE_TYPE_UNSPECIFIED CheckRequest_ChangeDatabaseType = 0
	CheckRequest_DDL                              CheckRequest_ChangeDatabaseType = 1
	CheckRequest_DML                              CheckRequest_ChangeDatabaseType = 2
	CheckRequest_SDL                              CheckRequest_ChangeDatabaseType = 3
)

// Enum value maps for CheckRequest_ChangeDatabaseType.
var (
	CheckRequest_ChangeDatabaseType_name = map[int32]string{
		0: "CHANGE_DATABASE_TYPE_UNSPECIFIED",
		1: "DDL",
		2: "DML",
		3: "SDL",
	}
	CheckRequest_ChangeDatabaseType_value = map[string]int32{
...
func (x CheckRequest_ChangeDatabaseType) Enum() *CheckRequest_ChangeDatabaseType {
	p := new(CheckRequest_ChangeDatabaseType)
	*p = x
	return p
}

func (x CheckRequest_ChangeDatabaseType) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (CheckRequest_ChangeDatabaseType) Descriptor() protoreflect.EnumDescriptor {
	return file_v1_sql_service_proto_enumTypes[1].Descriptor()
}

func (CheckRequest_ChangeDatabaseType) Type() protoreflect.EnumType {
	return &file_v1_sql_service_proto_enumTypes[1]
}

func (x CheckRequest_ChangeDatabaseType) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use CheckRequest_ChangeDatabaseType.Descriptor instead.
func (CheckRequest_ChangeDatabaseType) EnumDescriptor() ([]byte, []int) {
...
type CheckRequest struct {
	...
	ChangeDatabaseType CheckRequest_ChangeDatabaseType `protobuf:"varint,3,opt,name=change_database_type,json=changeDatabaseType,proto3,enum=bytebase.v1.CheckRequest_ChangeDatabaseType" json:"change_database_type,omitempty"`
...
func (x *CheckRequest) GetEngine() Engine {
	if x != nil {
		return x.Engine
	}
	return Engine_ENGINE_UNSPECIFIED
...
func (x *CheckRequest) GetChangeDatabaseType() CheckRequest_ChangeDatabaseType {
	if x != nil {
		return x.ChangeDatabaseType
	}
	return CheckRequest_CHANGE_DATABASE_TYPE_UNSPECIFIED
}
...
type CheckResponse struct {
	...
	Runs []*CheckResponse_Run `protobuf:"bytes,1,rep,name=runs,proto3" json:"runs,omitempty"`
}
...
func (x *CheckResponse) GetRuns() []*CheckResponse_Run {
	if x != nil {
		return x.Runs
	}
	return nil
...
type CheckResponse_Run struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Type    PlanCheckRun_Type      `protobuf:"varint,1,opt,name=type,proto3,enum=bytebase.v1.PlanCheckRun_Type" json:"type,omitempty"`
	Results []*PlanCheckRun_Result `protobuf:"bytes,2,rep,name=results,proto3" json:"results,omitempty"`
	Error   string                 `protobuf:"bytes,3,opt,name=error,proto3" json:"error,omitempty"`
}

func (x *CheckResponse_Run) Reset() {
	*x = CheckResponse_Run{}
	if protoimpl.UnsafeEnabled {
...
func (x *CheckResponse_Run) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CheckResponse_Run) ProtoMessage() {}

func (x *CheckResponse_Run) ProtoReflect() protoreflect.Message {
	mi := &file_v1_sql_service_proto_msgTypes[16]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CheckResponse_Run.ProtoReflect.Descriptor instead.
func (*CheckResponse_Run) Descriptor() ([]byte, []int) {
	return file_v1_sql_service_proto_rawDescGZIP(), []int{15, 0}
}

func (x *CheckResponse_Run) GetType() PlanCheckRun_Type {
	if x != nil {
		return x.Type
	}
...
func (x *CheckResponse_Run) GetResults() []*PlanCheckRun_Result {
	if x != nil {
		return x.Results
	}
	return nil
...
func (x *CheckResponse_Run) GetError() string {
	if x != nil {
		return x.Error
	}
	return ""
...
var file_v1_sql_service_proto_rawDesc = []byte{
	...
	0x2f, 0x72, 0x6f, 0x6c, 0x6c, 0x6f, 0x75, 0x74, 0x5f, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65,
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xa4, 0x01, 0x0a, 0x14, 0x44, 0x69, 0x66, 0x66, 0x65,
	...
	0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x73, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x22, 0xc3,
	0x01, 0x0a, 0x13, 0x41, 0x64, 0x6d, 0x69, 0x6e, 0x45, 0x78, 0x65, 0x63, 0x75, 0x74, 0x65, 0x52,
	0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x12, 0x0a, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x12, 0x2f, 0x0a, 0x13, 0x63, 0x6f,
	0x6e, 0x6e, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x64, 0x61, 0x74, 0x61, 0x62, 0x61, 0x73,
	0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x12, 0x63, 0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74,
	...
	0x22, 0xd6, 0x01, 0x0a, 0x0d, 0x45, 0x78, 0x70, 0x6f, 0x72, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65,
	0x73, 0x74, 0x12, 0x17, 0x0a, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09,
	0x42, 0x03, 0xe0, 0x41, 0x02, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x12, 0x2f, 0x0a, 0x13, 0x63,
	0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x64, 0x61, 0x74, 0x61, 0x62, 0x61,
	0x73, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x12, 0x63, 0x6f, 0x6e, 0x6e, 0x65, 0x63,
	...
	0x28, 0x08, 0x52, 0x05, 0x61, 0x64, 0x6d, 0x69, 0x6e, 0x22, 0x2a, 0x0a, 0x0e, 0x45, 0x78, 0x70,
	...
	0x6e, 0x74, 0x65, 0x6e, 0x74, 0x22, 0xc1, 0x01, 0x0a, 0x0c, 0x51, 0x75, 0x65, 0x72, 0x79, 0x52,
	...
	0x2f, 0x0a, 0x13, 0x63, 0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x64, 0x61,
	0x74, 0x61, 0x62, 0x61, 0x73, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x12, 0x63, 0x6f,
	...
	0x69, 0x6d, 0x69, 0x74, 0x12, 0x33, 0x0a, 0x07, 0x74, 0x69, 0x6d, 0x65, 0x6f, 0x75, 0x74, 0x18,
	0x05, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x19, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x70,
	0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2e, 0x44, 0x75, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e,
	0x52, 0x07, 0x74, 0x69, 0x6d, 0x65, 0x6f, 0x75, 0x74, 0x22, 0x95, 0x01, 0x0a, 0x0d, 0x51, 0x75,
	...
	0x69, 0x6e, 0x64, 0x22, 0xf3, 0x01, 0x0a, 0x06, 0x41, 0x64, 0x76, 0x69, 0x63, 0x65, 0x12, 0x32,
	...
	0x20, 0x01, 0x28, 0x05, 0x52, 0x04, 0x6c, 0x69, 0x6e, 0x65, 0x12, 0x16, 0x0a, 0x06, 0x64, 0x65,
	0x74, 0x61, 0x69, 0x6c, 0x18, 0x06, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x64, 0x65, 0x74, 0x61,
	0x69, 0x6c, 0x22, 0x45, 0x0a, 0x06, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x16, 0x0a, 0x12,
	...
	0x0a, 0x05, 0x45, 0x52, 0x52, 0x4f, 0x52, 0x10, 0x03, 0x22, 0x8c, 0x01, 0x0a, 0x0d, 0x50, 0x72,
	...
	0x63, 0x74, 0x65, 0x64, 0x53, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x22, 0xac, 0x02, 0x0a, 0x0c, 0x43,
	...
	0x73, 0x74, 0x61, 0x74, 0x65, 0x6d, 0x65, 0x6e, 0x74, 0x12, 0x2b, 0x0a, 0x06, 0x65, 0x6e, 0x67,
	...
	,
	...
	0x12, 0x07, 0x0a, 0x03, 0x53, 0x44, 0x4c, 0x10, 0x03, 0x22, 0xd1, 0x01, 0x0a, 0x0d, 0x43, 0x68,
	0x65, 0x63, 0x6b, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x32, 0x0a, 0x04, 0x72,
	0x75, 0x6e, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1e, 0x2e, 0x62, 0x79, 0x74, 0x65,
	0x62, 0x61, 0x73, 0x65, 0x2e, 0x76, 0x31, 0x2e, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x52, 0x65, 0x73,
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x2e, 0x52, 0x75, 0x6e, 0x52, 0x04, 0x72, 0x75, 0x6e, 0x73, 0x1a,
	0x8b, 0x01, 0x0a, 0x03, 0x52, 0x75, 0x6e, 0x12, 0x32, 0x0a, 0x04, 0x74, 0x79, 0x70, 0x65, 0x18,
	...
	0x2e, 0x54, 0x79, 0x70, 0x65, 0x52, 0x04, 0x74, 0x79, 0x70, 0x65, 0x12, 0x3a, 0x0a, 0x07, 0x72,
	...
	0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x32, 0x87, 0x05,
	0x0a, 0x0a, 0x53, 0x51, 0x4c, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x5c, 0x0a, 0x06,
	...
	0x73, 0x71, 0x6c, 0x2f, 0x70, 0x72, 0x65, 0x74, 0x74, 0x79, 0x12, 0x67, 0x0a, 0x05, 0x51, 0x75,
	...
	0x02, 0x21, 0x3a, 0x01, 0x2a, 0x22, 0x1c, 0x2f, 0x76, 0x31, 0x2f, 0x7b, 0x6e, 0x61, 0x6d, 0x65,
	0x3d, 0x69, 0x6e, 0x73, 0x74, 0x61, 0x6e, 0x63, 0x65, 0x73, 0x2f, 0x2a, 0x7d, 0x3a, 0x71, 0x75,
	0x65, 0x72, 0x79, 0x12, 0x6b, 0x0a, 0x06, 0x45, 0x78, 0x70, 0x6f, 0x72, 0x74, 0x12, 0x1a, 0x2e,
	...
	0x01, 0x30, 0x01, 0x12, 0x78, 0x0a, 0x0d, 0x44, 0x69, 0x66, 0x66, 0x65, 0x72, 0x50, 0x72, 0x65,
	...
	0x64, 0x69, 0x66, 0x66, 0x65, 0x72, 0x50, 0x72, 0x65, 0x76, 0x69, 0x65, 0x77, 0x12, 0x58, 0x0a,
	...
	0x6c, 0x2f, 0x63, 0x68, 0x65, 0x63, 0x6b, 0x42, 0x11, 0x5a, 0x0f, 0x67, 0x65, 0x6e, 0x65, 0x72,
...
var file_v1_sql_service_proto_msgTypes = make([]protoimpl.MessageInfo, 17)
var file_v1_sql_service_proto_goTypes = []interface{}{
	(Advice_Status)(0),                   // 0: bytebase.v1.Advice.Status
	(CheckRequest_ChangeDatabaseType)(0), // 1: bytebase.v1.CheckRequest.ChangeDatabaseType
	...
	(*CheckResponse_Run)(nil),            // 18: bytebase.v1.CheckResponse.Run
	...
	(PlanCheckRun_Type)(0),               // 25: bytebase.v1.PlanCheckRun.Type
...
var file_v1_sql_service_proto_depIdxs = []int32{
	...
	19, // 15: bytebase.v1.CheckRequest.engine:type_name -> bytebase.v1.Engine
	1,  // 16: bytebase.v1.CheckRequest.change_database_type:type_name -> bytebase.v1.CheckRequest.ChangeDatabaseType
	18, // 17: bytebase.v1.CheckResponse.runs:type_name -> bytebase.v1.CheckResponse.Run
	25, // 18: bytebase.v1.CheckResponse.Run.type:type_name -> bytebase.v1.PlanCheckRun.Type
	26, // 19: bytebase.v1.CheckResponse.Run.results:type_name -> bytebase.v1.PlanCheckRun.Result
	14, // 20: bytebase.v1.SQLService.Pretty:input_type -> bytebase.v1.PrettyRequest
	8,  // 21: bytebase.v1.SQLService.Query:input_type -> bytebase.v1.QueryRequest
	6,  // 22: bytebase.v1.SQLService.Export:input_type -> bytebase.v1.ExportRequest
	4,  // 23: bytebase.v1.SQLService.AdminExecute:input_type -> bytebase.v1.AdminExecuteRequest
	2,  // 24: bytebase.v1.SQLService.DifferPreview:input_type -> bytebase.v1.DifferPreviewRequest
	16, // 25: bytebase.v1.SQLService.Check:input_type -> bytebase.v1.CheckRequest
	15, // 26: bytebase.v1.SQLService.Pretty:output_type -> bytebase.v1.PrettyResponse
	9,  // 27: bytebase.v1.SQLService.Query:output_type -> bytebase.v1.QueryResponse
	7,  // 28: bytebase.v1.SQLService.Export:output_type -> bytebase.v1.ExportResponse
	5,  // 29: bytebase.v1.SQLService.AdminExecute:output_type -> bytebase.v1.AdminExecuteResponse
	3,  // 30: bytebase.v1.SQLService.DifferPreview:output_type -> bytebase.v1.DifferPreviewResponse
	17, // 31: bytebase.v1.SQLService.Check:output_type -> bytebase.v1.CheckResponse
...
func file_v1_sql_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_v1_sql_service_proto_msgTypes[16].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CheckResponse_Run); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
