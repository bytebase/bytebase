...
var file_v1_sql_service_proto_rawDesc = []byte{
	...
	0x75, 0x6c, 0x74, 0x52, 0x07, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x73, 0x22, 0xaa, 0x02, 0x0a,
	...
	0x5f, 0x74, 0x69, 0x6d, 0x65, 0x6f, 0x75, 0x74, 0x42, 0x09, 0x0a, 0x07, 0x5f, 0x73, 0x63, 0x68,
	0x65, 0x6d, 0x61, 0x4a, 0x04, 0x08, 0x02, 0x10, 0x03, 0x22, 0x95, 0x01, 0x0a, 0x0d, 0x51, 0x75,
	0x65, 0x72, 0x79, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x32, 0x0a, 0x07, 0x72,
	...
	0x2d, 0x0a, 0x07, 0x61, 0x64, 0x76, 0x69, 0x63, 0x65, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b,
	0x32, 0x13, 0x2e, 0x62, 0x79, 0x74, 0x65, 0x62, 0x61, 0x73, 0x65, 0x2e, 0x76, 0x31, 0x2e, 0x41,
	0x64, 0x76, 0x69, 0x63, 0x65, 0x52, 0x07, 0x61, 0x64, 0x76, 0x69, 0x63, 0x65, 0x73, 0x12, 0x21,
	0x0a, 0x0c, 0x61, 0x6c, 0x6c, 0x6f, 0x77, 0x5f, 0x65, 0x78, 0x70, 0x6f, 0x72, 0x74, 0x18, 0x03,
	0x20, 0x01, 0x28, 0x08, 0x52, 0x0b, 0x61, 0x6c, 0x6c, 0x6f, 0x77, 0x45, 0x78, 0x70, 0x6f, 0x72,
	0x74, 0x22, 0x89, 0x07, 0x0a, 0x0b, 0x51, 0x75, 0x65, 0x72, 0x79, 0x52, 0x65, 0x73, 0x75, 0x6c,
...
var file_v1_sql_service_proto_msgTypes = make([]protoimpl.MessageInfo, 25)
var file_v1_sql_service_proto_goTypes = []any{
	...
	(*QueryRequest)(nil),                 // 5: bytebase.v1.QueryRequest
	(*QueryResponse)(nil),                // 6: bytebase.v1.QueryResponse
	(*QueryResult)(nil),                  // 7: bytebase.v1.QueryResult
	(*QueryRow)(nil),                     // 8: bytebase.v1.QueryRow
	(*RowValue)(nil),                     // 9: bytebase.v1.RowValue
	(*Advice)(nil),                       // 10: bytebase.v1.Advice
	(*ExportRequest)(nil),                // 11: bytebase.v1.ExportRequest
	(*ExportResponse)(nil),               // 12: bytebase.v1.ExportResponse
	...
	(*ParseMyBatisMapperRequest)(nil),    // 17: bytebase.v1.ParseMyBatisMapperRequest
	(*ParseMyBatisMapperResponse)(nil),   // 18: bytebase.v1.ParseMyBatisMapperResponse
	(*StringifyMetadataRequest)(nil),     // 19: bytebase.v1.StringifyMetadataRequest
	(*StringifyMetadataResponse)(nil),    // 20: bytebase.v1.StringifyMetadataResponse
	...
	(*GenerateRestoreSQLRequest)(nil),    // 24: bytebase.v1.GenerateRestoreSQLRequest
	(*GenerateRestoreSQLResponse)(nil),   // 25: bytebase.v1.GenerateRestoreSQLResponse
...
var file_v1_sql_service_proto_depIdxs = []int32{
	28, // 0: bytebase.v1.AdminExecuteRequest.timeout:type_name -> google.protobuf.Duration
	7,  // 1: bytebase.v1.AdminExecuteResponse.results:type_name -> bytebase.v1.QueryResult
	28, // 2: bytebase.v1.QueryRequest.timeout:type_name -> google.protobuf.Duration
	7,  // 3: bytebase.v1.QueryResponse.results:type_name -> bytebase.v1.QueryResult
	10, // 4: bytebase.v1.QueryResponse.advices:type_name -> bytebase.v1.Advice
	8,  // 5: bytebase.v1.QueryResult.rows:type_name -> bytebase.v1.QueryRow
	28, // 6: bytebase.v1.QueryResult.latency:type_name -> google.protobuf.Duration
	26, // 7: bytebase.v1.QueryResult.postgres_error:type_name -> bytebase.v1.QueryResult.PostgresError
	9,  // 8: bytebase.v1.QueryRow.values:type_name -> bytebase.v1.RowValue
	29, // 9: bytebase.v1.RowValue.null_value:type_name -> google.protobuf.NullValue
	30, // 10: bytebase.v1.RowValue.value_value:type_name -> google.protobuf.Value
	31, // 11: bytebase.v1.RowValue.timestamp_value:type_name -> google.protobuf.Timestamp
	27, // 12: bytebase.v1.RowValue.timestamp_tz_value:type_name -> bytebase.v1.RowValue.TimestampTZ
	0,  // 13: bytebase.v1.Advice.status:type_name -> bytebase.v1.Advice.Status
	32, // 14: bytebase.v1.Advice.start_position:type_name -> bytebase.v1.Position
	32, // 15: bytebase.v1.Advice.end_position:type_name -> bytebase.v1.Position
	33, // 16: bytebase.v1.ExportRequest.format:type_name -> bytebase.v1.ExportFormat
	34, // 17: bytebase.v1.PrettyRequest.engine:type_name -> bytebase.v1.Engine
	35, // 18: bytebase.v1.CheckRequest.metadata:type_name -> bytebase.v1.DatabaseMetadata
	1,  // 19: bytebase.v1.CheckRequest.change_type:type_name -> bytebase.v1.CheckRequest.ChangeType
	10, // 20: bytebase.v1.CheckResponse.advices:type_name -> bytebase.v1.Advice
	35, // 21: bytebase.v1.StringifyMetadataRequest.metadata:type_name -> bytebase.v1.DatabaseMetadata
	34, // 22: bytebase.v1.StringifyMetadataRequest.engine:type_name -> bytebase.v1.Engine
	23, // 23: bytebase.v1.SearchQueryHistoriesResponse.query_histories:type_name -> bytebase.v1.QueryHistory
	31, // 24: bytebase.v1.QueryHistory.create_time:type_name -> google.protobuf.Timestamp
	28, // 25: bytebase.v1.QueryHistory.duration:type_name -> google.protobuf.Duration
	2,  // 26: bytebase.v1.QueryHistory.type:type_name -> bytebase.v1.QueryHistory.Type
	31, // 27: bytebase.v1.RowValue.TimestampTZ.timestamp:type_name -> google.protobuf.Timestamp
	5,  // 28: bytebase.v1.SQLService.Query:input_type -> bytebase.v1.QueryRequest
	3,  // 29: bytebase.v1.SQLService.AdminExecute:input_type -> bytebase.v1.AdminExecuteRequest
	21, // 30: bytebase.v1.SQLService.SearchQueryHistories:input_type -> bytebase.v1.SearchQueryHistoriesRequest
	11, // 31: bytebase.v1.SQLService.Export:input_type -> bytebase.v1.ExportRequest
	15, // 32: bytebase.v1.SQLService.Check:input_type -> bytebase.v1.CheckRequest
	17, // 33: bytebase.v1.SQLService.ParseMyBatisMapper:input_type -> bytebase.v1.ParseMyBatisMapperRequest
	13, // 34: bytebase.v1.SQLService.Pretty:input_type -> bytebase.v1.PrettyRequest
	19, // 35: bytebase.v1.SQLService.StringifyMetadata:input_type -> bytebase.v1.StringifyMetadataRequest
	24, // 36: bytebase.v1.SQLService.GenerateRestoreSQL:input_type -> bytebase.v1.GenerateRestoreSQLRequest
	6,  // 37: bytebase.v1.SQLService.Query:output_type -> bytebase.v1.QueryResponse
	4,  // 38: bytebase.v1.SQLService.AdminExecute:output_type -> bytebase.v1.AdminExecuteResponse
	22, // 39: bytebase.v1.SQLService.SearchQueryHistories:output_type -> bytebase.v1.SearchQueryHistoriesResponse
	12, // 40: bytebase.v1.SQLService.Export:output_type -> bytebase.v1.ExportResponse
	16, // 41: bytebase.v1.SQLService.Check:output_type -> bytebase.v1.CheckResponse
	18, // 42: bytebase.v1.SQLService.ParseMyBatisMapper:output_type -> bytebase.v1.ParseMyBatisMapperResponse
	14, // 43: bytebase.v1.SQLService.Pretty:output_type -> bytebase.v1.PrettyResponse
	20, // 44: bytebase.v1.SQLService.StringifyMetadata:output_type -> bytebase.v1.StringifyMetadataResponse
	25, // 45: bytebase.v1.SQLService.GenerateRestoreSQL:output_type -> bytebase.v1.GenerateRestoreSQLResponse
