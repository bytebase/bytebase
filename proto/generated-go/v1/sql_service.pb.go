...
func (ExportRequest_Format) EnumDescriptor() ([]byte, []int) {
	return file_v1_sql_service_proto_rawDescGZIP(), []int{0, 0}
}
...
var file_v1_sql_service_proto_rawDesc = []byte{
	...
	,
	...
	0x02, 0x22, 0x2a, 0x0a, 0x0e, 0x45, 0x78, 0x70, 0x6f, 0x72, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f,
	...
	0x02, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x12, 0x2f, 0x0a, 0x13, 0x63, 0x6f, 0x6e, 0x6e, 0x65,
	...
	0x04, 0x20, 0x01, 0x28, 0x05, 0x52, 0x05, 0x6c, 0x69, 0x6d, 0x69, 0x74, 0x22, 0x72, 0x0a, 0x0d,
	...
	0x22, 0xb5, 0x01, 0x0a, 0x0b, 0x51, 0x75, 0x65, 0x72, 0x79, 0x52, 0x65, 0x73, 0x75, 0x6c, 0x74,
	...
	0x09, 0x52, 0x05, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x22, 0x39, 0x0a, 0x08, 0x51, 0x75, 0x65, 0x72,
	...
	0x65, 0x64, 0x53, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x32, 0xc0, 0x02, 0x0a, 0x0a, 0x53, 0x51, 0x4c,
	...
	0x73, 0x2f, 0x2a, 0x7d, 0x3a, 0x65, 0x78, 0x70, 0x6f, 0x72, 0x74, 0x42, 0x11, 0x5a, 0x0f, 0x67,
...
var file_v1_sql_service_proto_msgTypes = make([]protoimpl.MessageInfo, 10)
var file_v1_sql_service_proto_goTypes = []interface{}{
	...
	(*ExportRequest)(nil),     // 2: bytebase.v1.ExportRequest
	(*ExportResponse)(nil),    // 3: bytebase.v1.ExportResponse
	(*QueryRequest)(nil),      // 4: bytebase.v1.QueryRequest
	(*QueryResponse)(nil),     // 5: bytebase.v1.QueryResponse
	(*QueryResult)(nil),       // 6: bytebase.v1.QueryResult
	(*QueryRow)(nil),          // 7: bytebase.v1.QueryRow
	(*RowValue)(nil),          // 8: bytebase.v1.RowValue
	(*Advice)(nil),            // 9: bytebase.v1.Advice
	(*PrettyRequest)(nil),     // 10: bytebase.v1.PrettyRequest
	(*PrettyResponse)(nil),    // 11: bytebase.v1.PrettyResponse
	(structpb.NullValue)(0),   // 12: google.protobuf.NullValue
	(*structpb.Value)(nil),    // 13: google.protobuf.Value
	(Engine)(0),               // 14: bytebase.v1.Engine
}
var file_v1_sql_service_proto_depIdxs = []int32{
	0,  // 0: bytebase.v1.ExportRequest.format:type_name -> bytebase.v1.ExportRequest.Format
	6,  // 1: bytebase.v1.QueryResponse.results:type_name -> bytebase.v1.QueryResult
	9,  // 2: bytebase.v1.QueryResponse.advices:type_name -> bytebase.v1.Advice
	7,  // 3: bytebase.v1.QueryResult.rows:type_name -> bytebase.v1.QueryRow
	8,  // 4: bytebase.v1.QueryRow.values:type_name -> bytebase.v1.RowValue
	12, // 5: bytebase.v1.RowValue.null_value:type_name -> google.protobuf.NullValue
	13, // 6: bytebase.v1.RowValue.value_value:type_name -> google.protobuf.Value
	1,  // 7: bytebase.v1.Advice.status:type_name -> bytebase.v1.Advice.Status
	14, // 8: bytebase.v1.PrettyRequest.engine:type_name -> bytebase.v1.Engine
	10, // 9: bytebase.v1.SQLService.Pretty:input_type -> bytebase.v1.PrettyRequest
	4,  // 10: bytebase.v1.SQLService.Query:input_type -> bytebase.v1.QueryRequest
	2,  // 11: bytebase.v1.SQLService.Export:input_type -> bytebase.v1.ExportRequest
	11, // 12: bytebase.v1.SQLService.Pretty:output_type -> bytebase.v1.PrettyResponse
	5,  // 13: bytebase.v1.SQLService.Query:output_type -> bytebase.v1.QueryResponse
	3,  // 14: bytebase.v1.SQLService.Export:output_type -> bytebase.v1.ExportResponse
