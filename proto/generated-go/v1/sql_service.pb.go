...
type PrettyRequest struct {
	...
	DumpedSDL string `protobuf:"bytes,2,opt,name=dumpedSDL,proto3" json:"dumpedSDL,omitempty"`
	// The user-defined SDL schema. This schema will be checked for correctness and normalized.
	UserSDL string `protobuf:"bytes,3,opt,name=userSDL,proto3" json:"userSDL,omitempty"`
}
...
func (x *PrettyRequest) GetDumpedSDL() string {
	if x != nil {
		return x.DumpedSDL
	}
	return ""
...
func (x *PrettyRequest) GetUserSDL() string {
	if x != nil {
		return x.UserSDL
	}
	return ""
...
type PrettyResponse struct {
	...
	PrettyDumpedSDL string `protobuf:"bytes,1,opt,name=prettyDumpedSDL,proto3" json:"prettyDumpedSDL,omitempty"`
	// The user-defined SDL schema after normalizing.
	PrettyUserSDL string `protobuf:"bytes,2,opt,name=prettyUserSDL,proto3" json:"prettyUserSDL,omitempty"`
}
...
func (x *PrettyResponse) GetPrettyDumpedSDL() string {
	if x != nil {
		return x.PrettyDumpedSDL
	}
	return ""
}

func (x *PrettyResponse) GetPrettyUserSDL() string {
	if x != nil {
		return x.PrettyUserSDL
	}
	return ""
}
...
var file_v1_sql_service_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x22, 0x74, 0x0a, 0x0d, 0x50, 0x72, 0x65, 0x74, 0x74, 0x79, 0x52, 0x65, 0x71, 0x75,
	...
	,
	...
	0x70, 0x72, 0x65, 0x74, 0x74, 0x79, 0x42, 0x11, 0x5a, 0x0f, 0x67, 0x65, 0x6e, 0x65, 0x72, 0x61,
