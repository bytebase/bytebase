...
var file_v1_sql_service_proto_rawDesc = []byte{
	...
	0x06, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x73, 0x22, 0x90, 0x03, 0x0a, 0x08, 0x52, 0x6f, 0x77, 0x56,
	...
	0x61, 0x32, 0xd3, 0x01, 0x0a, 0x0a, 0x53, 0x51, 0x4c, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65,
	...
	0x7d, 0x3a, 0x71, 0x75, 0x65, 0x72, 0x79, 0x42, 0x11, 0x5a, 0x0f, 0x67, 0x65, 0x6e, 0x65, 0x72,
...
var file_v1_sql_service_proto_depIdxs = []int32{
	...
	0,  // 5: bytebase.v1.Advice.status:type_name -> bytebase.v1.Advice.Status
	10, // 6: bytebase.v1.PrettyRequest.engine:type_name -> bytebase.v1.Engine
	7,  // 7: bytebase.v1.SQLService.Pretty:input_type -> bytebase.v1.PrettyRequest
	1,  // 8: bytebase.v1.SQLService.Query:input_type -> bytebase.v1.QueryRequest
	8,  // 9: bytebase.v1.SQLService.Pretty:output_type -> bytebase.v1.PrettyResponse
	2,  // 10: bytebase.v1.SQLService.Query:output_type -> bytebase.v1.QueryResponse
