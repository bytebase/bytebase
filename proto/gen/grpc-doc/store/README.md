...
| schema_config | [SchemaConfig](#bytebase-store-SchemaConfig) |  | schema_config will be apply to the given database after executing statement, only be used in schema design for now. |
