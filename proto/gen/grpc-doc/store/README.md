...
- [store/project.proto](#store_project-proto)
    ...
    - [Project.PriorBackupPolicy](#bytebase-store-Project-PriorBackupPolicy)
...
| prior_backup_policy | [Project.PriorBackupPolicy](#bytebase-store-Project-PriorBackupPolicy) |  |  |
...
<a name="bytebase-store-Project-PriorBackupPolicy"></a>

### Project.PriorBackupPolicy


| Name | Number | Description |
| ---- | ------ | ----------- |
| PRIOR_BACKUP_POLICY_UNSPECIFIED | 0 |  |
| PRIOR_BACKUP_POLICY_NO_BACKUP | 1 |  |
| PRIOR_BACKUP_POLICY_BACKUP_ON_ERROR_STOP | 2 |  |
| PRIOR_BACKUP_POLICY_BACKUP_ON_ERROR_SKIP | 3 |  |
