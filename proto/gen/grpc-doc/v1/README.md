...
- [v1/setting_service.proto](#v1_setting_service-proto)
    ...
    - [WorkspaceMode](#bytebase-v1-WorkspaceMode)
...
| workspace_mode | [WorkspaceMode](#bytebase-v1-WorkspaceMode) |  | The workspace mode, either Console or SQL Editor. |
...
<a name="bytebase-v1-WorkspaceMode"></a>
