...
| expire_time | [google.protobuf.Timestamp](#google-protobuf-Timestamp) |  | The expiration time of the access grant. When the current time exceeds this value, an ACTIVE grant is considered expired and no longer authorizes access. |
