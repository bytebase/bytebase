...
|                `bytebase.imagePullPolicy`                |                                                                                            The imagePullPolicy for the Bytebase container.                                                                                            |                           "Always"                            |
...
|               `bytebase.busyboxPullPolicy`               |                                                                                        The imagePullPolicy for the BusyBox init container.                                                                                         |                        "IfNotPresent"                         |
