			...
			},
			{
				...
				result: []api.TaskCheckResult{
					...
					},
					{
						...
						Content:   `Column "id" in "public"."userTable" can have NULL value`,
					},
					{
						Status:    api.TaskCheckStatusWarn,
						Namespace: api.AdvisorNamespace,
						Code:      advisor.ColumnCanNotNull.Int(),
						Title:     "column.no-null",
						Content:   `Column "name" in "public"."userTable" can have NULL value`,
					},
					{
						Status:    api.TaskCheckStatusWarn,
						Namespace: api.AdvisorNamespace,
						Code:      advisor.ColumnCanNotNull.Int(),
						Title:     "column.no-null",
						Content:   `Column "roomId" in "public"."userTable" can have NULL value`,
					},
				},
			},
			{
