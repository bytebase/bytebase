...
echo ""
echo "$ ${OUTPUT_BINARY} --host localhost --port 8080${NC}"
echo ""
echo "Command to start Bytebase in on localhost:8080 and exposed at http://example.com via a separate gateway"
echo ""
echo "$ ${OUTPUT_BINARY} --host localhost --port 8080 --external-url http://example.com${NC}"
echo ""
