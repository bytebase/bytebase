...
echo ""
echo "$ docker run --init --name bytebase --restart always --publish 8080:80 --volume ~/.bytebase/data:/var/opt/bytebase bytebase/bytebase"
echo ""
echo "Command to start Bytebase in demo and readonly mode on http://example.com"
echo ""
echo "$ docker run --init --name bytebase --restart always --publish 80:80 --volume ~/.bytebase/data:/var/opt/bytebase bytebase/bytebase --demo --readonly --host http://example.com"
echo ""