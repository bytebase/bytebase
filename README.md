...
- [Air](https://github.com/cosmtrek/air#installation) (**must use 1.29.0**). This is for backend live reload.

### Steps

1. Install Air v1.29.0. Use 1.29.0 because the newer version changes the behavior and won't shutdown the previous service properly.
