...
ALTER TABLE sheet ADD source TEXT NOT NULL CHECK (source IN ('BYTEBASE', 'GITLAB_SELF_HOST', 'GITHUB_COM'));
ALTER TABLE sheet ADD type TEXT NOT NULL CHECK (type IN ('SQL'));
