...
VALUES
    (
        ...
        '',
        '{"resultList":[{"status":"SUCCESS","title":"Successfully connected \"testdb_prod\"","content":""}]}',
        ''
    );
...
VALUES
    (
        ...
        '{"statement":"SELECT ''Welcome Tech Lead, DBA, Developer'';","dbType":"MYSQL","charset":"utf8mb4","collation":"utf8mb4_general_ci"}'
    );
